...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 959893C33F7
	for <lists+linux-usb@lfdr.de>; Sat, 10 Jul 2021 11:23:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232456AbhGJJZg (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Sat, 10 Jul 2021 05:25:36 -0400
Received: from smtprelay-out1.synopsys.com ([149.117.73.133]:54756 "EHLO
        smtprelay-out1.synopsys.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S231877AbhGJJZg (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Sat, 10 Jul 2021 05:25:36 -0400
Received: from mailhost.synopsys.com (mdc-mailhost1.synopsys.com [10.225.0.209])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
        (Client CN "mailhost.synopsys.com", Issuer "SNPSica2" (verified OK))
        by smtprelay-out1.synopsys.com (Postfix) with ESMTPS id 277524019D;
        Sat, 10 Jul 2021 09:22:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=synopsys.com; s=mail;
        t=1625908971; bh=n/GJl5+kpn57kmV6jnVPIUviZzCAuOv6QmYNVPUHsGI=;
        h=Date:In-Reply-To:References:From:Subject:To:Cc:From;
        b=
Received: from razpc-HP (razpc-hp.internal.synopsys.com [10.116.75.64])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
        (Client did not present a certificate)
        by mailhost.synopsys.com (Postfix) with ESMTPSA id D7AFEA005D;
        Sat, 10 Jul 2021 09:22:47 +0000 (UTC)
Received: by razpc-HP (sSMTP sendmail emulation); Sat, 10 Jul 2021 13:22:46 +0400
Date:   Sat, 10 Jul 2021 13:22:46 +0400
In-Reply-To: <c0711737fe54efa72d35df42cc4b9db31c382e7a.1625896955.git.Arthur.Petrosyan@synopsys.com>
References: <c0711737fe54efa72d35df42cc4b9db31c382e7a.1625896955.git.Arthur.Petrosyan@synopsys.com>
X-SNPS-Relay: synopsys.com
From:   Artur Petrosyan <Arthur.Petrosyan@synopsys.com>
Subject: [PATCH v2] usb: phy: Fix page fault from usb_phy_uevent
...
Message-Id: <20210710092247.D7AFEA005D@mailhost.synopsys.com>
Precedence: bulk
