...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 69F8054AD30
	for <lists+linux-usb@lfdr.de>; Tue, 14 Jun 2022 11:22:29 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1355549AbiFNJVk (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Tue, 14 Jun 2022 05:21:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60060 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1355208AbiFNJV3 (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Tue, 14 Jun 2022 05:21:29 -0400
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:3::133])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1C25743AF7;
        Tue, 14 Jun 2022 02:21:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=bombadil.20210309; h=Content-Transfer-Encoding:
        MIME-Version:References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:Sender
        :Reply-To:Content-Type:Content-ID:Content-Description;
        bh=lHiSRvIuwO3YPEj672jytYVO9QUPjt5MfEUdHRE+ciU=; b=oU/Ex5kK8l1L4viReXymEM0gem
        ;
Received: from [2001:4bb8:180:36f6:1fed:6d48:cf16:d13c] (helo=localhost)
        by bombadil.infradead.org with esmtpsa (Exim 4.94.2 #2 (Red Hat Linux))
        id 1o12jW-008fPF-VF; Tue, 14 Jun 2022 09:21:11 +0000
...
Subject: [PATCH 07/10] ARM/dma-mapping: use dma-direct unconditionally
Date:   Tue, 14 Jun 2022 11:20:44 +0200
Message-Id: <20220614092047.572235-8-hch@lst.de>
...
@@ -2293,7 +1960,6 @@ void arch_teardown_dma_ops(struct device *dev)
 	set_dma_ops(dev, NULL);
 }
...
-#ifdef CONFIG_SWIOTLB
 ...
 {
@@ -2321,4 +1987,3 @@ void arch_dma_free(struct device *dev, size_t size, void *cpu_addr,
 {
