...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 750513C348D
	for <lists+linux-usb@lfdr.de>; Sat, 10 Jul 2021 15:02:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232014AbhGJNF1 (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Sat, 10 Jul 2021 09:05:27 -0400
Received: from cable.insite.cz ([84.242.75.189]:37831 "EHLO cable.insite.cz"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231896AbhGJNFW (ORCPT <rfc822;linux-usb@vger.kernel.org>);
        Sat, 10 Jul 2021 09:05:22 -0400
Received: from localhost (localhost [127.0.0.1])
        by cable.insite.cz (Postfix) with ESMTP id 958EBA1A3D405;
        Sat, 10 Jul 2021 14:55:43 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=ivitera.com; s=mail;
        t=1625921743; bh=2e+v3ah+Lk7jSfOiqbBQ9wqYIhD+4ezU9kXXGYncFjE=;
        h=Subject:To:Cc:From:Date:From;
        b=nROdyMhmMHSXo21AGPinaUI1fro9Hooa2yaTV3XA2kRGkFRYLbhZ6pgoVBCzS0sOF
         pde5MC88tCjxPIJ30I3EjpDF90dNI2Rjm8dVtTzntexK6lCWRjKJ1Cb63g+Q6W3vGU
         9Ea4svyOLT9+neNJNZz6Fhjqh+9TzIyrRNAsJssw=
Received: from cable.insite.cz ([84.242.75.189])
        by localhost (server.insite.cz [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 7ATxb1x8mfIe; Sat, 10 Jul 2021 14:55:36 +0200 (CEST)
Received: from [192.168.105.22] (ip28.insite.cz [81.0.237.28])
        (Authenticated sender: pavel)
        by cable.insite.cz (Postfix) with ESMTPSA id 65641A1A3D401;
        Sat, 10 Jul 2021 14:55:36 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=ivitera.com; s=mail;
        t=1625921736; bh=2e+v3ah+Lk7jSfOiqbBQ9wqYIhD+4ezU9kXXGYncFjE=;
        h=Subject:To:Cc:From:Date:From;
        b=P/Thq4J4WROPw6+aYeqNTjmyHQtwDeC/AM3rtnT6l9+okq1YMkDThpXLTH/DAi/a8
         44NgzzK4BD2QgUCyyiAZix9IvrzcBUYVKHREyKR5IhkCo4Mx7zQgnxSsip0heXnndh
         D5iMGyzwsTolTkrVIN2COw6RSIj3Ywnup3bqqwbc=
Subject: [PATCH 3/4] usb: gadget: f_uac2: add volume and mute support
...
Message-ID: <43b65251-2f63-8908-4afc-e972d877cd5b@ivitera.com>
Date:   Sat, 10 Jul 2021 14:55:35 +0200
...
+++ b/Documentation/usb/gadget-testing.rst
@@ -729,10 +729,20 @@ The uac2 function provides these attributes in its
function directory:
 	c_srate		capture sampling rate
 	c_ssize		capture sample size (bytes)
 	c_sync		capture synchronization type (async/adaptive)
...
index ae29ff2b2b68..f61ca892abe5 100644
...
@@ -212,6 +237,9 @@ static struct uac2_output_terminal_descriptor
io_out_ot_desc = {
...
@@ -595,6 +676,26 @@ static int set_ep_max_packet_size(const struct
...
+
 		...
 		ac_hdr_desc.wTotalLength = cpu_to_le16(len);
 		iad_desc.bInterfaceCount++;
@@ -752,6 +898,28 @@ static int afunc_validate_opts(struct g_audio *agdev,
struct device *dev)
 		return -EINVAL;
 	}
...
+
 ...
 @@ -774,6 +942,23 @@ afunc_bind(struct usb_configuration *cfg, struct
usb_function *fn)
...
@@ -787,6 +972,21 @@ afunc_bind(struct usb_configuration *cfg, struct
usb_function *fn)
...
@@ -801,6 +1001,26 @@ afunc_bind(struct usb_configuration *cfg, struct
usb_function *fn)
...
@@ -808,7 +1028,7 @@ afunc_bind(struct usb_configuration *cfg, struct
usb_function *fn)
...
+		goto err_free_fu;
 ...
 @@ -820,7 +1040,7 @@ afunc_bind(struct usb_configuration *cfg, struct
usb_function *fn)
 		ret = usb_interface_id(cfg, fn);
 		if (ret < 0) {
 			dev_err(dev, "%s:%d Error!\n", __func__, __LINE__);
...
@@ -849,7 +1069,7 @@ afunc_bind(struct usb_configuration *cfg, struct
usb_function *fn)
 		ret = usb_interface_id(cfg, fn);
 		if (ret < 0) {
 			dev_err(dev, "%s:%d Error!\n", __func__, __LINE__);
...
@@ -857,6 +1077,17 @@ afunc_bind(struct usb_configuration *cfg, struct
usb_function *fn)
 		uac2->as_in_alt = 0;
 	}
...
+
 	...
 	ret = set_ep_max_packet_size(uac2_opts, &fs_epin_desc, USB_SPEED_FULL,
 				     true);
@@ -904,7 +1135,8 @@ afunc_bind(struct usb_configuration *cfg, struct
usb_function *fn)
...
@@ -912,7 +1144,8 @@ afunc_bind(struct usb_configuration *cfg, struct
usb_function *fn)
...
@@ -921,7 +1154,8 @@ afunc_bind(struct usb_configuration *cfg, struct
usb_function *fn)
...
+			goto err_free_fu;
 ...
 @@ -937,38 +1171,137 @@ afunc_bind(struct usb_configuration *cfg, struct
usb_function *fn)
...
+
 ...
 @@ -977,6 +1310,7 @@ afunc_set_alt(struct usb_function *fn, unsigned intf,
unsigned alt)
 {
...
+	struct g_audio *agdev = func_to_g_audio(fn);
 	...
 	int ret = 0;
@@ -993,6 +1327,14 @@ afunc_set_alt(struct usb_function *fn, unsigned intf,
unsigned alt)
 			dev_err(dev, "%s:%d Error!\n", __func__, __LINE__);
 			return -EINVAL;
 		}
...
+		usb_ep_disable(uac2->int_ep);
  ...
  static int
@@ -1054,7 +1398,7 @@ in_rq_cur(struct usb_function *fn, const struct
usb_ctrlrequest *cr)
 {
...
@@ -1063,28 +1407,64 @@ in_rq_cur(struct usb_function *fn, const struct
usb_ctrlrequest *cr)
...
+			__func__, __LINE__, entity_id, control_selector);
  	...
  	return value;
@@ -1095,38 +1475,77 @@ in_rq_range(struct usb_function *fn, const struct
usb_ctrlrequest *cr)
 {
 	struct usb_request *req = fn->config->cdev->req;
 	struct g_audio *agdev = func_to_g_audio(fn);
...
+			__func__, __LINE__, entity_id, control_selector);
  	...
  	return value;
@@ -1143,16 +1562,82 @@ ac_rq_in(struct usb_function *fn, const struct
usb_ctrlrequest *cr)
 		return -EOPNOTSUPP;
 }
 +static void
...
+#define UAC2_ATTRIBUTE(type, name)					\
 static ssize_t f_uac2_opts_##name##_show(struct config_item *item,	\
 					 char *page)			\
 {									\
@@ -1236,7 +1729,7 @@ static ssize_t f_uac2_opts_##name##_show(struct
config_item *item,	\
 	int result;							\
 									\
...
+	result = sprintf(page, type##_fmt, opts->name);			\
 	mutex_unlock(&opts->lock);					\
 									\
 	return result;							\
@@ -1247,7 +1740,7 @@ static ssize_t f_uac2_opts_##name##_store(struct
config_item *item,	\
 {									\
...
+	type num;							\
 	...
 	mutex_lock(&opts->lock);					\
 	if (opts->refcnt) {						\
@@ -1255,7 +1748,7 @@ static ssize_t f_uac2_opts_##name##_store(struct
config_item *item,	\
 		goto end;						\
 	}								\
 									\
...
+
 ...
 @@ -1383,6 +1901,19 @@ static struct usb_function_instance
...
@@ -1409,6 +1940,11 @@ static void afunc_unbind(struct usb_configuration *c,
...
@@ -1441,3 +1977,4 @@ DECLARE_USB_FUNCTION_INIT(uac2, afunc_alloc_inst,
afunc_alloc);
 MODULE_LICENSE("GPL");
