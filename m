Return-Path: <linux-usb+bounces-7442-lists+linux-usb=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-usb@lfdr.de
Delivered-To: lists+linux-usb@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BD8FF86F53A
	for <lists+linux-usb@lfdr.de>; Sun,  3 Mar 2024 14:55:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 6FD22284F02
	for <lists+linux-usb@lfdr.de>; Sun,  3 Mar 2024 13:55:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 027545A0EB;
	Sun,  3 Mar 2024 13:55:12 +0000 (UTC)
X-Original-To: linux-usb@vger.kernel.org
Received: from mx3.molgen.mpg.de (mx3.molgen.mpg.de [141.14.17.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E26F2290A
	for <linux-usb@vger.kernel.org>; Sun,  3 Mar 2024 13:55:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=141.14.17.11
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709474111; cv=none; b=E8AUnfOBym4MT2UE1uokDQ/pO7cLXi80q5J2JKkQsOPfcxA+GNFO1WRmNsnzutgJYllDlC7mfE4RypCg5ml6ir12K9IvzpVT9x5+JnsqPhHtmpMthWOBJsNZa0PfNis+n3oRzSxARPFWr9DU0ZdFOlOEJwUnP/q86+RaxAZtAlo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709474111; c=relaxed/simple;
	bh=XuFZoO+FJ45/lw24WhP25L6Fi4T5DntkhS9T1LIKwrk=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=A4Zgs3l2kPfPyEfx3BGbXEztbqILmYTks8K94esCEC9Aat8DM5e/UeItEGWJPEEw+TjwdkTfPwwIwaIvLR3rlUYYQYpszDxJoL+z2JxRUfPFOM1Q20JfsXkMbslBVS0i1eiuoP1ROBPtHiK6OrIMTsHEjLtcSANrxxrGtHzCSL0=
...
Received: from [192.168.0.53] (ip5f5aeda0.dynamic.kabel-deutschland.de [95.90.237.160])
	...
	by mx.molgen.mpg.de (Postfix) with ESMTPSA id B16F561E5FE05;
	Sun,  3 Mar 2024 14:54:35 +0100 (CET)
Message-ID: <62595888-9339-41fa-aab6-f76e581e371f@molgen.mpg.de>
Date: Sun, 3 Mar 2024 14:54:34 +0100
Precedence: bulk
...
>>>> unreliable` on Dell XPS 13 9360* [1][2], Linux warns about this on 
>>>> Dell laptops, desktops, and servers, and also on devices from other 
>>>> manufacturers [3].
>>>>
>>>> Is this a firmware issue or a Linux one? As a user I am unsure what 
>>>> to do, and ignoring warnings sounds wrong to me.
>>>
...
Mathias posted patches [4][5] fixing this issue, but it sounds like a 
firmware issue to me. Would that be something fwts [6][7] could check for?
...
[4]: 
https://lore.kernel.org/linux-usb/20240222133819.4149388-2-mathias.nyman@linux.intel.com/
[5]: 
https://lore.kernel.org/linux-usb/20240222233343.71856-1-mathias.nyman@linux.intel.com/
