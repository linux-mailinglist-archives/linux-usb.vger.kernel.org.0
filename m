Return-Path: <linux-usb+bounces-34008-lists+linux-usb=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-usb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id uNUYJ4B0qGm5ugAAu9opvQ
	(envelope-from <linux-usb+bounces-34008-lists+linux-usb=lfdr.de@vger.kernel.org>)
	for <lists+linux-usb@lfdr.de>; Wed, 04 Mar 2026 19:05:52 +0100
X-Original-To: lists+linux-usb@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 470F4205B6A
	for <lists+linux-usb@lfdr.de>; Wed, 04 Mar 2026 19:05:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 43984307B577
	for <lists+linux-usb@lfdr.de>; Wed,  4 Mar 2026 18:03:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 74FB33E556B;
...
X-Spamd-Result: default: False [2.84 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-34008-lists,linux-usb=lfdr.de];
	URIBL_MULTI_FAIL(0.00)[kwiboo.se:server fail,pengutronix.de:server fail,ffwll.ch:server fail,tuxon.dev:server fail,bootlin.com:server fail,ideasonboard.com:server fail,rock-chips.com:server fail,glider.be:server fail,nxp.com:server fail,linaro.org:server fail,microchip.com:server fail,intel.com:server fail,suse.de:server fail,baylibre.com:server fail,sto.lore.kernel.org:server fail];
