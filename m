prod.outlook.com;FPR:;SPF:None;LANG:en;PTR:InfoNoRecords;A:1;MX:1;
received-spf: None (protection.outlook.com: cadence.com does not designate
 permitted sender hosts)
x-ms-exchange-senderadcheck: 1
x-microsoft-antispam-message-info: 
Content-Type: text/plain; charset="us-ascii"
Content-Transfer-Encoding: quoted-printable
MIME-Version: 1.0
X-OriginatorOrg: cadence.com
X-MS-Exchange-CrossTenant-Network-Message-Id: c379105d-b23a-4ea8-9149-08d7156842a4
X-MS-Exchange-CrossTenant-originalarrivaltime: 31 Jul 2019 03:36:23.0200
 (UTC)
...
X-Proofpoint-Spam-Details: rule=outbound_check_notspam policy=outbound_check score=0
 ...
 scancount=1 engine=8.0.1-1906280000 definitions=main-1907310035
...
In this version I made all your suggestion from you first part of review=20
for v9 and some from the second.

Will you find some time for next review ?
...
>+
>+static inline
>+struct cdns3_role_driver *cdns3_get_current_role_driver(struct cdns3 *cdn=
s)
>+{
...
>+	}
>+
>+	if (dr_mode =3D=3D USB_DR_MODE_OTG || dr_mode =3D=3D USB_DR_MODE_PERIPHE=
RAL) {
...
>+
>+/**
>+ * cdsn3_real_role_switch_get - get real role of controller based on hard=
ware
>+ *   settings.
...
>+ *           or OTG mode that allow to switch between Device and Host mod=
e.
...
>+ *           dr_mode                 |  desired_dr_mode and current_dr_mo=
de
>+ *           ------------------------------------------------------------=
----
>+ *           USB_DR_MODE_HOST        | only USB_DR_MODE_HOST
>+ *           USB_DR_MODE_PERIPHERAL  | only USB_DR_MODE_PERIPHERAL
>+ *           USB_DR_MODE_OTG         | USB_DR_MODE_OTG or USB_DR_MODE_HOS=
T or
...
>+ *
>+ * Prints out all TRBs in the endpoint ring, even those after the Link TR=
B.
>+ *.
>+ */
...
>+ * @ctrl_req: pointer to received setup packet
>+ *
>+ * Returns 0 if success, USB_GADGET_DELAYED_STATUS on deferred status sta=
ge,
>+ * error code on error
>+ */
...
>+
>+/**
>+ * cdns3_req_ep0_set_address - Handling of SET_ADDRESS standard USB reque=
st
>+ * @priv_dev: extended gadget object
>+ * @ctrl_req: pointer to received setup packet
>+ *
...
>+}
>+
>+static int cdns3_ep0_feature_handle_endpoint(struct cdns3_device *priv_de=
v,
>+					     struct usb_ctrlrequest *ctrl,
>+					     int set)
>+{
...
>+{
>+	struct cdns3_device *priv_dev =3D container_of(work, struct cdns3_device=
,
>+			pending_status_wq);
>+	unsigned long flags;
>+
...
>+
>+/**
>+ * cdns3_check_ep0_interrupt_proceed - Processes interrupt related to end=
point 0
>+ * @priv_dev: extended gadget object
...
>+ *
>+ * To fix this problem, driver needs to make the first TRB in TD as inval=
id.
...
>+
>+/**
>+ * cdns3_hw_reset_eps_config - reset endpoints configuration kept by cont=
roller.
>+ * @priv_dev: extended gadget object
>+ */
...
>+ * if it is point to the link TRB, wrap around to the beginning and rever=
t
>+ * cycle state bit The
...
>+ *
>+ * Must be called with controller's lock held and interrupts disabled. Th=
is
...
>+}
>+
>+static int cdns3_prepare_aligned_request_buf(struct cdns3_request *priv_r=
eq)
>+{
>+	struct cdns3_endpoint *priv_ep =3D priv_req->priv_ep;
>+	struct cdns3_device *priv_dev =3D priv_ep->cdns3_dev;
...
>+}
>+
>+static void cdns3_wa1_tray_restore_cycle_bit(struct cdns3_device *priv_de=
v,
>+					     struct cdns3_endpoint *priv_ep)
>+{
>+	int dma_index;
...
>+ *
>+ * Returns false if request has not been handled by DMA, else returns tru=
e.
>+ *
>+ * SR - start ring
>+ * ER -  end ring
...
>+ * This situation take place when CI go through the LINK TRB at the end o=
f
>+ * transfer ring.
>+ *      SR ... CI ... EQ ... DQ ... ER
>+ *
...
>+	if (TRBS_PER_SEGMENT =3D=3D 2 && priv_ep->type !=3D USB_ENDPOINT_XFER_IS=
OC) {
>+		handled =3D 1;
>+		goto finish;
>+	}
...
>+
>+/**
>+ * cdns3_check_ep_interrupt_proceed - Processes interrupt related to endp=
oint
>+ * @priv_ep: endpoint object
>+ *
>+ * Returns 0
>+ */
>+static int cdns3_check_ep_interrupt_proceed(struct cdns3_endpoint *priv_e=
p)
>+{
>+	struct cdns3_device *priv_dev =3D priv_ep->cdns3_dev;
>+	u32 ep_sts_reg;
...
>+
>+/**
>+ * cdns3_check_usb_interrupt_proceed - Processes interrupt related to dev=
ice
>+ * @priv_dev: extended gadget object
...
>+
>+/**
>+ * cdns3_device_irq_handler- interrupt handler for device part of control=
ler
>+ *
>+ * @irq: irq number for cdns3 core device
>+ * @data: structure of cdns3
...
>+ * set_configuration.
>+ *
>+ * This function set EP_CLAIMED flag which is added when the gadget drive=
r
...
>+ * accordingly.
>+ *
>+ * At usb_ep_ops.enable/disable, we only enable and disable endpoint thro=
ugh
...
>+}
>+
>+static int cdns3_gadget_ep_queue(struct usb_ep *ep, struct usb_request *r=
equest,
>+				 gfp_t gfp_flags)
>+{
...
>+#define DEV_UNDEFSPEED(p)	(((p) & USB_STS_USBSPEED_MASK) =3D=3D (0x0 << 4=
))
>+#define DEV_LOWSPEED(p)		(((p) & USB_STS_USBSPEED_MASK) =3D=3D USB_STS_LS=
)
>+#define DEV_FULLSPEED(p)	(((p) & USB_STS_USBSPEED_MASK) =3D=3D USB_STS_FS=
)
>+#define DEV_HIGHSPEED(p)	(((p) & USB_STS_USBSPEED_MASK) =3D=3D USB_STS_HS=
)
>+#define DEV_SUPERSPEED(p)	(((p) & USB_STS_USBSPEED_MASK) =3D=3D USB_STS_S=
S)
>+/*
...
>+ * 0 - USB device is disabled (VBUS input is disconnected from internal l=
ogic).
>+ * 1 - USB device is enabled (VBUS input is connected to the internal log=
ic).
>+ */
...
>+ * SET_ADDRESS request service. This field should be set immediately afte=
r
>+ * the SETUP packet is decoded, and prior to confirmation of the status p=
hase
>+ */
...
>+ * In HS/FS mode this field represent number of last SOF received from ho=
st.
>+ */
...
>+
>+#define USB_IEN_INIT  (USB_IEN_U2RESIEN | USB_ISTS_DIS2I | USB_IEN_CON2IE=
N \
...
>+/*
>+ * Status bit indicating that operation required by STB_CLK_SWITCH_EN wri=
te
>+ * is completed
>+ */
...
>+ * 0x1 - some features and ports for CDNS USB OTG controller are implemen=
ted.
>+ */
...
>+/*
>+ * RXDET_BREAK_DIS value This parameter configures terminating the Far-en=
d
...
>+ * LFPS_MIN_DET_U1_EXIT field value to the device. This bit is automatica=
lly
...
>+ * LFPS_MIN_GEN_U1_EXIT field value to the device. This bit is automatica=
lly
>+ * cleared. Writing '0' has no effect
>+ */
...
>+ * the RXDET_BREAK_DIS field value to the device. This bit is automatical=
ly
>+ * cleared. Writing '0' has no effect
>+ */
...
>+
>+#define gadget_to_cdns3_device(g) (container_of(g, struct cdns3_device, g=
adget))
>+
>+#define ep_to_cdns3_ep(ep) (container_of(ep, struct cdns3_endpoint, endpo=
int))
>+
>+/*-----------------------------------------------------------------------=
--*/
...
>+
>+#define GET_TRBS_PER_SEGMENT(ep_type) ((ep_type) =3D=3D USB_ENDPOINT_XFER=
_ISOC ? \
...
>+/*
>+ * When set to '1', the device will toggle its interpretation of the Cycl=
e bit
>+ */
>+#define TRB_TOGGLE		BIT(1)
>+
>+/*
>+ * Short Packet (SP). OUT EPs at DMULT=3D1 only. Indicates if the TRB was
>+ * processed while USB short packet was received. No more buffers defined=
 by
...
>+ * - Shall be set to 1 by Controller when Short Packet condition for this=
 TRB
...
>+
>+/**
>+ * struct cdns3_endpoint - extended device side representation of USB end=
point.
>+ * @endpoint: usb endpoint
>+ * @pending_req_list: list of requests queuing on transfer ring.
>+ * @deferred_req_list: list of requests waiting for queuing on transfer r=
ing.
...
>+
>+/**
>+ * struct cdns3_aligned_buf - represent aligned buffer used for DMA trans=
fer
...
>+
>+/**
>+ * struct cdns3_request - extended device side representation of usb_requ=
est
>+ *                        object .
...
>+ * @aligned_buf: object holds information about aligned buffer associated=
 whit
>+ *               this endpoint
...
>+};
>+
>+#define to_cdns3_request(r) (container_of(r, struct cdns3_request, reques=
t))
>+
...
>+ * @aligned_buf_list: list of aligned buffers internally allocated by dri=
ver
>+ * @run_garbage_collector: infroms that at least one element of aligned_b=
uf_list
>+ *                        can be freed
...
.
>+ * @pending_status_wq: workqueue handling status stage for deferred reque=
sts.
...
>+void cdns3_gadget_ep_free_request(struct usb_ep *ep,
>+				  struct usb_request *request);
>+int cdns3_gadget_ep_dequeue(struct usb_ep *ep, struct usb_request *reques=
t);
>+void cdns3_gadget_giveback(struct cdns3_endpoint *priv_ep,
>+			   struct cdns3_request *priv_req,
>+			   int status);
...
>+	),
>+	TP_printk("%s: trb %p, dma buf: 0x%08x, size: %ld, burst: %d ctrl: 0x%08=
x (%s%s%s%s%s%s%s)",
...
>+		TRB_FIELD_TO_TYPE(__entry->control) =3D=3D TRB_NORMAL ? "Normal" : "LIN=
K"
>+	)
>+);
>+
