...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E251C5A8097
	for <lists+linux-usb@lfdr.de>; Wed, 31 Aug 2022 16:49:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229635AbiHaOtY (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Wed, 31 Aug 2022 10:49:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38980 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229510AbiHaOtW (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Wed, 31 Aug 2022 10:49:22 -0400
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 641F2CE328
        for <linux-usb@vger.kernel.org>; Wed, 31 Aug 2022 07:49:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1661957358; x=1693493358;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=kgZgixFlSI2C96r/t4urIc+6RiPwLzqmPR+gMqY9Ydg=;
  b=D7rZxJZLJoaLIe3WWkZjX+uZ4E278Du0GiaKiKN4yeF+lXo/a/CnS89x
   7KbF379Auzowg7XSgqAeFCDCiSvSfdoJEN9lhPAXMV02cOeXxEH9vMVfn
   skRBtvIN0d0oqjq98xm/6lHPpjIgiDLM136+2NE6nmHviAKHAZ30FpYJX
   PKjFSbDNdw+JgoEDFsjNKwlCDHWEnqLGBVxLtiiy57wZ+DeXwkdGFEnca
   MBN1m7HB1aT6RN4I6TILMMAixb7xf40cXVfZgQNE5aSEDPpOX0IHQSszi
   SlwN1/fMtgaZJMnCLatIfSCvBVwXTZYzKRMaTgMn2Y7h0RFnOAAVN7IWf
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10456"; a="296743473"
X-IronPort-AV: E=Sophos;i="5.93,278,1654585200"; 
   d="scan'208";a="296743473"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 31 Aug 2022 07:49:17 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,278,1654585200"; 
   d="scan'208";a="589055379"
Received: from lkp-server02.sh.intel.com (HELO 811e2ceaf0e5) ([10.239.97.151])
  by orsmga006.jf.intel.com with ESMTP; 31 Aug 2022 07:49:15 -0700
Received: from kbuild by 811e2ceaf0e5 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oTP1m-0000Mj-1n;
        Wed, 31 Aug 2022 14:49:14 +0000
Date:   Wed, 31 Aug 2022 22:49:09 +0800
From:   kernel test robot <lkp@intel.com>
To:     Piyush Mehta <piyush.mehta@amd.com>
Cc:     kbuild-all@lists.01.org, linux-usb@vger.kernel.org,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        Linus Walleij <linus.walleij@linaro.org>
Subject: [usb:usb-linus 33/41] drivers/usb/gadget/udc/udc-xilinx.c:502:37:
 sparse: sparse: incorrect type in argument 1 (different address spaces)
Message-ID: <202208312226.w744Bzfn-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="2sP2PKHGOCoFnSLB"
...
head:   58bfe7d8e31014d7ce246788df99c56e3cfe6c68
commit: 8cb339f1c1f04baede9d54c1e40ac96247a6393b [33/41] usb: gadget: udc-xilinx: replace memcpy with memcpy_toio
...
>> drivers/usb/gadget/udc/udc-xilinx.c:1755:22: sparse: sparse: incorrect type in argument 1 (different address spaces) @@     expected void volatile [noderef] __iomem * @@     got struct usb_ctrlrequest * @@
   drivers/usb/gadget/udc/udc-xilinx.c:1755:22: sparse:     expected void volatile [noderef] __iomem *
   drivers/usb/gadget/udc/udc-xilinx.c:1755:22: sparse:     got struct usb_ctrlrequest *
...
>> drivers/usb/gadget/udc/udc-xilinx.c:1842:29: sparse: sparse: incorrect type in argument 1 (different address spaces) @@     expected void volatile [noderef] __iomem * @@     got void *[assigned] buffer @@
   drivers/usb/gadget/udc/udc-xilinx.c:1842:29: sparse:     expected void volatile [noderef] __iomem *
   drivers/usb/gadget/udc/udc-xilinx.c:1842:29: sparse:     got void *[assigned] buffer
...
>> drivers/usb/gadget/udc/udc-xilinx.c:1918:37: sparse: sparse: incorrect type in argument 1 (different address spaces) @@     expected void volatile [noderef] __iomem * @@     got unsigned char [usertype] *[assigned] ep0rambase @@
   drivers/usb/gadget/udc/udc-xilinx.c:1918:37: sparse:     expected void volatile [noderef] __iomem *
   drivers/usb/gadget/udc/udc-xilinx.c:1918:37: sparse:     got unsigned char [usertype] *[assigned] ep0rambase
