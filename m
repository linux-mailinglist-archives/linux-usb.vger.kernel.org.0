...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 618BC199D24
	for <lists+linux-usb@lfdr.de>; Tue, 31 Mar 2020 19:43:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726194AbgCaRnM (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Tue, 31 Mar 2020 13:43:12 -0400
Received: from aserp2120.oracle.com ([141.146.126.78]:45302 "EHLO
        aserp2120.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726164AbgCaRnM (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Tue, 31 Mar 2020 13:43:12 -0400
Received: from pps.filterd (aserp2120.oracle.com [127.0.0.1])
        by aserp2120.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 02VHdTw7193044;
        Tue, 31 Mar 2020 17:43:09 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=content-type :
 mime-version : subject : from : in-reply-to : date : cc :
 content-transfer-encoding : message-id : references : to;
 s=corp-2020-01-29; bh=H1MpmT9SGLH1LDQ/75vev3vV8672bDXdR6yTxfkeNH8=;
 b= og== 
Received: from userp3030.oracle.com (userp3030.oracle.com [156.151.31.80])
        by aserp2120.oracle.com with ESMTP id 303yun3mc9-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 31 Mar 2020 17:43:09 +0000
Received: from pps.filterd (userp3030.oracle.com [127.0.0.1])
        by userp3030.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 02VHgpah154825;
        Tue, 31 Mar 2020 17:43:08 GMT
Received: from aserv0122.oracle.com (aserv0122.oracle.com [141.146.126.236])
        by userp3030.oracle.com with ESMTP id 302g2ehyt5-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 31 Mar 2020 17:43:08 +0000
Received: from abhmp0020.oracle.com (abhmp0020.oracle.com [141.146.116.26])
        by aserv0122.oracle.com (8.14.4/8.14.4) with ESMTP id 02VHh6qW028870;
        Tue, 31 Mar 2020 17:43:07 GMT
Received: from dhcp-10-39-193-97.vpn.oracle.com (/10.39.193.97)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Tue, 31 Mar 2020 10:43:06 -0700
...
Date:   Tue, 31 Mar 2020 12:43:04 -0500
Cc:     linux-usb@vger.kernel.org
Content-Transfer-Encoding: quoted-printable
Message-Id: <86E5B81F-DD9D-42E8-A687-D4593FA734AE@oracle.com>
References: <Pine.LNX.4.44L0.2003311000010.27552-100000@netrider.rowland.org>
 <4BC4ADAB-FB33-4172-90EC-3EE38A3E3DE8@oracle.com>
...
> On Mar 31, 2020, at 11:07 AM, John Donnelly =
...
480M
>>>    |__ Port 3: Dev 2, If 0, Class=3DHub, Driver=3Dhub/2p, 480M
>>> /:  Bus 03.Port 1: Dev 1, Class=3Droot_hub, Driver=3Duhci_hcd/2p, =
12M
...
>>=20
>> Why do you say this is the last activity seen on both traces?  In =
both
>> of the log extracts you included above there are plenty of lines
>> following those "enabling power" messages.
>>=20
>>> Is this when the BCM discovery is suppose to  occur ? In the =
function=20
