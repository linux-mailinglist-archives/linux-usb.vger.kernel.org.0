...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A1E2963D0BA
	for <lists+linux-usb@lfdr.de>; Wed, 30 Nov 2022 09:34:53 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235483AbiK3Iev (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Wed, 30 Nov 2022 03:34:51 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38492 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235488AbiK3Iec (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Wed, 30 Nov 2022 03:34:32 -0500
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A4AFE165A3
        for <linux-usb@vger.kernel.org>; Wed, 30 Nov 2022 00:30:59 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1669797059; x=1701333059;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=0RqiNJ2JPemEQCSnG+l0t8pkXmoFBB9YXcsAmvfcN7Q=;
  b=KUWPX9BcAFEoCITwjIegFtylBd3IRqKf5vAh0+RrFKGrIx6dW34LXEQo
   J64bYiEAm2B5qnimCRENrIN13Yts1FuZELkLiCt6uHn2ErK8Lr3/gUZyn
   CEl8gICrBzUhbfVWIDm6vjw3RRwtR2CHrztPey9eR5bxHIkzzYeXRGQgn
   TMC/WeQ1suouX8NBkP7LcbMuRqSEzBy1fxATzaOHgYcuTfiiiTMxLtVO5
   dZz1ZZZwNtG2IikexkjjWpkDYsjmYridmvhuzP63QvdLX6EwQJnsr3iHu
   40h5267BRPc8ntho9P3oWyg5QbyVkQvK5VI1Bdb0qLPiae/u5fBF3G5W9
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10546"; a="379617921"
X-IronPort-AV: E=Sophos;i="5.96,205,1665471600"; 
   d="scan'208";a="379617921"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Nov 2022 00:30:58 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10546"; a="712726170"
X-IronPort-AV: E=Sophos;i="5.96,205,1665471600"; 
   d="scan'208";a="712726170"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by fmsmga004.fm.intel.com with ESMTP; 30 Nov 2022 00:30:55 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1p0IUY-000Arj-2c;
        Wed, 30 Nov 2022 08:30:54 +0000
Date:   Wed, 30 Nov 2022 16:30:37 +0800
From:   kernel test robot <lkp@intel.com>
To:     Andy Shevchenko <andriy.shevchenko@linux.intel.com>
Cc:     oe-kbuild-all@lists.linux.dev, linux-usb@vger.kernel.org,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        Lucas De Marchi <lucas.demarchi@intel.com>
Subject: [usb:usb-testing 19/24] drivers/xen/unpopulated-alloc.c:17:21:
 error: 'list_count' redeclared as different kind of symbol
Message-ID: <202211301628.iwMjPVMp-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="vkLlB3PgIaGxj0iO"
...
head:   62c73bfea048e66168df09da6d3e4510ecda40bb
commit: a9efc04cfd05690e91279f41c2325c46335c43ef [19/24] i915: Move list_count() to list.h for broader use
config: x86_64-allyesconfig
compiler: gcc-11 (Debian 11.3.0-8) 11.3.0
reproduce (this is a W=1 build):
        # https://git.kernel.org/pub/scm/linux/kernel/git/gregkh/usb.git/commit/?id=a9efc04cfd05690e91279f41c2325c46335c43ef
        git remote add usb https://git.kernel.org/pub/scm/linux/kernel/git/gregkh/usb.git
        git fetch --no-tags usb usb-testing
        git checkout a9efc04cfd05690e91279f41c2325c46335c43ef
...
vim +/list_count +17 drivers/xen/unpopulated-alloc.c

9e2369c06c8a18 Roger Pau Monne 2020-09-01  14  
9e2369c06c8a18 Roger Pau Monne 2020-09-01  15  static DEFINE_MUTEX(list_lock);
ee32f32335e8c7 Juergen Gross   2020-12-07  16  static struct page *page_list;
9e2369c06c8a18 Roger Pau Monne 2020-09-01 @17  static unsigned int list_count;
9e2369c06c8a18 Roger Pau Monne 2020-09-01  18  
