Return-Path: <linux-usb+bounces-37942-lists+linux-usb=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-usb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 8N73FdOJEGriYwYAu9opvQ
	(envelope-from <linux-usb+bounces-37942-lists+linux-usb=lfdr.de@vger.kernel.org>)
	for <lists+linux-usb@lfdr.de>; Fri, 22 May 2026 18:52:35 +0200
X-Original-To: lists+linux-usb@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id AD8215B7C89
	for <lists+linux-usb@lfdr.de>; Fri, 22 May 2026 18:52:34 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 1C5CC30056CE
	for <lists+linux-usb@lfdr.de>; Fri, 22 May 2026 16:46:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 40B9946AF39;
	Fri, 22 May 2026 16:46:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=igalia.com header.i=@igalia.com header.b="glQpC+NY"
X-Original-To: linux-usb@vger.kernel.org
Received: from fanzine2.igalia.com (fanzine2.igalia.com [213.97.179.56])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B58353AEB35;
	Fri, 22 May 2026 16:46:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=213.97.179.56
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1779468372; cv=none; b=I+upR4i3NZ2iM2+GXLtFcIgRzjt510auXvRgVxfsPBTsLhO1x5RhoejgX8WejYNeYG+z5YkvCu+m7b/sUrbGLMwSWG9y/12aZmpcFEa+NVKPirpT3YRh58AeJnkgHHRs891vZyCkqQpoGawJS3xVZ0KDOquokF1bx/tswhmgvkk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1779468372; c=relaxed/simple;
	bh=4erRcbxjsWMuwUTB89AshDsVf16ZgniNd2SD3IKBjIs=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:To:Cc; b=ESySkS0W7fBPlthd4SvBz+20c/6Y4/StNIeR+qLpgXS6TfkE/hi5dEmsqi36+UfaQnMnOCrGTReYeoLP2tD4zDiKyN3B4llIMfAkZ8wV6NgOHSVaZ+93ECzpFfGGy1sTVFSmxx7S6JIfYf5BYT3YJFLXpyYw7BY0WYc1n+tGozY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=igalia.com; spf=pass smtp.mailfrom=igalia.com; dkim=pass (2048-bit key) header.d=igalia.com header.i=@igalia.com header.b=glQpC+NY; arc=none smtp.client-ip=213.97.179.56
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=igalia.com;
	...
	bh=hxNo2fiQW+Ord5Okbrpwa2U/mGyaC99cgTF3O4wuRyk=; b=glQpC+NYEVXVibMY5Zisb9OJWx
	;
Received: from 186-249-145-161.shared.desktop.com.br ([186.249.145.161] helo=[192.168.1.68])
	by fanzine2.igalia.com with esmtpsa 
	(Cipher TLS1.3:ECDHE_X25519__RSA_PSS_RSAE_SHA256__AES_256_GCM:256) (Exim)
	id 1wQT0U-004yAG-Dh; Fri, 22 May 2026 18:45:55 +0200
From: Mauricio Faria de Oliveira <mfo@igalia.com>
Date: Fri, 22 May 2026 13:45:35 -0300
Subject: [PATCH v2] usb: atm: ueagle-atm: wait for pre-firmware load in
 .disconnect()
Precedence: bulk
...
Message-Id: <20260522-ueagle-atm_req-fw-sync-v2-1-eee7f6b823a7@igalia.com>
X-B4-Tracking: v=1; b=H4sIAC6IEGoC/4WNWw6CMBBFt0Lm2zFteSh+uQ9DzKQOMAlQbBElh
 L1b2YCf5yT33BUCe+EAl2QFz7MEcUMEc0jAtjQ0jPKIDEaZQuU6xxdT0zHS1N89P7F+Y1gGi0Z
 lp0LXpM6qhDgePdfy2cO3KnIrYXJ+2X9m/bN/k7NGjZkqLKVlWrKhqzTUCR2t66Hatu0LS+OQE
 r0AAAA=
...
X-Spamd-Result: default: False [1.14 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-37942-lists,linux-usb=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	FREEMAIL_TO(0.00)[free.fr,wp.pl,linuxfoundation.org,osdl.org];
	...
	FREEMAIL_CC(0.00)[igalia.com,vger.kernel.org,suse.de,yandex.ru,syzkaller.appspotmail.com];
	MID_RHS_MATCH_FROM(0.00)[];
	RCVD_VIA_SMTP_AUTH(0.00)[];
	TAGGED_RCPT(0.00)[linux-usb,ce1e5a1b4e086b43e56d,306212936b13e520679d,457452d30bcdda75ead2];
	TO_DN_SOME(0.00)[];
	ASN(0.00)[asn:63949, ipnet:2600:3c0a::/32, country:SG];
	DBL_BLOCKED_OPENRESOLVER(0.00)[sea.lore.kernel.org:rdns,sea.lore.kernel.org:helo,qemu.org:url,appspotmail.com:email,igalia.com:mid,igalia.com:email,syzkaller.appspot.com:url]
X-Rspamd-Queue-Id: AD8215B7C89
...
index ed2611aacb252fce829b4a33589c47912aadbe67..f94a216e5ccec937597a2c9d226fba9fc9abb57a 100644
