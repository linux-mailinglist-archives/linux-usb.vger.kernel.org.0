...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 188DC16FB7B
	for <lists+linux-usb@lfdr.de>; Wed, 26 Feb 2020 10:59:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727451AbgBZJ7J (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Wed, 26 Feb 2020 04:59:09 -0500
Received: from eu-smtp-delivery-167.mimecast.com ([146.101.78.167]:36147 "EHLO
        eu-smtp-delivery-167.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727109AbgBZJ7I (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Wed, 26 Feb 2020 04:59:08 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=displaylink.com;
        s=mimecast20151025; t=1582711140;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding;
        bh=UPVaO/vs4QPz+kw34/BA9Q49P3nPAcikqW3X+d7851Q=;
        b=AzDPUJ71I17AYHhK1ggLory9YurJpWQKg/riWKd8KThAsM3Aq2pDPkvFHYUY3X7W1WyqRv
        uhsFiaOWjKBVBSzOQLf8YqEkhI4TyPSplZe+fF0nR9U3vewh6clbg7X6E2caCJzTG/c55C
        oJsWDIm8ijmTfsn32oEodLD80vZnj18=
Received: from EUR03-AM5-obe.outbound.protection.outlook.com
 (mail-am5eur03lp2053.outbound.protection.outlook.com [104.47.8.53]) (Using
 TLS) by relay.mimecast.com with ESMTP id
 uk-mta-79-J4EdjhxRNQezP0ZkNpyKzA-1; Wed, 26 Feb 2020 09:58:59 +0000
X-MC-Unique: J4EdjhxRNQezP0ZkNpyKzA-1
Received: from AM0PR10MB1954.EURPRD10.PROD.OUTLOOK.COM (52.133.63.154) by
 ...
 15.20.2772.14; Wed, 26 Feb 2020 09:58:56 +0000
Received: from AM0PR10MB1954.EURPRD10.PROD.OUTLOOK.COM
 ...
 09:58:56 +0000
Received: from [172.17.183.132] (80.93.235.40) by VI1P195CA0021.EURP195.PROD.OUTLOOK.COM (2603:10a6:800:d0::31) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.2750.18 via Frontend Transport; Wed, 26 Feb 2020 09:58:55 +0000
...
Subject: [PATCH v2 5/8] usb: mausb_host: Introduce PAL processing
Thread-Topic: [PATCH v2 5/8] usb: mausb_host: Introduce PAL processing
Thread-Index: AQHV7ItbzvqingZIeEeVfzReVaM/AQ==
Date:   Wed, 26 Feb 2020 09:58:56 +0000
Message-ID: <659eab4d-a995-d372-2c46-8b3d72ba13bc@displaylink.com>
Accept-Language: en-US
Content-Language: en-US
X-MS-Has-Attach: 
X-MS-TNEF-Correlator: 
x-clientproxiedby: VI1P195CA0021.EURP195.PROD.OUTLOOK.COM
 (2603:10a6:800:d0::31) To AM0PR10MB1954.EURPRD10.PROD.OUTLOOK.COM
 (2603:10a6:208:40::26)
x-ms-exchange-messagesentrepresentingtype: 1
x-originating-ip: [80.93.235.40]
x-ms-publictraffictype: Email
x-ms-office365-filtering-correlation-id: e688ae30-92eb-40b0-4545-08d7baa27e22
x-ms-traffictypediagnostic: AM0PR10MB2897:
x-ms-exchange-transport-forked: True
x-microsoft-antispam-prvs: <AM0PR10MB2897071DEDFECA995BB6988D91EA0@AM0PR10MB2897.EURPRD10.PROD.OUTLOOK.COM>
...
x-microsoft-antispam-message-info: 
x-ms-exchange-antispam-messagedata: utJoi6qunDytQFPxBcl1mHYSVj6ng4RUNWG97OG5GQ2rftm8OSxqn5pvxOn2+jsCcj7irS3uYgd0dTLoP8fRmYbCJTpyOQIPqZ4T+BpGB2OiCT8N10unI5+tb0dQUk9zNIejSJJ0N/iyYE4sthbVlw==
Content-ID: <CDA3A7EE2660AC47BDE716E50ED6B5B8@EURPRD10.PROD.OUTLOOK.COM>
MIME-Version: 1.0
X-OriginatorOrg: displaylink.com
X-MS-Exchange-CrossTenant-Network-Message-Id: e688ae30-92eb-40b0-4545-08d7baa27e22
X-MS-Exchange-CrossTenant-originalarrivaltime: 26 Feb 2020 09:58:56.1626
 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: a4bda75a-b444-4312-9c90-44a7c4b2c91a
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: Gt/PbFdXlYSidjpEUXolrkjEta6eipDJMXWtH3P+rwvq+uXEjlBV3WGunxyPG23JvTrFqY/LPm4uT70PA+HoTYKehJV7LAbhYpBuXjXuhwYlLSRwYnknH8aKiPeaPSFf
...
+++ b/drivers/usb/mausb_host/Makefile
@@ -10,6 +10,7 @@ mausb_host-y :=3D mausb_host.o
...
+=09=09mausb_pr_err("port number out of range, port_number=3D%x",
...
@@ -235,12 +320,31 @@ static int mausb_hcd_hub_status(struct usb_hcd=20
*hcd, char *buff);
...
usb_device *dev);
  static int mausb_reset_device(struct usb_hcd *hcd, struct usb_device=20
*dev);
  static int mausb_update_device(struct usb_hcd *hcd, struct usb_device=20
*dev);
  +static void mausb_print_urb(struct urb *request)
+{
+=09mausb_pr_debug("URB: urb=3D%p, ep_handle=3D%#x, packet_num=3D%d,=20
setup_dma=3D%lld, is_setup_packet=3D%d, is_ep=3D%d, is_sg=3D%d, num_sgs=3D%=
d,=20
num_mapped_sgs=3D%d, status=3D%d, is_transfer_buffer=3D%d,=20
transfer_buffer_length=3D%d, is_transfer_dma=3D%llu, transfer_flags=3D%d,=
=20
is_hcpriv=3D%d",
+=09=09       request, ((struct mausb_endpoint_ctx *)
+=09=09=09=09 request->ep->hcpriv)->ep_handle,
...
@@ -252,6 +356,9 @@ static const struct hc_driver mausb_hc_driver =3D {
...
@@ -311,6 +418,25 @@ static int get_root_hub_port_number(struct=20
...
+}
+
  static struct mausb_usb_device_ctx *mausb_find_usb_device(struct mausb_de=
v
  =09=09=09=09=09=09=09*mdevs, void *dev_addr)
  {
@@ -330,6 +456,31 @@ static struct mausb_usb_device_ctx=20
...
+
  ...
  {
  =09return 0;
@@ -504,6 +655,123 @@ static int mausb_hcd_hub_control(struct usb_hcd=20
*hcd, u16 type_req,
  =09return retval;
  }
...
+{
+=09if (!urb) {
+=09=09mausb_pr_err("urb is NULL");
+=09=09return -EINVAL;
+=09}
+
+=09if (!urb->ep->hcpriv) {
+=09=09mausb_pr_err("urb->ep->hcpriv is NULL");
+=09=09return -EINVAL;
+=09}
+
+=09if (!urb->ep->enabled) {
+=09=09mausb_pr_err("Endpoint not enabled");
+=09=09return -EINVAL;
+=09}
+=09return 0;
+}
...
+=09=09mausb_pr_err("Hpal urb enqueue failed");
+=09=09return -EPROTO;
+=09}
+
...
+=09=09mausb_pr_err("Client is not responsive anymore - finish urb=20
immediately");
...
+=09urb->hcpriv =3D hcd;
+
+=09mausb_pr_debug("ep_handle=3D%#x, dev_handle=3D%#x, urb_reject=3D%d",
...
+
+=09/*
+=09 * Masking URB_SHORT_NOT_OK flag as SCSI driver is adding it where it
...
@@ -765,8 +1033,10 @@ static void mausb_free_dev(struct usb_hcd *hcd,=20
...
+=09struct mausb_device=09    *ma_dev;
  ...
  @@ -779,6 +1049,16 @@ static void mausb_free_dev(struct usb_hcd *hcd,=20
struct usb_device *dev)
...
+
+=09if (!ma_dev) {
+=09=09mausb_pr_err("MAUSB device not found on port_number=3D%d",
+=09=09=09     port_number);
+=09=09return;
+=09}
+
...
@@ -787,6 +1067,13 @@ static void mausb_free_dev(struct usb_hcd *hcd,=20
struct usb_device *dev)
   =09dev_handle =3D usb_device_ctx->dev_handle;
  +=09if (atomic_read(&ma_dev->unresponsive_client)) {
+=09=09mausb_pr_err("Client is not responsive anymore - free usbdevice=20
immediately");
...
+=09=09mausb_pr_warn("device_ctx already exists");
...
+=09mausb_pr_info("New USB device added device=3D%p",
...
+=09return usb_device_ctx;
   ...
   /*
@@ -808,7 +1137,9 @@ static int mausb_address_device(struct usb_hcd=20
...
+=09struct mausb_device=09    *ma_dev;
  =09struct mausb_usb_device_ctx *usb_device_ctx;
  =09struct mausb_endpoint_ctx   *endpoint_ctx;
  @@ -819,9 +1150,23 @@ static int mausb_address_device(struct usb_hcd=20
*hcd, struct usb_device *dev)
  =09=09return -EINVAL;
  =09}
...
+
+=09if (!ma_dev) {
+=09=09mausb_pr_warn("MAUSB device not found on port_number=3D%d",
+=09=09=09      port_number);
  =09=09return -ENODEV;
+=09}
+
...
@@ -852,9 +1197,13 @@ static int mausb_add_endpoint(struct usb_hcd *hcd,=20
struct usb_device *dev,
  {
  =09int=09status;
  =09u8=09port_number;
...
@@ -863,6 +1212,16 @@ static int mausb_add_endpoint(struct usb_hcd *hcd,=20
struct usb_device *dev,
  =09=09return 0;
  =09}
  +=09spin_lock_irqsave(&mhcd->lock, flags);
...
;
   =09if (!usb_dev_ctx) {
@@ -876,8 +1235,17 @@ static int mausb_add_endpoint(struct usb_hcd *hcd,=20
struct usb_device *dev,
...
+
  ...
  @@ -887,8 +1255,10 @@ static int mausb_drop_endpoint(struct usb_hcd=20
*hcd, struct usb_device *dev,
  =09u8=09port_number;
  =09int=09status;
  =09struct hub_ctx=09=09    *hub =3D (struct hub_ctx *)hcd->hcd_priv;
...
+=09unsigned long flags =3D 0;
   =09status =3D get_root_hub_port_number(dev, &port_number);
  =09if (status < 0 || port_number >=3D NUMBER_OF_PORTS) {
@@ -897,6 +1267,16 @@ static int mausb_drop_endpoint(struct usb_hcd=20
*hcd, struct usb_device *dev,
  =09=09return -EINVAL;
  =09}
  +=09spin_lock_irqsave(&mhcd->lock, flags);
...
;
   =09if (!endpoint_ctx) {
@@ -913,6 +1293,70 @@ static int mausb_drop_endpoint(struct usb_hcd=20
*hcd, struct usb_device *dev,
  =09return 0;
  }
...
+=09mausb_pr_info("start... mausb_devspeed=3D%d, route=3D%#x, port_number=
=3D%d",
+=09=09      dev_speed, dev->route, port_number);
+
+=09if (dev_speed =3D=3D -EINVAL) {
+=09=09mausb_pr_err("bad dev_speed");
+=09=09return -EINVAL;
+=09}
+
...
@@ -923,7 +1367,9 @@ static int mausb_enable_device(struct usb_hcd *hcd,=20
struct usb_device *dev)
  =09int status;
  =09u8 port_number;
  =09struct hub_ctx=09=09    *hub =3D (struct hub_ctx *)hcd->hcd_priv;
...
+=09unsigned long flags;
   =09status =3D get_root_hub_port_number(dev, &port_number);
  =09if (status < 0 || port_number >=3D NUMBER_OF_PORTS) {
@@ -932,13 +1378,27 @@ static int mausb_enable_device(struct usb_hcd=20
*hcd, struct usb_device *dev)
  =09=09return -EINVAL;
  =09}
  -=09usb_device_ctx =3D mausb_find_usb_device(&hub->ma_devs[port_number], =
...
+=09=09=09=09=09=09      usb_device_ctx);
  ...
  @@ -952,7 +1412,9 @@ static int mausb_update_device(struct usb_hcd=20
*hcd, struct usb_device *dev)
...
@@ -966,6 +1428,16 @@ static int mausb_update_device(struct usb_hcd=20
*hcd, struct usb_device *dev)
  =09=09return -EINVAL;
  =09}
  +=09spin_lock_irqsave(&mhcd->lock, flags);
...
+=09}
+
  =09usb_device_ctx =3D mausb_find_usb_device(&hub->ma_devs[port_number], d=
ev);
  =09if (!usb_device_ctx) {
  =09=09mausb_pr_warn("Device not found");
@@ -980,10 +1452,12 @@ static int mausb_hub_update_device(struct usb_hcd=20
*hcd, struct usb_device *dev,
  {
  =09int=09status;
  =09u8=09port_number;
...
@@ -998,6 +1472,16 @@ static int mausb_hub_update_device(struct usb_hcd=20
*hcd, struct usb_device *dev,
  =09=09return 0;
  =09}
  +=09spin_lock_irqsave(&mhcd->lock, flags);
...
+
  =09usb_device_ctx =3D mausb_find_usb_device(&hub->ma_devs[port_number],
  =09=09=09=09=09       dev);
  @@ -1038,10 +1522,12 @@ static void mausb_endpoint_reset(struct=20
usb_hcd *hcd,
  =09int is_control;
  =09int epnum;
  =09int is_out;
...
@@ -1064,14 +1550,21 @@ static void mausb_endpoint_reset(struct usb_hcd=20
*hcd,
  =09}
...
@@ -1099,7 +1592,9 @@ static int mausb_reset_device(struct usb_hcd *hcd,=20
struct usb_device *dev)
  =09int status;
  =09u8  port_number;
  =09u16 dev_handle;
...
+=09struct mausb_device=09    *ma_dev;
  =09struct mausb_usb_device_ctx *usb_device_ctx;
   =09hub =3D (struct hub_ctx *)hcd->hcd_priv;
@@ -1111,6 +1606,16 @@ static int mausb_reset_device(struct usb_hcd=20
*hcd, struct usb_device *dev)
  =09=09return -EINVAL;
  =09}
  +=09spin_lock_irqsave(&mhcd->lock, flags);
...
+=09struct mausb_data_iter=09iterator;
  ...
  =09struct work_struct=09work;
   ...
   int mausb_probe(struct device *dev);
+void mausb_hcd_urb_complete(struct urb *urb, u32 actual_length, int=20
status);
   void mausb_clear_hcd_madev(u16 port_number);
  diff --git a/drivers/usb/mausb_host/hpal.c b/drivers/usb/mausb_host/hpal.=
c
...
+
+static inline struct mausb_urb_ctx *__mausb_find_urb_in_tree(struct urb=20
*urb)
+{
...
+}
+
+static struct mausb_urb_ctx *mausb_create_urb_ctx(struct urb *urb, int=20
*status)
+{
...
+=09=09=09mausb_pr_err("Error %d while linking urb to hcd_endpoint",
+=09=09=09=09     status);
+=09=09=09kfree(urb_ctx);
+=09=09=09return status;
+=09=09}
...
+=09=09mausb_pr_err("Urb_ctx insertion failed");
+=09=09return -EEXIST;
+=09}
+
...
+
+=09if (!urb) {
+=09=09mausb_pr_warn("Urb is NULL");
+=09=09return NULL;
+=09}
+
+=09spin_lock_irqsave(&mhcd->lock, flags);
...
+
+=09if (!urb_ctx) {
+=09=09mausb_pr_warn("Urb=3D%p not in tree", urb);
+=09=09spin_unlock_irqrestore(&mhcd->lock, flags);
+=09=09return NULL;
+=09}
+
...
+=09=09mausb_pr_warn("Urb=3D%p is already unlinked", urb);
+=09else
...
+=09spin_unlock_irqrestore(&mhcd->lock, flags);
+
+=09mausb_pr_debug("Urb=3D%p is removed from tree", urb);
+
+=09return urb_ctx;
+}
+
...
",
+=09=09       event->data.transfer_size,
+=09=09       event->data.rem_transfer_size, event->status);
...
+=09if (status < 0) {
+=09=09spin_unlock_irqrestore(&mhcd->lock, flags);
+=09=09mausb_pr_err("There is no free port, schedule delete ma_dev");
...
+=09=09mausb_pr_err("Devices disconnecting - app is unresponsive");
...
+=09=09=09mausb_pr_debug("Enqueue heartbeat_work madev_addr=3D%x",
...
+
+=09mausb_pr_info("Scheduling work for MAUSB device to be deleted");
+
...
+=09mausb_event.data.urb=09=09=3D (u64)request;
...
+=09=09mausb_pr_err("Missed more than %d heartbeats",
+=09=09=09     MAUSB_MAX_MISSED_HEARTBEATS);
+=09=09spin_unlock_irqrestore(&mss.lock, flags);
...
+=09if (atomic_read(&ma_dev->unresponsive_client)) {
+=09=09mausb_pr_err("Client is not responsive anymore - finish urb=20
immediately urb=3D%p, ep_handle=3D%#x, dev_handle=3D%#x",
+=09=09=09     urb, ep_ctx->ep_handle, ep_ctx->dev_handle);
...
+=09mausb_event.data.urb=09       =3D (u64)urb;
...
+=09=09mausb_pr_debug("Enqueue mausb_hcd_disconnect_work madev_addr=3D%x",
...
+{
+=09mausb_pr_info("Registering power states listener");
+
...
+{
+=09mausb_pr_info("Un-registering power states listener");
+
...
+=09struct mausb_device *dev =3D NULL;
+
+=09mausb_pr_info("Power state callback action =3D %ld", action);
...
+=09=09mausb_pr_info("Saving state before sleep");
+=09=09spin_lock_irqsave(&mss.lock, flags);
+=09=09if (!list_empty(&mss.madev_list))
+=09=09=09atomic_inc(&mss.num_of_transitions_to_sleep);
+
+=09=09list_for_each_entry(dev, &mss.madev_list, list_entry) {
+=09=09=09mausb_pr_info("Enqueue heartbeat_work madev_addr=3D%x",
+=09=09=09=09      dev->madev_addr);
+=09=09=09queue_work(dev->workq, &dev->heartbeat_work);
+=09=09}
+
...
+}
+
+static void mausb_populate_standard_ep_descriptor(struct usb_ep_desc=20
*std_desc,
...
+
+static void
+mausb_populate_superspeed_ep_descriptor(struct usb_ss_ep_comp_desc=20
*ss_desc,
...
+
+void
+mausb_init_standard_ep_descriptor(struct ma_usb_ephandlereq_desc_std=20
*std_desc,
...
+
+void
+mausb_init_superspeed_ep_descriptor(struct ma_usb_ephandlereq_desc_ss=20
*ss_desc,
...
+}
+
+int mausb_send_data(struct mausb_device *dev, enum mausb_channel=20
channel_num,
...
+}
+
+int mausb_send_transfer_ack(struct mausb_device *dev, struct=20
mausb_event *event)
+{
...
+=09=09=09     event->type, event->status);
...
+}
+
+int mausb_receive_data_msg(struct mausb_device *dev, struct mausb_event=20
*event)
+{
+=09int status =3D 0;
+=09struct mausb_urb_ctx *urb_ctx;
+
+=09mausb_pr_debug("Direction=3D%d", event->data.direction);
+
+=09if (!mausb_isoch_data_event(event)) {
+=09=09status =3D mausb_send_transfer_ack(dev, event);
+=09=09if (status < 0) {
+=09=09=09mausb_pr_warn("Sending acknowledgment failed");
...
+}
+
+u32 mausb_data_iterator_write(struct mausb_data_iter *iterator, void=20
*buffer,
+=09=09=09      u32 length)
+{
+=09if (iterator->buffer)
...
+}
+
+static inline void mausb_seek_virtual_buffer(struct mausb_data_iter=20
*iterator,
...
+}
+
+void mausb_init_data_iterator(struct mausb_data_iter *iterator, void=20
*buffer,
...
+=09=09=09=09       struct usb_endpoint_descriptor *
+=09=09=09=09       usb_std_desc);
+void mausb_init_superspeed_ep_descriptor(struct=20
...
+}
+
+static inline u8 mausb_transfer_type_from_hdr(struct ma_usb_hdr_common=20
*hdr)
+{
...
diff --git a/drivers/usb/mausb_host/ma_usb.h=20
...
+#endif /* __KERNEL__ */
+
+#define MA_USB_SET_FIELD_(_m_, _v)=20
__mausb_set_field(MA_USB_##_m_##_MASK, _v)
+#define MA_USB_GET_FIELD_(_m_, _v)=20
...
+
+#define MAUSB_ISOCH_TRANSFER_HDR_SIZE (u16)(sizeof(struct=20
ma_usb_hdr_common) +\
...
diff --git a/drivers/usb/mausb_host/mausb_address.h=20
...
+=09struct {
+=09=09union {
+=09=09=09char=09ip4[ADDR_LEN];
+=09=09=09u8=09ip6[ADDR_LEN];
+=09=09} address;
...
diff --git a/drivers/usb/mausb_host/mausb_event.h=20
...
+=09status =3D mausb_register_power_state_listener();
  ...
  +=09status =3D mausb_create_dev();
+=09if (status < 0)
+=09=09goto unregister_power_state_listener;
+
