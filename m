Return-Path: <linux-usb+bounces-35046-lists+linux-usb=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-usb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id GFeAOOubummHZgIAu9opvQ
	(envelope-from <linux-usb+bounces-35046-lists+linux-usb=lfdr.de@vger.kernel.org>)
	for <lists+linux-usb@lfdr.de>; Wed, 18 Mar 2026 13:34:51 +0100
X-Original-To: lists+linux-usb@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [IPv6:2600:3c09:e001:a7::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 7937D2BB8A8
	for <lists+linux-usb@lfdr.de>; Wed, 18 Mar 2026 13:34:51 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 0E2B7300E590
	for <lists+linux-usb@lfdr.de>; Wed, 18 Mar 2026 12:34:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 147723D6CA5;
	Wed, 18 Mar 2026 12:34:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=realtek.com header.i=@realtek.com header.b="Qzxny7wB"
X-Original-To: linux-usb@vger.kernel.org
Received: from rtits2.realtek.com.tw (rtits2.realtek.com [211.75.126.72])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E22A33D6466;
	Wed, 18 Mar 2026 12:34:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=211.75.126.72
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1773837272; cv=none; b=BtUxJRXrx2VPmqoBXVw7AX+hci33a1O0UCxOhJjPxLkPnJrL+KYbKey+eLFPYSlouRG5sHphbg0D3K6YoC5n08pQPFbDEFuRXqu5RRPeO1eKO1uCCbY/NKF6J3tRrVDY1m2VjHB6S+9ohOT7lqdNvx0KRZWa3tGvU5fwlDxut50=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1773837272; c=relaxed/simple;
	bh=7xpe90w/zVu+VzIm5sIKknVv51u9ZAj9XymDDk0ztv4=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=McZzA7L8JA5v9Yq6FhlfBDsvVOUT3MsbYZ71YbzwEvR48slLpnboFmF9CGMLuhV6N4S3bpaUWCRor3PmIULCLx9ghQ3VVlhJHhx2Xo9Eh3qUu80LQfRWV3Q5ThctvIRUihF6kKKNzZkfS4vqM2nJUvRkQ9WNII9paVcPsedJOkM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=realtek.com; spf=pass smtp.mailfrom=realtek.com; dkim=pass (2048-bit key) header.d=realtek.com header.i=@realtek.com header.b=Qzxny7wB; arc=none smtp.client-ip=211.75.126.72
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=realtek.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=realtek.com
X-SpamFilter-By: ArmorX SpamTrap 5.80 with qID 62ICXpSV21675529, This message is accepted by code: ctloc85258
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=realtek.com; s=dkim;
	t=1773837231; bh=6KeQuzz3EudYq1xkKTEG4IiYC1y+RHadhqJ18EuGREA=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Transfer-Encoding:Content-Type;
	b=
Received: from mail.realtek.com (rtkexhmbs04.realtek.com.tw[10.21.1.54])
	by rtits2.realtek.com.tw (8.15.2/3.21/5.94) with ESMTPS id 62ICXpSV21675529
...
Subject: [PATCH net-next 2/2] r8152: add helper functions for PHY OCP registers
Date: Wed, 18 Mar 2026 20:33:13 +0800
Message-ID: <20260318123313.2313-446-nic_swsd@realtek.com>
...
X-Spamd-Result: default: False [-1.66 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-35046-lists,linux-usb=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	FROM_HAS_DN(0.00)[];
...
---
 drivers/net/usb/r8152.c | 683 +++++++++++++---------------------------
 1 file changed, 220 insertions(+), 463 deletions(-)

diff --git a/drivers/net/usb/r8152.c b/drivers/net/usb/r8152.c
index da9a93d5a733..e6c5b64a9889 100644
...
@@ -6874,11 +6885,7 @@ static void r8153_init(struct r8152 *tp)
...
@@ -6993,11 +7000,7 @@ static void r8153b_init(struct r8152 *tp)
...
@@ -7075,11 +7078,7 @@ static void r8153c_init(struct r8152 *tp)
...
@@ -7131,9 +7130,7 @@ static void r8156_hw_phy_cfg(struct r8152 *tp)
 	case PHY_STAT_EXT_INIT:
 		rtl8152_apply_firmware(tp, true);
...
+		ocp_reg_clr_bits(tp, 0xa468, BIT(3) | BIT(1));
 	...
 	case PHY_STAT_LAN_ON:
 	case PHY_STAT_PWRDN:
@@ -7155,153 +7152,57 @@ static void r8156_hw_phy_cfg(struct r8152 *tp)
...
@@ -7325,17 +7226,12 @@ static void r8156_hw_phy_cfg(struct r8152 *tp)
...
@@ -7345,34 +7241,19 @@ static void r8156_hw_phy_cfg(struct r8152 *tp)
...
@@ -7433,9 +7314,7 @@ static void r8156_hw_phy_cfg(struct r8152 *tp)
 		}
...
+		ocp_reg_set_bits(tp, OCP_INTR_EN, INTR_SPEED_FORCE);
 	...
 	default:
 		break;
@@ -7443,12 +7322,8 @@ static void r8156_hw_phy_cfg(struct r8152 *tp)
...
+	ocp_reg_clr_bits(tp, 0xa5ea, BIT(0));
 	...
 	if (tp->eee_en)
@@ -7468,21 +7343,12 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
 	switch (tp->version) {
 	case RTL_VER_12:
...
+		ocp_reg_w0w1(tp, 0xbf46, 0xf00, 0x700);
 	...
 	case RTL_VER_13:
 	case RTL_VER_15:
@@ -7499,13 +7365,8 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
 	case PHY_STAT_EXT_INIT:
 		rtl8152_apply_firmware(tp, true);
...
+		ocp_reg_clr_bits(tp, 0xa468, BIT(3) | BIT(1));
 	...
 	case PHY_STAT_LAN_ON:
 	case PHY_STAT_PWRDN:
@@ -7514,11 +7375,7 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
 		break;
 	}
...
+	r8152_mdio_test_and_clr_bit(tp, MII_BMCR, BMCR_PDOWN);
 	...
 	/* disable ALDPS before updating the PHY parameters */
 	r8153_aldps_en(tp, false);
@@ -7533,21 +7390,12 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
...
@@ -7625,21 +7473,15 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
...
@@ -7672,64 +7514,33 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
...
@@ -7744,41 +7555,25 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
...
+		ocp_reg_w0w1(tp, 0xad30, 0x0003, 0x0001);
 	...
 	case RTL_VER_15:
 		/* EEE parameter */
@@ -7787,20 +7582,11 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
...
@@ -7815,48 +7601,35 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
...
+	ocp_reg_clr_bits(tp, 0xa5ea, BIT(0));
 	...
 	if (tp->eee_en)
@@ -7896,17 +7669,10 @@ static void r8156_init(struct r8152 *tp)
 	}
...
@@ -7994,20 +7760,11 @@ static void r8156b_init(struct r8152 *tp)
