...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6A5AE1CD5B2
	for <lists+linux-usb@lfdr.de>; Mon, 11 May 2020 11:51:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729046AbgEKJv3 (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Mon, 11 May 2020 05:51:29 -0400
Received: from esa6.microchip.iphmx.com ([216.71.154.253]:51834 "EHLO
        esa6.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728209AbgEKJv2 (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Mon, 11 May 2020 05:51:28 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1589190686; x=1620726686;
  h=from:to:cc:subject:date:message-id:mime-version;
  bh=RDxm/KpsdPY9E9s6WVXmjANhJ5t7m4zo2mAclmF1hPw=;
  b=SrY5CYRRmIIjWasjwDXTF9JDjSrt71rULq5Oq28eDWHaQKniEF8hjZbV
   VIPCl3YSm5xlZGSD/JO+zQCRPhONik5TkKokASGAXf5nYccLTz3iKpdor
   /Af+E9Sr3olyPb6n5ykFLu5TRSyAqzrsZpmGi85xUjV36XPPMu52k7jD1
   ugtjZgC7IPHJlN6CyGsD/KFItOx2Vg3gJ9BRY2LBiIogq5twOStkRcnMC
   R7JQIw6u0kN3YhZfxzzokCsBjdtWCOgk6xlekIwmb61OuSoTcUUwJCzgu
   gQsWSM2Nxr23RX7Twwr6n0krmUZ4D8QCI2lpDYIAzITUsiRceXrjPkAos
   Q==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.73,379,1583218800"; 
   d="scan'208";a="11974758"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa6.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 11 May 2020 02:51:25 -0700
Received: from chn-vm-ex04.mchp-main.com (10.10.85.152) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1713.5; Mon, 11 May 2020 02:51:27 -0700
Received: from localhost.localdomain (10.10.115.15) by
 chn-vm-ex04.mchp-main.com (10.10.85.152) with Microsoft SMTP Server id
 15.1.1713.5 via Frontend Transport; Mon, 11 May 2020 02:51:24 -0700
From:   Christian Gromm <christian.gromm@microchip.com>
To:     <gregkh@linuxfoundation.org>
CC:     <driverdev-devel@linuxdriverproject.org>,
        <linux-usb@vger.kernel.org>,
        Christian Gromm <christian.gromm@microchip.com>
Subject: [PATCH RFC] drivers: most: add USB adapter driver
Date:   Mon, 11 May 2020 11:51:15 +0200
Message-ID: <1589190675-21145-1-git-send-email-christian.gromm@microchip.com>
...
---
 ...
 create mode 100644 drivers/most/usb/Kconfig
 create mode 100644 drivers/most/usb/Makefile
 create mode 100644 drivers/most/usb/usb.c
...
diff --git a/drivers/most/usb/Makefile b/drivers/most/usb/Makefile
new file mode 100644
index 0000000..c2b2073
--- /dev/null
+++ b/drivers/most/usb/Makefile
@@ -0,0 +1,4 @@
+# SPDX-License-Identifier: GPL-2.0
