...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 72EB4608EE5
	for <lists+linux-usb@lfdr.de>; Sat, 22 Oct 2022 20:04:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229531AbiJVSEv (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Sat, 22 Oct 2022 14:04:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44526 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229497AbiJVSEt (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Sat, 22 Oct 2022 14:04:49 -0400
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 57191476D5
        for <linux-usb@vger.kernel.org>; Sat, 22 Oct 2022 11:04:44 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666461884; x=1697997884;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=5KGS72gDEEOcC+e5hVOLySbthnhgUvawNIfwH6btI6E=;
  b=FIUp2obYb+R7qQqn1cRDjEJMBdapPWtQu0At/WdwPQLvuyd1TUD5o9fI
   Id1SWcKk1J7ULo7T4q2tR+jJN8sL26xyOVB5e/BzhrQT/EHhROUpWseN1
   E8K8CLrKnNhjab5OABSKFTYlRjiaZaxd294qhyYge4bYmXvwlbmxRWqvw
   xo35UP1qwUDagVism2fPeqVvoU8c9PG4o9Clg6DYz7xHda6xwr5gJgLgx
   9cnn3xxogHTOcjlvjx1IAzruWabcVRKdjrZde9IafLqSCUusCmb2+hnmB
   jgxFXS7JPeLWR4rmE6d9lIByvhNKKHANwgOqvGQaLGrTsQQtAAly/Vuww
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10508"; a="393515555"
X-IronPort-AV: E=Sophos;i="5.95,205,1661842800"; 
   d="scan'208";a="393515555"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Oct 2022 11:04:43 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10508"; a="876030146"
X-IronPort-AV: E=Sophos;i="5.95,205,1661842800"; 
   d="scan'208";a="876030146"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by fmsmga006.fm.intel.com with ESMTP; 22 Oct 2022 11:04:41 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1omIrR-0003n3-0r;
        Sat, 22 Oct 2022 18:04:41 +0000
Date:   Sun, 23 Oct 2022 02:04:33 +0800
From:   kernel test robot <lkp@intel.com>
To:     Arnd Bergmann <arnd@arndb.de>
Cc:     llvm@lists.linux.dev, kbuild-all@lists.01.org,
        linux-usb@vger.kernel.org,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: [usb:usb-testing 12/23] arch/arm/mach-s3c/devs.c:30:10: fatal error:
 'linux/platform_data/s3c-hsudc.h' file not found
Message-ID: <202210230210.NvXmltv5-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="9aPfq/G0Sg4ZCuU6"
...
head:   ef9b5001471cf71e4e587dcbaa6e84f13cec03fd
commit: 685624f14a5344590f2c00bae17580e47280ce56 [12/23] usb: gadget: remove s3c24xx drivers
...
reproduce (this is a W=1 build):
        ...
        # https://git.kernel.org/pub/scm/linux/kernel/git/gregkh/usb.git/commit/?id=685624f14a5344590f2c00bae17580e47280ce56
        git remote add usb https://git.kernel.org/pub/scm/linux/kernel/git/gregkh/usb.git
        git fetch --no-tags usb usb-testing
        git checkout 685624f14a5344590f2c00bae17580e47280ce56
...
vim +30 arch/arm/mach-s3c/devs.c

61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03   7  
f67f6c00c7f367 arch/arm/plat-samsung/devs.c Arnd Bergmann   2020-08-06   8  #include <linux/gpio.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03   9  #include <linux/kernel.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  10  #include <linux/types.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  11  #include <linux/interrupt.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  12  #include <linux/list.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  13  #include <linux/timer.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  14  #include <linux/init.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  15  #include <linux/serial_core.h>
334a1c70bb03d7 arch/arm/plat-samsung/devs.c Tushar Behera   2014-02-14  16  #include <linux/serial_s3c.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  17  #include <linux/platform_device.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  18  #include <linux/io.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  19  #include <linux/slab.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  20  #include <linux/string.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  21  #include <linux/dma-mapping.h>
5716714927b789 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  22  #include <linux/fb.h>
5716714927b789 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  23  #include <linux/gfp.h>
0523ec3a685573 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  24  #include <linux/mtd/mtd.h>
0523ec3a685573 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  25  #include <linux/mtd/onenand.h>
bad1e6aadd17c9 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  26  #include <linux/mtd/partitions.h>
bad1e6aadd17c9 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  27  #include <linux/mmc/host.h>
5716714927b789 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  28  #include <linux/ioport.h>
2bb1ad17d66da3 arch/arm/plat-samsung/devs.c Sachin Kamat    2014-03-21  29  #include <linux/sizes.h>
715a3e41e78a40 arch/arm/plat-samsung/devs.c Heiko Stübner   2011-12-19 @30  #include <linux/platform_data/s3c-hsudc.h>
126625e1bf3228 arch/arm/plat-samsung/devs.c Lukasz Majewski 2012-05-09  31  #include <linux/platform_data/s3c-hsotg.h>
7f99ef2284b46f arch/arm/plat-samsung/devs.c Heiko Stuebner  2013-10-08  32  #include <linux/platform_data/dma-s3c24xx.h>
61c542bfda19c8 arch/arm/plat-samsung/devs.c Kukjin Kim      2011-10-03  33  

:::::: The code at line 30 was first introduced by commit
:::::: 715a3e41e78a40e1e711298667435d5a2cef1972 usb: gadget: s3c-hsudc: move platform_data struct to global header
