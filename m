...
Subject: [PATCH 23/25] thunderbolt: Add support for Time Management Unit
Date:   Wed, 23 Oct 2019 14:21:52 +0300
Message-Id: <20191023112154.64235-24-mika.westerberg@linux.intel.com>
...
index 546269ddd0e4..6a39e71bd682 100644
--- a/drivers/thunderbolt/switch.c
+++ b/drivers/thunderbolt/switch.c
@@ -2298,6 +2298,10 @@ int tb_switch_add(struct tb_switch *sw)
...
index d7d07aeee1a4..4b52b7d3eef7 100644
...
+			tb_switch_tmu_disable(port->remote->sw);
 			...
 			port->remote = NULL;
@@ -856,6 +879,8 @@ static int tb_start(struct tb *tb)
 		return ret;
 	}
...
@@ -887,6 +912,9 @@ static void tb_restore_children(struct tb_switch *sw)
 {
 	struct tb_port *port;
