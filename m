Return-Path: <linux-usb+bounces-7025-lists+linux-usb=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-usb@lfdr.de
Delivered-To: lists+linux-usb@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id C0577862711
	for <lists+linux-usb@lfdr.de>; Sat, 24 Feb 2024 20:46:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 13EA01F21A5C
	for <lists+linux-usb@lfdr.de>; Sat, 24 Feb 2024 19:46:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 626124C63D;
	Sat, 24 Feb 2024 19:46:23 +0000 (UTC)
X-Original-To: linux-usb@vger.kernel.org
Received: from mx3.molgen.mpg.de (mx3.molgen.mpg.de [141.14.17.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3A55F12B82;
	Sat, 24 Feb 2024 19:46:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=141.14.17.11
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708803983; cv=none; b=iaNLktYTvgJOCgGQxxSS/kM7XM49uywWSR/sAhfmmsESBFKrFISFi3W9KZ+zbPTBomb4J8bFxn6rn6XC7RXEzO2zC/gA5HR78BgAEUrPQt9B2MvEcZBJTLNG6ZULNcQkg39XcA11vUi4LO33dpXENDBu1KhmDi5TKQbDJGneqX0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708803983; c=relaxed/simple;
	bh=G2oEAGJLlPyjQXjnDqRIcGkYyLIIYUGOLMjJr3uTSQQ=;
	h=Message-ID:Date:MIME-Version:To:Cc:From:Subject:Content-Type; b=pPtsyfk41//9GsKBG/Nz5u/WPBtAy9LJeTsEUywApcazFRCqAwPzCYuugxazmRUO3Aroux4g/IarReD8sIcFvR314/0DfIK59PCI38QBYOvnuT4plEfMeuPrP1iP8tfv5ICmuov3pxrCGdApNjxKQ9nUAF8/l/MhHGjeQ9yw5Ao=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=molgen.mpg.de; spf=pass smtp.mailfrom=molgen.mpg.de; arc=none smtp.client-ip=141.14.17.11
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=molgen.mpg.de
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=molgen.mpg.de
Received: from [192.168.0.6] (ip5f5af3f1.dynamic.kabel-deutschland.de [95.90.243.241])
	(using TLSv1.3 with cipher TLS_AES_128_GCM_SHA256 (128/128 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	(Authenticated sender: pmenzel)
	by mx.molgen.mpg.de (Postfix) with ESMTPSA id 580C261E5FE04;
	Sat, 24 Feb 2024 20:45:44 +0100 (CET)
Message-ID: <14c16bf9-bcdf-4e6b-ac36-f995f5f088a1@molgen.mpg.de>
Date: Sat, 24 Feb 2024 20:45:43 +0100
Precedence: bulk
...
Cc: linux-usb@vger.kernel.org, netdev@vger.kernel.org,
 LKML <linux-kernel@vger.kernel.org>, Mike Jones <mike@mjones.io>
From: Paul Menzel <pmenzel@molgen.mpg.de>
Subject: xhci_hcd: `Timeout while waiting for setup device command`, 37 s
...
I suspended a Dell XPS 13 9360 with no devices attached into ACPI S3. 
Then connecting an LMP USB-C mini Dock (P/N 15954) [1] with an Ethernet 
cable attached to the left USB-C port and resumed the system from ACPI 
S3. It took 37 seconds, until the link was established.

```
[    0.000000] Linux version 6.8.0-rc5+ 
(build@bohemianrhapsody.molgen.mpg.de) (gcc (Debian 13.2.0-13) 13.2.0, 
GNU ld (GNU Binutils for Debian) 2.42) #27 SMP PREEMPT_DYNAMIC Wed Feb 
21 09:09:49 CET 2024
...
[135623.353870] Freezing remaining freezable tasks completed (elapsed 
0.001 seconds)
...
[134788.714287] wlp58s0: RX AssocResp from a4:97:33:06:77:d3 
(capab=0x511 status=0 aid=102)
[134788.717462] wlp58s0: associated
[134788.721574] wlp58s0: Limiting TX power to 30 (30 - 0) dBm as 
advertised by a4:97:33:06:77:d3
...
[135620.148856] wlp58s0: deauthenticating from a4:97:33:06:77:d3 by 
...
[135629.976929] mei_hdcp 
0000:00:16.0-b638ab7e-94e2-4ea2-a552-d1c54b627f04: bound 0000:00:02.0 
(ops i915_hdcp_ops [i915])
[135629.977326] OOM killer enabled.
[135629.977329] Restarting tasks ...
[135629.977351] pci 0000:01:00.0: [8086:1576] type 01 class 0x060400 
...
[135629.977446] pci 0000:01:00.0:   bridge window [mem 
...
[135629.981650] pci 0000:02:00.0: [8086:1576] type 01 class 0x060400 
...
[135629.982333] pci 0000:02:01.0: [8086:1576] type 01 class 0x060400 
PCIe Switch Downstream Port
...
[135629.982426] pci 0000:02:01.0:   bridge window [mem 
0xa0000000-0xc1ffffff 64bit pref]
...
[135629.986390] pci 0000:02:02.0: [8086:1576] type 01 class 0x060400 
PCIe Switch Downstream Port
...
[135629.990420] pci 0000:39:00.0: [8086:15b5] type 00 class 0x0c0330 
PCIe Endpoint
...
[135629.997892] pci 0000:02:01.0: bridge window [io  0x1000-0x0fff] to 
[bus 04-38] add_size 1000
[135629.997901] pci 0000:02:02.0: bridge window [io  0x1000-0x0fff] to 
[bus 39] add_size 1000
[135629.997904] pci 0000:02:02.0: bridge window [mem 
0x00100000-0x000fffff 64bit pref] to [bus 39] add_size 200000 add_align 
100000
[135629.997908] pci 0000:01:00.0: bridge window [io  0x1000-0x0fff] to 
[bus 02-39] add_size 2000
[135629.997912] pci 0000:01:00.0: bridge window [io  size 0x2000]: can't 
assign; no space
[135629.997915] pci 0000:01:00.0: bridge window [io  size 0x2000]: 
failed to assign
[135629.997917] pci 0000:01:00.0: bridge window [io  size 0x2000]: can't 
assign; no space
[135629.997924] pci 0000:01:00.0: bridge window [io  size 0x2000]: 
failed to assign
[135629.997929] pci 0000:02:02.0: bridge window [mem size 0x00200000 
64bit pref]: can't assign; no space
[135629.997931] pci 0000:02:02.0: bridge window [mem size 0x00200000 
64bit pref]: failed to assign
[135629.997932] pci 0000:02:01.0: bridge window [io  size 0x1000]: can't 
assign; no space
[135629.997934] pci 0000:02:01.0: bridge window [io  size 0x1000]: 
failed to assign
[135629.997935] pci 0000:02:02.0: bridge window [io  size 0x1000]: can't 
assign; no space
[135629.997937] pci 0000:02:02.0: bridge window [io  size 0x1000]: 
failed to assign
[135629.997940] pci 0000:02:02.0: bridge window [mem size 0x00200000 
64bit pref]: can't assign; no space
[135629.997942] pci 0000:02:02.0: bridge window [mem size 0x00200000 
64bit pref]: failed to assign
[135629.997982] pci 0000:02:02.0: bridge window [io  size 0x1000]: can't 
assign; no space
[135629.998009] pci 0000:02:02.0: bridge window [io  size 0x1000]: 
failed to assign
[135629.998037] pci 0000:02:01.0: bridge window [io  size 0x1000]: can't 
assign; no space
[135629.998063] pci 0000:02:01.0: bridge window [io  size 0x1000]: 
failed to assign
...
0xc4000000-0xd9efffff]
[135629.998149] pci 0000:02:01.0:   bridge window [mem 
0xa0000000-0xc1ffffff 64bit pref]
...
0xc4000000-0xda0fffff]
[135629.998179] pci 0000:01:00.0:   bridge window [mem 
0xa0000000-0xc1ffffff 64bit pref]
[135630.003545] xhci_hcd 0000:39:00.0: xHCI Host Controller
[135630.003562] xhci_hcd 0000:39:00.0: new USB bus registered, assigned 
bus number 3
...
[135630.024946] xhci_hcd 0000:39:00.0: new USB bus registered, assigned 
bus number 4
...
[135630.078734] hub 3-0:1.0: trying to enable port power on 
non-switchable hub
...
[135630.109230] hub 4-0:1.0: trying to enable port power on 
non-switchable hub
[135630.110174] pci_bus 0000:02: Allocating resources
[135630.110197] pcieport 0000:02:01.0: bridge window [io  0x1000-0x0fff] 
to [bus 04-38] add_size 1000
[135630.110205] pcieport 0000:02:02.0: bridge window [io  0x1000-0x0fff] 
to [bus 39] add_size 1000
[135630.110210] pcieport 0000:02:02.0: bridge window [mem 
0x00100000-0x000fffff 64bit pref] to [bus 39] add_size 200000 add_align 
100000
[135630.110218] pcieport 0000:01:00.0: bridge window [io  0x1000-0x0fff] 
...
failed to assign
[135630.110245] pcieport 0000:02:02.0: bridge window [mem size 
0x00200000 64bit pref]: can't assign; no space
[135630.110249] pcieport 0000:02:02.0: bridge window [mem size 
...
failed to assign
[135630.110271] pcieport 0000:02:02.0: bridge window [mem size 
0x00200000 64bit pref]: can't assign; no space
[135630.110275] pcieport 0000:02:02.0: bridge window [mem size 
0x00200000 64bit pref]: failed to assign
...
[135643.395529] usb 3-1.1-port3: debounce total 100ms stable 100ms 
status 0x100
[135643.395546] hub 3-1.1:1.0: hub_suspend
[135643.395900] usb 3-1.1: usb auto-suspend, wakeup 1
[135643.399598] usb 4-1.1-port3: debounce total 100ms stable 100ms 
status 0x203
...
[135654.447545] r8152-cfgselector 4-1.1.3: adding 4-1.1.3:1.0 (config 
#1, interface 0)
