...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 63575625CA4
	for <lists+linux-usb@lfdr.de>; Fri, 11 Nov 2022 15:10:53 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234358AbiKKOKu (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Fri, 11 Nov 2022 09:10:50 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:32810 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234615AbiKKOK3 (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Fri, 11 Nov 2022 09:10:29 -0500
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6505C8BD68
        for <linux-usb@vger.kernel.org>; Fri, 11 Nov 2022 06:01:16 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1668175276; x=1699711276;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=SI2sf6lYL96OTtnP1/IRiS7HDseaSZKUXl7ZgR7bw2E=;
  b=EVhWiA7UHggm4DKLAaNd+DZiCl8JmnGLuCuiFR50VtmX5+MyCzjGwxGm
   mD94YA8sUOW7KSyXQ0gbUJuEq5Z96tIhUIQRjxDNKahFTaPC8trEn8c+t
   ahwsVvZnG9GL1Ucdc/hANAgsd7G0isiXjwPJssWZVkfZi83g3eOMKKYi0
   vzpoapGKuOjvXan+NMG1cOUgDpdLzEfOgD8Fvaufl3FUt1QNkuMNOQKV7
   CSdyNxlrdu/uX7D32kNVR4Gd671nFYxEMK2cTdlwZ+zwF/ya0qvlpYb6z
   TB/nUQum5M5EGUDCaUupSLMM+iTAXFy1+SmdrBh0DmHQBBuVMgXurOdrl
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10528"; a="313387720"
X-IronPort-AV: E=Sophos;i="5.96,156,1665471600"; 
   d="scan'208";a="313387720"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Nov 2022 06:01:11 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10528"; a="706548850"
X-IronPort-AV: E=Sophos;i="5.96,156,1665471600"; 
   d="scan'208";a="706548850"
Received: from lkp-server01.sh.intel.com (HELO e783503266e8) ([10.239.97.150])
  by fmsmga004.fm.intel.com with ESMTP; 11 Nov 2022 06:01:09 -0800
Received: from kbuild by e783503266e8 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1otUai-00040D-1w;
        Fri, 11 Nov 2022 14:01:08 +0000
Date:   Fri, 11 Nov 2022 22:00:57 +0800
From:   kernel test robot <lkp@intel.com>
To:     Linus Walleij <linus.walleij@linaro.org>
Cc:     oe-kbuild-all@lists.linux.dev, linux-usb@vger.kernel.org,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: [usb:usb-testing 22/36] fotg210-core.c:undefined reference to
 `usb_disabled'
Message-ID: <202211112132.0BUPGKCd-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="XMX8HXmlzZce73U2"
...
head:   dd65a243a915ca319ed5fee9161a168c836fa2f2
commit: aeffd2c3b09f4f50438ec8960095129798bcb33a [22/36] usb: fotg210: Compile into one module
config: s390-randconfig-c031-20221110
compiler: s390-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://git.kernel.org/pub/scm/linux/kernel/git/gregkh/usb.git/commit/?id=aeffd2c3b09f4f50438ec8960095129798bcb33a
        git remote add usb https://git.kernel.org/pub/scm/linux/kernel/git/gregkh/usb.git
        git fetch --no-tags usb usb-testing
        git checkout aeffd2c3b09f4f50438ec8960095129798bcb33a
...
All errors (new ones prefixed by >>):
   ...
   s390-linux-ld: s390-linux-ld: DWARF error: could not find abbrev number 1131480
   drivers/usb/fotg210/fotg210-core.o: in function `fotg210_init':
>> fotg210-core.c:(.init.text+0x26): undefined reference to `usb_disabled'
   s390-linux-ld: s390-linux-ld: DWARF error: could not find abbrev number 17
   drivers/usb/fotg210/fotg210-hcd.o: in function `fotg210_urb_done':
...
>> s390-linux-ld: fotg210-hcd.c:(.text+0xdc2): undefined reference to `usb_hcd_giveback_urb'
   s390-linux-ld: drivers/usb/fotg210/fotg210-hcd.o: in function `fotg210_clear_tt_buffer.constprop.0':
>> fotg210-hcd.c:(.text+0x1654): undefined reference to `usb_hub_clear_tt_buffer'
   s390-linux-ld: drivers/usb/fotg210/fotg210-hcd.o: in function `fotg210_run':
>> fotg210-hcd.c:(.text+0x25b4): undefined reference to `ehci_cf_port_reset_rwsem'
   s390-linux-ld: drivers/usb/fotg210/fotg210-hcd.o: in function `qh_make.constprop.0':
...
>> s390-linux-ld: fotg210-hcd.c:(.text+0x5f38): undefined reference to `usb_calc_bus_time'
   s390-linux-ld: fotg210-hcd.c:(.text+0x6006): undefined reference to `usb_calc_bus_time'
   s390-linux-ld: drivers/usb/fotg210/fotg210-hcd.o: in function `itd_submit':
   fotg210-hcd.c:(.text+0x7322): undefined reference to `usb_calc_bus_time'
...
>> s390-linux-ld: fotg210-hcd.c:(.text+0x7564): undefined reference to `usb_hcd_unlink_urb_from_ep'
   s390-linux-ld: drivers/usb/fotg210/fotg210-hcd.o: in function `fotg210_urb_enqueue':
>> fotg210-hcd.c:(.text+0x76b4): undefined reference to `usb_hcd_link_urb_to_ep'
   s390-linux-ld: fotg210-hcd.c:(.text+0x7704): undefined reference to `usb_hcd_unlink_urb_from_ep'
   s390-linux-ld: fotg210-hcd.c:(.text+0x77ec): undefined reference to `usb_hcd_link_urb_to_ep'
   s390-linux-ld: fotg210-hcd.c:(.text+0x78e2): undefined reference to `usb_hcd_unlink_urb_from_ep'
   s390-linux-ld: drivers/usb/fotg210/fotg210-hcd.o: in function `fotg210_irq':
...
>> s390-linux-ld: fotg210-hcd.c:(.text+0x8af6): undefined reference to `usb_hcd_poll_rh_status'
   s390-linux-ld: drivers/usb/fotg210/fotg210-hcd.o: in function `fotg210_urb_dequeue':
>> fotg210-hcd.c:(.text+0x8b70): undefined reference to `usb_hcd_check_unlink_urb'
   s390-linux-ld: drivers/usb/fotg210/fotg210-hcd.o: in function `fotg210_hcd_probe':
...
>> s390-linux-ld: fotg210-hcd.c:(.text+0x8fc8): undefined reference to `usb_put_hcd'
   s390-linux-ld: drivers/usb/fotg210/fotg210-hcd.o: in function `fotg210_hcd_remove':
>> fotg210-hcd.c:(.text+0x90a0): undefined reference to `usb_remove_hcd'
   s390-linux-ld: fotg210-hcd.c:(.text+0x90aa): undefined reference to `usb_put_hcd'
   s390-linux-ld: drivers/usb/fotg210/fotg210-hcd.o: in function `fotg210_hcd_init':
...
>> s390-linux-ld: fotg210-hcd.c:(.init.text+0x3e): undefined reference to `usb_hcds_loaded'
   s390-linux-ld: drivers/usb/fotg210/fotg210-hcd.o: in function `fotg210_hcd_cleanup':
