Return-Path: <linux-usb+bounces-33747-lists+linux-usb=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-usb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 6CnJFZxpoGk3jgQAu9opvQ
	(envelope-from <linux-usb+bounces-33747-lists+linux-usb=lfdr.de@vger.kernel.org>)
	for <lists+linux-usb@lfdr.de>; Thu, 26 Feb 2026 16:41:16 +0100
X-Original-To: lists+linux-usb@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id F3EEE1A8F1E
	for <lists+linux-usb@lfdr.de>; Thu, 26 Feb 2026 16:41:15 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 1EA433052B81
	for <lists+linux-usb@lfdr.de>; Thu, 26 Feb 2026 15:40:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8D32340FD8F;
	Thu, 26 Feb 2026 15:40:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ew.tq-group.com header.i=@ew.tq-group.com header.b="nl1a95Jb"
X-Original-To: linux-usb@vger.kernel.org
Received: from mx-relay83-hz1.antispameurope.com (mx-relay83-hz1.antispameurope.com [94.100.132.252])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D465E40B6F9
	for <linux-usb@vger.kernel.org>; Thu, 26 Feb 2026 15:40:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=pass smtp.client-ip=94.100.132.252
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1772120408; cv=pass; b=CI6ToDoMfAJFqpS7FwE8pD9OB2af5EB0zQequ8fk0ZMq2Wyem4j3LDqq8+Ih94Dyh05/NsOzks6aoYZ+Zl6AkgFCI4ztceVSLVcGJx1z8MS7f3ywp1E6D7adhdYZGAdvqQf39eMPioSrDLytCGrYbCK5U4bhemNs4JqUvoUymLU=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1772120408; c=relaxed/simple;
	bh=jxqCkbk0ousEl4+gyNxWQ1ljJnSn+EmtIvUOEf+j6t8=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=Z4rDQDrLipvU6zucLN9jM3Ta+3cnhb4r7wBl9tOxAA8Wu0ZfckOfw8nUILA7+v2hgCGRITFe+JAfXMQBa6DA4XUl/nGK+t3+HWOS6JaVnxnPz2d6HJKzOPVFn4mBODOQJGky5TSXadL5vtY6PuOOSBsimlaYLmgng4KSWhfoDFs=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=ew.tq-group.com; spf=pass smtp.mailfrom=ew.tq-group.com; dkim=pass (2048-bit key) header.d=ew.tq-group.com header.i=@ew.tq-group.com header.b=nl1a95Jb; arc=pass smtp.client-ip=94.100.132.252
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=ew.tq-group.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ew.tq-group.com
ARC-Authentication-Results: i=1; mx-gate83-hz1.hornetsecurity.com 1; spf=pass
 reason=mailfrom (ip=94.100.132.6, headerfrom=ew.tq-group.com)
 smtp.mailfrom=ew.tq-group.com smtp.helo=smtp-out01-hz1.hornetsecurity.com;
 dmarc=pass header.from=ew.tq-group.com orig.disposition=pass
ARC-Message-Signature: a=rsa-sha256;
 bh=lmy890F/KSXWJUYgP7zOrsSNTRi84I+hmhBWG+EQvs4=; c=relaxed/relaxed;
 d=hornetsecurity.com; h=from:to:date:subject:mime-version:; i=1; s=hse1;
 t=1772120368;
 b=
ARC-Seal: a=rsa-sha256; cv=none; d=hornetsecurity.com; i=1; s=hse1;
 t=1772120368;
 b=
Received: from he-nlb01-hz1.hornetsecurity.com ([94.100.132.6]) by mx-relay83-hz1.antispameurope.com;
 Thu, 26 Feb 2026 16:39:28 +0100
Received: from steina-w.tq-net.de (host-82-135-125-110.customer.m-online.net [82.135.125.110])
	(Authenticated sender: alexander.stein@ew.tq-group.com)
	by smtp-out01-hz1.hornetsecurity.com (Postfix) with ESMTPSA id 67877A41357;
	Thu, 26 Feb 2026 16:39:09 +0100 (CET)
...
Subject: [PATCH v3 4/5] arm64: dts: freescale: add initial device tree for TQMa8x
Date: Thu, 26 Feb 2026 16:38:53 +0100
Message-ID: <20260226153859.665901-5-alexander.stein@ew.tq-group.com>
...
X-cloud-security-disclaimer: This E-Mail was scanned by E-Mailservice on mx-relay83-hz1.antispameurope.com with 4fMFxV4Ct2z2McyY
X-cloud-security-connect: he-nlb01-hz1.hornetsecurity.com[94.100.132.6], TLS=1, IP=94.100.132.6
X-cloud-security-Digest:7b7ceca67f9865db1892530e11516836
X-cloud-security:scantime:1.486
DKIM-Signature: a=rsa-sha256;
 bh=lmy890F/KSXWJUYgP7zOrsSNTRi84I+hmhBWG+EQvs4=; c=relaxed/relaxed;
 d=ew.tq-group.com;
 h=content-type:mime-version:subject:from:to:message-id:date; s=hse1;
 t=1772120367; v=1;
 b=
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-33747-lists,linux-usb=lfdr.de];
...
---
Changes in v3:
* Remove superfluous xceiver-supply for flexcan nodes

 arch/arm64/boot/dts/freescale/Makefile        |   1 +
 .../dts/freescale/imx8qm-tqma8qm-mba8x.dts    | 906 ++++++++++++++++++
...
index de7e2f5d30f4f..0ce9706869bd8 100644
...
index 0000000000000..68e33282b7943
--- /dev/null
