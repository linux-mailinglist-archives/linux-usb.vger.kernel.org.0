
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
  by fmvoesa109.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Apr 2026 18:48:35 -0700
X-CSE-ConnectionGUID: CAiLfZeuRoORv062A26vfA==
X-CSE-MsgGUID: w20SH6Z9Qr+g8J3yTF1kDw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,189,1770624000"; 
   d="scan'208";a="236569061"
Received: from lkp-server01.sh.intel.com (HELO 7e48d0ff8e22) ([10.239.97.150])
  by fmviesa005.fm.intel.com with ESMTP; 19 Apr 2026 18:47:19 -0700
Received: from kbuild by 7e48d0ff8e22 with local (Exim 4.98.2)
	(envelope-from <lkp@intel.com>)
	id 1wEdjI-000000001zW-0Zyr;
	Mon, 20 Apr 2026 01:47:16 +0000
Date: Mon, 20 Apr 2026 09:46:24 +0800
From: kernel test robot <lkp@intel.com>
To: Pavitra Jha <jhapavitra98@gmail.com>, linux-usb@vger.kernel.org
Cc: llvm@lists.linux.dev, oe-kbuild-all@lists.linux.dev,
	gregkh@linuxfoundation.org, stable@vger.kernel.org,
	linux-kernel@vger.kernel.org, Pavitra Jha <jhapavitra98@gmail.com>
Subject: Re: [PATCH] usb: gadget: udc: max3420: validate endpoint index
 before array access
Message-ID: <202604191819.2IEGJjoB-lkp@intel.com>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="mmnMzuY96/xpvrgb"
...
X-Spamd-Result: default: False [-1.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-36322-lists,linux-usb=lfdr.de];
	FROM_HAS_DN(0.00)[];
...
| Closes: https://lore.kernel.org/oe-kbuild-all/202604191819.2IEGJjoB-lkp@intel.com/

All errors (new ones prefixed by >>):

>> drivers/usb/gadget/udc/max3420_udc.c:551:3: error: use of undeclared identifier 'id'
     551 |                 id = udc->setup.wIndex & USB_ENDPOINT_NUMBER_MASK;
         |                 ^
   drivers/usb/gadget/udc/max3420_udc.c:552:7: error: use of undeclared identifier 'id'
     552 |                 if (id >= MAX3420_MAX_EPS)
         |                     ^
   drivers/usb/gadget/udc/max3420_udc.c:554:17: error: use of undeclared identifier 'id'
     554 |                 ep = &udc->ep[id];
         |                               ^
>> drivers/usb/gadget/udc/max3420_udc.c:603:9: error: use of undeclared label 'stall'
     603 |                         goto stall;
         |                              ^
   4 errors generated.


vim +/id +551 drivers/usb/gadget/udc/max3420_udc.c
...
reproduce (this is a W=1 build):
        ...
        # install loongarch cross compiling tool for clang build
        # apt-get install binutils-loongarch-linux-gnu
        git clone https://github.com/intel/lkp-tests.git ~/lkp-tests

        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=clang-19 ~/lkp-tests/kbuild/make.cross W=1 O=build_dir ARCH=loongarch olddefconfig
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=clang-19 ~/lkp-tests/kbuild/make.cross W=1 O=build_dir ARCH=loongarch SHELL=/bin/bash drivers/usb/gadget/udc/ 
...
# Linux/loongarch 7.0.0-rc7 Kernel Configuration
#
...
CONFIG_KASAN_SHADOW_OFFSET=0x0
...
CONFIG_IOMMU_PT_VTDSS=m
CONFIG_IOMMU_PT_X86_64=m
