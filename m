...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 383846BA41D
	for <lists+linux-usb@lfdr.de>; Wed, 15 Mar 2023 01:40:01 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230091AbjCOAj5 (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Tue, 14 Mar 2023 20:39:57 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39480 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229960AbjCOAjx (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Tue, 14 Mar 2023 20:39:53 -0400
Received: from mx0a-0031df01.pphosted.com (mx0a-0031df01.pphosted.com [205.220.168.131])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D782F5614B;
        Tue, 14 Mar 2023 17:39:51 -0700 (PDT)
Received: from pps.filterd (m0279865.ppops.net [127.0.0.1])
        by mx0a-0031df01.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 32ENBGEC011415;
        Wed, 15 Mar 2023 00:39:46 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=quicinc.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references; s=qcppdkim1;
 bh=vDIhzWQMVkyA590Rl1r1cfKpsaotTtpC4RGdPZlhtx0=;
 b= iA== 
Received: from nalasppmta03.qualcomm.com (Global_NAT1.qualcomm.com [129.46.96.20])
        by mx0a-0031df01.pphosted.com (PPS) with ESMTPS id 3pb2c98497-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Wed, 15 Mar 2023 00:39:46 +0000
Received: from pps.filterd (NALASPPMTA03.qualcomm.com [127.0.0.1])
        by NALASPPMTA03.qualcomm.com (8.17.1.5/8.17.1.5) with ESMTP id 32F0djcO014801;
        Wed, 15 Mar 2023 00:39:45 GMT
Received: from pps.reinject (localhost [127.0.0.1])
        by NALASPPMTA03.qualcomm.com (PPS) with ESMTP id 3p8jqkvs7a-1;
        Wed, 15 Mar 2023 00:39:45 +0000
Received: from NALASPPMTA03.qualcomm.com (NALASPPMTA03.qualcomm.com [127.0.0.1])
        by pps.reinject (8.17.1.5/8.17.1.5) with ESMTP id 32F0djDK014795;
        Wed, 15 Mar 2023 00:39:45 GMT
Received: from hu-devc-lv-c.qualcomm.com (hu-eserrao-lv.qualcomm.com [10.47.235.164])
        by NALASPPMTA03.qualcomm.com (PPS) with ESMTP id 32F0djan014794;
        Wed, 15 Mar 2023 00:39:45 +0000
Received: by hu-devc-lv-c.qualcomm.com (Postfix, from userid 464172)
        id E51F620E62; Tue, 14 Mar 2023 17:39:44 -0700 (PDT)
...
Subject: [PATCH v9 5/5] usb: gadget: f_ecm: Add suspend/resume and remote wakeup support
Date:   Tue, 14 Mar 2023 17:39:43 -0700
Message-Id: <1678840783-15472-6-git-send-email-quic_eserrao@quicinc.com>
...
X-Proofpoint-Virus-Version: vendor=nai engine=6200 definitions=5800 signatures=585085
X-Proofpoint-ORIG-GUID: wEpx-6hqNyp6p1ANG7BLAU_jJmQz-veE
X-Proofpoint-GUID: wEpx-6hqNyp6p1ANG7BLAU_jJmQz-veE
X-Proofpoint-Virus-Version: vendor=baseguard
 engine=ICAP:2.0.254,Aquarius:18.0.942,Hydra:6.0.573,FMLib:17.11.170.22
 definitions=2023-03-14_16,2023-03-14_02,2023-02-09_01
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0 priorityscore=1501
 phishscore=0 mlxlogscore=957 clxscore=1015 spamscore=0 mlxscore=0
...
+	f->func_wakeup_armed = false;
 ...
 /*-------------------------------------------------------------------------*/
@@ -885,6 +887,76 @@ static struct usb_function_instance *ecm_alloc_inst(void)
...
+	}
+
+	return USB_INTRF_STAT_FUNC_RW_CAP;
+}
+
...
+
+	if (USB_CONFIG_ATT_WAKEUP & c->bmAttributes) {
+		f->func_wakeup_armed = !!(options &
+					 (USB_INTRF_FUNC_SUSPEND_RW >> 8));
+	}
+
...
+
 ...
 {
 	struct f_ecm *ecm;
@@ -952,6 +1024,10 @@ static struct usb_function *ecm_alloc(struct usb_function_instance *fi)
