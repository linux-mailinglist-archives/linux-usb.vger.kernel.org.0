...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 46D5150AA8F
	for <lists+linux-usb@lfdr.de>; Thu, 21 Apr 2022 23:16:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1441892AbiDUVRp (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Thu, 21 Apr 2022 17:17:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46746 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1441845AbiDUVRf (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Thu, 21 Apr 2022 17:17:35 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5175A4B1E6
        for <linux-usb@vger.kernel.org>; Thu, 21 Apr 2022 14:14:42 -0700 (PDT)
Received: from drehscheibe.grey.stw.pengutronix.de ([2a0a:edc0:0:c01:1d::a2])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mgr@pengutronix.de>)
        id 1nhe8O-0006XL-En; Thu, 21 Apr 2022 23:14:40 +0200
Received: from [2a0a:edc0:0:1101:1d::ac] (helo=dude04.red.stw.pengutronix.de)
        by drehscheibe.grey.stw.pengutronix.de with esmtp (Exim 4.94.2)
        (envelope-from <mgr@pengutronix.de>)
        id 1nhe8P-004R0u-3g; Thu, 21 Apr 2022 23:14:39 +0200
Received: from mgr by dude04.red.stw.pengutronix.de with local (Exim 4.94.2)
        (envelope-from <mgr@pengutronix.de>)
        id 1nhe8M-00EGp6-6a; Thu, 21 Apr 2022 23:14:38 +0200
...
Subject: [RESEND v7 7/7] usb: gadget: uvc: add format/frame handling code
Date:   Thu, 21 Apr 2022 23:14:27 +0200
Message-Id: <20220421211427.3400834-8-m.grzeschik@pengutronix.de>
...
index 626612c3c6ea3e..51807bf7d4b8e6 100644
...
index f7d9a4d1f1b655..03d042b386398f 100644
...
@@ -185,5 +195,14 @@ extern struct uvcg_format *find_format_by_index(struct uvc_device *uvc,
...
index 7ec63e929496fd..8ca21a0717d6b7 100644
...
@@ -533,7 +586,10 @@ uvc_v4l2_unsubscribe_event(struct v4l2_fh *fh,
 	if (ret < 0)
 		return ret;
