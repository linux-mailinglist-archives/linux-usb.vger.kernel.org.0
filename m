Return-Path: <linux-usb+bounces-37210-lists+linux-usb=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-usb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CODDIcfPAGr3MwEAu9opvQ
	(envelope-from <linux-usb+bounces-37210-lists+linux-usb=lfdr.de@vger.kernel.org>)
	for <lists+linux-usb@lfdr.de>; Sun, 10 May 2026 20:34:47 +0200
X-Original-To: lists+linux-usb@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id C790C505AFE
	for <lists+linux-usb@lfdr.de>; Sun, 10 May 2026 20:34:46 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 78DD8303BB1E
	for <lists+linux-usb@lfdr.de>; Sun, 10 May 2026 18:32:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4D2263128D4;
	Sun, 10 May 2026 18:32:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="jbBH3beI"
X-Original-To: linux-usb@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9A15B3128DF;
	Sun, 10 May 2026 18:32:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1778437937; cv=none; b=MVGKBi4o7lG2xTTg3SqfKYJ/RADtZcBn42mqJk9MLtgnwS2b7GjD9SS/Bu2rK83KNjeCOfV4wIySscA2S7a3ksgJNzpDwR3lRbvZfyQq9HCJ8A2cXXR41av9x8PvIC02lgkdmUlZOiZ3f5axBkUPde/fN41s71SzqDN4pS9lJf4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1778437937; c=relaxed/simple;
	bh=2VtJ1xyt3axUKgUtMTLelYsgalzGVTdS4w1Ld9666f4=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=S9BJgshhFlYsIeTTGG4z3uFQnnsLt6ZRexQ+L3SmeqGJQnlI8mMU4XB+jAc14nhn1FsByFMlPN+4lkbn5SW/FcaKvbu4dWqG8nrQf7kmL3rEDzND00gj87U47A9rb0uvaMb6PwcCEJ3990epMhiUNWqDqxrZRJAd7aSH9Wz0E2A=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=jbBH3beI; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPS id 4C2E8C2BCFD;
	Sun, 10 May 2026 18:32:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1778437937;
	bh=2VtJ1xyt3axUKgUtMTLelYsgalzGVTdS4w1Ld9666f4=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:Reply-To:From;
	b=
Received: from aws-us-west-2-korg-lkml-1.web.codeaurora.org (localhost.localdomain [127.0.0.1])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 39481CD37B2;
	Sun, 10 May 2026 18:32:17 +0000 (UTC)
From: Alexandre Hamamdjian via B4 Relay <devnull+azkali.limited.gmail.com@kernel.org>
Date: Mon, 11 May 2026 01:32:09 +0700
Subject: [PATCH v2 1/3] usb: typec: bm92txx: add Rohm BM92TXX support
Precedence: bulk
...
Message-Id: <20260511-bm92t-v2-1-2145e4f4386b@gmail.com>
...
X-Mailer: b4 0.15.2
X-Developer-Signature: v=1; a=ed25519-sha256; t=1778437929; l=82476;
 i=azkali.limited@gmail.com; s=20260510; h=from:subject:message-id;
 bh=aSjT95CxeNA0LXcD5/We1ja9DXkE3GQ+KKLY9142jE8=;
 b=ED7H9O2Yv/nVNdnkWdqsG4TFo6KUlTcypZkQgwTrrB1r2Unc2xgjUpiWj1Sdtk0QELe0DkZVu
 Pe6vYsiJBd3BGVG4UCXrxRpLe66bO7L1TYF2Ud3o/d9mmuIlLg+zr+e
...
X-Spamd-Result: default: False [1.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-37210-lists,linux-usb=lfdr.de,azkali.limited.gmail.com];
	RCVD_TLS_LAST(0.00)[];
...
---
 ...
 4 files changed, 2653 insertions(+)

diff --git a/MAINTAINERS b/MAINTAINERS
index f877e5aaf2c7..01e06d87b926 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -23306,6 +23306,13 @@ L:	linux-iio@vger.kernel.org
 S:	Supported
 F:	drivers/iio/pressure/rohm-bm1390.c
 
+ROHM BM92TXX USB TYPE-C CONTROLLER DRIVER
+M:	CTCaer <ctcaer@gmail.com>
...
index 2f80c2792dbd..a9160d6e36bc 100644
...
+	help
+	  Say Y or M here if your system has Rohm BM92TXX USB Type-C and
+	  Power Delivery controller.
+
+	  If you choose to build this driver as a dynamically linked module, the
+	  module will be called bm92txx.ko
+
 config TYPEC_RT1719
 	tristate "Richtek RT1719 Sink Only Type-C controller driver"
 	depends on USB_ROLE_SWITCH || !USB_ROLE_SWITCH
diff --git a/drivers/usb/typec/Makefile b/drivers/usb/typec/Makefile
index 8a6a1c663eb6..349996e5355c 100644
...
+/* TV/Monitor connected. link channel enabled or hpd channel or something */
...
+/* Configure and enter selected DP Alt mode and start handling HPD */
...
+		if (err) {
+			dev_err(&info->i2c_client->dev,
+				"Writing DP cfg failed!\n");
+			return -ENODEV;
+		}
+		/* Configure DP Alt mode and start handling HPD */
+		bm92t_send_cmd(info, &cmd);
+
+		prop.intval = valid_lanes > info->pdata->dp_lanes ?
+			      info->pdata->dp_lanes : valid_lanes;
+
+	} else {
...
+
+	err = bm92t_read_reg(info, CONFIG1_REG, (unsigned char *) &value,
+			     sizeof(value));
+	if (err < 0)
+		return err;
+
...
+
+#ifdef CONFIG_SWITCH
+	switch_set_state(&info->pd_switch, 1);
+#endif
+}
+
...
+			info->cable.pdo_no = 2;
+			memcpy(&info->cable.pdo, &pdo[1],
+			       sizeof(struct pd_object));
+			return 1;
+		}
+
...
+
+	if (bm92t_write_reg(info, msg, sizeof(msg))) {
...
+
+	if (bm92t_write_reg(info, msg, len)) {
...
+#ifdef CONFIG_SWITCH
+				switch_set_state(&info->pd_switch, 0);
+#endif
+			}
+
...
+				vdm, sizeof(vdm));
+
+			memcpy(&info->cable.vdo, &vdm[5],
+			       sizeof(struct vd_object));
+
...
+		goto failed;
+
+	if (!debugfs_create_file("regs", 0444,
+				 info->debugfs_root,
+				 info,
+				 &bm92t_regs_fops))
+		goto failed;
+
+	if (!debugfs_create_file("state", 0444,
+				 info->debugfs_root,
+				 info,
+				 &bm92t_state_fops))
+		goto failed;
+
+	if (!debugfs_create_file("fw_info", 0444,
+				 info->debugfs_root,
+				 info,
+				 &bm92t_fwinfo_fops))
+		goto failed;
...
+
+failed:
+	dev_err(&info->i2c_client->dev, "failed\n");
+	debugfs_remove_recursive(info->debugfs_root);
+	return -ENOMEM;
+}
+#endif
...
+	if (client->irq > 0) {
+		/*
+		 * Level-triggered (active-low) IRQ wired to BM92T36 ALERT.
+		 * Use a threaded handler with IRQF_ONESHOT so the line is
+		 * masked while bm92t_interrupt_handler runs i2c reads, then
+		 * re-enabled after the work clears the controller's status.
+		 * Without IRQF_ONESHOT this would re-enter immediately on
+		 * the still-asserted line and "irq nobody cared" disable it.
+		 */
+		if (request_threaded_irq(client->irq, NULL,
+				bm92t_interrupt_handler,
+				IRQF_TRIGGER_LOW | IRQF_ONESHOT, "bm92t",
+				info)) {
