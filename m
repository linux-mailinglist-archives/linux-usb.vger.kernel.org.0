...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E134072BB57
	for <lists+linux-usb@lfdr.de>; Mon, 12 Jun 2023 10:53:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233865AbjFLIxx (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Mon, 12 Jun 2023 04:53:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51936 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232614AbjFLIxR (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Mon, 12 Jun 2023 04:53:17 -0400
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DB12E30D6
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=fTvkG05pbHDcjA3DKT3YNQm7HkDjZOaNIDL8WyEfjpY=;
  b=Hl4BW9TqpgPN7OREbRVTIBFkXxfNm9KFM59HwuOztrNqTbEU2hhaTJmS
   W44+4irjxL8eNUkGqVEdkPEt6z5pxmJKw4UPuBsDepWZh9QvwZ1V1jLgv
   lmb/HnAgCb21vYQbZ3qVRnh0xjLH8HOC1IzvoKRyn2esvjKltJohcw7tO
   kRKal2DN+HrhOuDoOhbi3IxlM1UkNqG21P8W1sM+ssAnki58Dz/5xFTkP
   8IeYAx/RBLWzDwo6KHbk3VdZ5EKJBf2FWQUaj26H1lebg57jozYXxQIJh
   agKD4o7mQVNTAFU7G1hSr5Ph1Z8p6ss4qzE5qYzWFOlxMevA/xb5KWPhC
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10738"; a="347627325"
X-IronPort-AV: E=Sophos;i="6.00,236,1681196400"; 
   d="scan'208";a="347627325"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Jun 2023 01:21:45 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10738"; a="744247787"
X-IronPort-AV: E=Sophos;i="6.00,236,1681196400"; 
   d="scan'208";a="744247787"
Received: from black.fi.intel.com ([10.237.72.28])
  by orsmga001.jf.intel.com with ESMTP; 12 Jun 2023 01:21:42 -0700
Received: by black.fi.intel.com (Postfix, from userid 1001)
        id 0993CA6B; Mon, 12 Jun 2023 11:21:45 +0300 (EEST)
...
Subject: [PATCH v2 16/20] thunderbolt: Add support for enhanced uni-directional TMU mode
Date:   Mon, 12 Jun 2023 11:21:41 +0300
Message-Id: <20230612082145.62218-17-mika.westerberg@linux.intel.com>
...
---
 ...
 6 files changed, 614 insertions(+), 173 deletions(-)
...
index 088033726648..68ab9b3c9580 100644
...
@@ -375,6 +533,23 @@ int tb_switch_tmu_post_time(struct tb_switch *sw)
 	return ret;
 }
...
@@ -384,11 +559,10 @@ int tb_switch_tmu_post_time(struct tb_switch *sw)
 int tb_switch_tmu_disable(struct tb_switch *sw)
 {
 	/* Already disabled? */
...
+	}
 	...
 	if (ret)
@@ -637,13 +939,14 @@ static int tb_switch_tmu_change_mode(struct tb_switch *sw)
  */
 int tb_switch_tmu_enable(struct tb_switch *sw)
 {
