Return-Path: <linux-usb+bounces-9040-lists+linux-usb=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-usb@lfdr.de
Delivered-To: lists+linux-usb@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A14DE89BD9A
	for <lists+linux-usb@lfdr.de>; Mon,  8 Apr 2024 12:54:39 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 5271C2831EE
	for <lists+linux-usb@lfdr.de>; Mon,  8 Apr 2024 10:54:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 52322604D3;
	Mon,  8 Apr 2024 10:54:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ucw.cz header.i=@ucw.cz header.b="jflQWxlG"
X-Original-To: linux-usb@vger.kernel.org
Received: from jabberwock.ucw.cz (jabberwock.ucw.cz [46.255.230.98])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1869B5F861;
	Mon,  8 Apr 2024 10:54:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=46.255.230.98
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712573672; cv=none; b=FVYuPDqX3thFd1EUroWHFTqoq7nWfBep4JjAyVBoYu+aqrfoxZ0hhYpwD1cX/1vsflwqnQzN+NKZ4KJKnfHxmtG1jtymtufxLKrCF0ByxRJq+SO6oRKB5gKdLCWQVRc/RE57pcK0G5Ntlnm+aYhZh8TDZnz6pfYeO4n1z7MzQPU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712573672; c=relaxed/simple;
	bh=N1kxlKJSRGydGxTmSF8DTfy8S1u602z9TOQDn96FMpk=;
	h=Date:From:To:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=vDf/L8DomWrevl0F3eKdf0EiKk0Z96+4f63f0Rtk8KQV+mbgL3c5Bdl58k9R85pVfIESmoNh+tHnQwa3wncQPTudE5Sgci+nroAfGpCaf4g569S+2gBCbDtuMZsNJBfPclYpeTpveAlQNJ1vxWRT2wqIZ3hjy+uKhRUojPqCMz8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=ucw.cz; spf=pass smtp.mailfrom=ucw.cz; dkim=pass (1024-bit key) header.d=ucw.cz header.i=@ucw.cz header.b=jflQWxlG; arc=none smtp.client-ip=46.255.230.98
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=ucw.cz
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ucw.cz
Received: by jabberwock.ucw.cz (Postfix, from userid 1017)
	id 185CB1C006B; Mon,  8 Apr 2024 12:54:26 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ucw.cz; s=gen1;
	t=1712573666;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=W7Ca2LE1y6MqDC+CijiT3s/7an/I3TlowxpcJ8b62Dg=;
	b=jflQWxlGE1kkwFfcfWvIvYARUY7IjCwFWgoW9hMLOc6Ek+YRaJGiENKHdiff6gC9+1eXGQ
	a8Ac976+zg3BtIPOIJbOLCFLyomaI8SYm+tgl/ouYNTeX3uFCR6e40yccYzzSD7B4CuSvI
	WE5Kx0p7b/y+ErF26xX8eZjt8jGf25I=
Date: Mon, 8 Apr 2024 12:54:25 +0200
...
Subject: [PATCHv3 2/2] usb: typec: anx7688: Add driver for ANX7688 USB-C HDMI
 bridge
Message-ID: <ZhPM4XU8ttsFftBd@duo.ucw.cz>
...
Content-Type: multipart/signed; micalg=pgp-sha1;
	protocol="application/pgp-signature"; boundary="l6WV2dKWBunzVLCJ"
...
+					     data_len + 3, pkt);
+	if (ret < 0)
+		dev_err(anx7688->dev, "failed to send pd packet (err=3D%d)\n", ret);
+
...
+
+			dev_dbg(anx7688->dev, "RDO (idx=3D%d op=3D%umA max=3D%umA)\n",
...
+		} else {
+			dev_dbg(anx7688->dev,
+				"PWR_OBJ RDO index out of range (RDO =3D 0x%08X)\n", rdo);
+		}
+
+		break;
+
...
+
+	dev_dbg(anx7688->dev, "updating power mode to %s, current limit %dmA (0 =
=3D> BC1.2)\n",
...
iF0EABECAB0WIQRPfPO7r0eAhk010v0w5/Bqldv68gUCZhPM4QAKCRAw5/Bqldv6
8plsAKCsN0opKjwK+/9RjSpCy/8xo3VjUACfQct+wno/jiSAUvTwa1V7vaz0L1k=
=k+2m
-----END PGP SIGNATURE-----
