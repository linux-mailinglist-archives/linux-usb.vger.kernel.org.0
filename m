Return-Path: <linux-usb+bounces-35047-lists+linux-usb=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-usb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id sAnrIyucummHZgIAu9opvQ
	(envelope-from <linux-usb+bounces-35047-lists+linux-usb=lfdr.de@vger.kernel.org>)
	for <lists+linux-usb@lfdr.de>; Wed, 18 Mar 2026 13:35:55 +0100
X-Original-To: lists+linux-usb@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 0AA852BB8E3
	for <lists+linux-usb@lfdr.de>; Wed, 18 Mar 2026 13:35:55 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 704213054647
	for <lists+linux-usb@lfdr.de>; Wed, 18 Mar 2026 12:34:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D38933D6CDB;
	Wed, 18 Mar 2026 12:34:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=realtek.com header.i=@realtek.com header.b="KNceIYWy"
X-Original-To: linux-usb@vger.kernel.org
Received: from rtits2.realtek.com.tw (rtits2.realtek.com [211.75.126.72])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B59FC3B7B76;
	Wed, 18 Mar 2026 12:34:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=211.75.126.72
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1773837276; cv=none; b=naTKanKg09FcvNLpTO6OKc6uPbehe3HnFKPrBYI4NJwnTDIoU0CUzRJjKsTUxy3HsZewLcJ5E4xt/L89jHAP/G80Dbg+ECBkyKnXEcKNZBh4hBJqBva2WqXrbbJyGq2tUK+oRUU+1TJxr9qckEziOvfxPPgzA5zGkotTz8Cz6ro=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1773837276; c=relaxed/simple;
	bh=32O/AIo0249cw+xd65hyyTA7//EzBPvRSGTmuJ1htRo=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=XA6cOKKKHLPylJs1NzJFr93QV9m08xFtW+w3FJPEHR5ea44u4YSR11Hk/XGDSPQQ7mrWtygfinTO9tQWHH6dd/z9V84CJloajeOcCNi+GQuRYg+dK3EeKWflOGbBEjohSI4KwJFyENKLPi/TaZ2KuoOoFITe+aVqK3sIhBPfMYw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=realtek.com; spf=pass smtp.mailfrom=realtek.com; dkim=pass (2048-bit key) header.d=realtek.com header.i=@realtek.com header.b=KNceIYWy; arc=none smtp.client-ip=211.75.126.72
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=realtek.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=realtek.com
X-SpamFilter-By: ArmorX SpamTrap 5.80 with qID 62ICXpRqA1675527, This message is accepted by code: ctloc85258
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=realtek.com; s=dkim;
	t=1773837231; bh=qwmhfi9Of0Qe0OzbBvypBARutauwlWyoUneEI8LCsE0=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Transfer-Encoding:Content-Type;
	b=
Received: from mail.realtek.com (rtkexhmbs02.realtek.com.tw[172.21.6.41])
	by rtits2.realtek.com.tw (8.15.2/3.21/5.94) with ESMTPS id 62ICXpRqA1675527
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
	Wed, 18 Mar 2026 20:33:51 +0800
...
Subject: [PATCH net-next 1/2] r8152: add helper functions for PLA/USB OCP registers
Date: Wed, 18 Mar 2026 20:33:12 +0800
Message-ID: <20260318123313.2313-445-nic_swsd@realtek.com>
X-Mailer: git-send-email 2.53.0
In-Reply-To: <20260318123313.2313-444-nic_swsd@realtek.com>
References: <20260318123313.2313-444-nic_swsd@realtek.com>
Precedence: bulk
...
X-Spamd-Result: default: False [-1.66 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-35047-lists,linux-usb=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	FROM_HAS_DN(0.00)[];
...
X-Rspamd-Queue-Id: 0AA852BB8E3
X-Rspamd-Action: no action
X-Rspamd-Server: lfdr

Add the following bitwise operaion functions for PLA/USB OCP registers
...
Signed-off-by: hsuck <hsu.chih.kai@realtek.com>
---
 drivers/net/usb/r8152.c | 1114 +++++++++++++++------------------------
 1 file changed, 414 insertions(+), 700 deletions(-)

diff --git a/drivers/net/usb/r8152.c b/drivers/net/usb/r8152.c
index 3b6d4252d34c..da9a93d5a733 100644
...
@@ -7053,14 +6844,12 @@ static void r8152b_init(struct r8152 *tp)
 	rtl_tally_reset(tp);
...
@@ -7096,67 +6885,55 @@ static void r8153_init(struct r8152 *tp)
 	r8153_u2p3en(tp, false);
...
+		ocp_byte_set_bits(tp, MCU_TYPE_USB, USB_LPM_CTRL,
...
@@ -7166,21 +6943,17 @@ static void r8153_init(struct r8152 *tp)
...
@@ -7200,7 +6973,6 @@ static void r8153_init(struct r8152 *tp)
...
@@ -7239,13 +7011,12 @@ static void r8153b_init(struct r8152 *tp)
 	r8153_queue_wake(tp, false);
...
+			      POLL_LINK_CHG);
 	...
 	if (tp->udev->speed >= USB_SPEED_SUPER)
 		r8153b_u1u2en(tp, true);
@@ -7255,25 +7026,20 @@ static void r8153b_init(struct r8152 *tp)
 	/* MAC clock speed down */
...
@@ -7282,7 +7048,6 @@ static void r8153b_init(struct r8152 *tp)
...
@@ -7293,12 +7058,10 @@ static void r8153c_init(struct r8152 *tp)
...
@@ -7330,14 +7093,12 @@ static void r8153c_init(struct r8152 *tp)
 	r8153_queue_wake(tp, false);
 	rtl_runtime_suspend_enable(tp, false);
...
@@ -7346,16 +7107,13 @@ static void r8153c_init(struct r8152 *tp)
 	/* MAC clock speed down */
 	r8153_mac_clk_speed_down(tp, true);
...
@@ -7364,14 +7122,9 @@ static void r8153c_init(struct r8152 *tp)
...
+	ocp_word_test_and_clr_bits(tp, MCU_TYPE_USB, USB_MISC_0, PCUT_STATUS);
 	...
 	switch (data) {
@@ -7398,9 +7151,7 @@ static void r8156_hw_phy_cfg(struct r8152 *tp)
...
+	ocp_word_set_bits(tp, MCU_TYPE_PLA, PLA_PHY_PWR, PFM_PWM_SWITCH);
 	...
 	switch (tp->version) {
 	case RTL_VER_10:
@@ -7561,9 +7312,8 @@ static void r8156_hw_phy_cfg(struct r8152 *tp)
 		/* EEE parameter */
...
@@ -7572,9 +7322,8 @@ static void r8156_hw_phy_cfg(struct r8152 *tp)
 			return;
...
@@ -7714,7 +7463,6 @@ static void r8156_hw_phy_cfg(struct r8152 *tp)
...
-	u32 ocp_data;
 	...
 	switch (tp->version) {
@@ -7744,11 +7492,7 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
 		break;
 	}
...
+	ocp_word_test_and_clr_bits(tp, MCU_TYPE_USB, USB_MISC_0, PCUT_STATUS);
 	...
 	data = r8153_phy_status(tp, 0);
 	switch (data) {
@@ -7785,9 +7529,7 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
 	data = r8153_phy_status(tp, PHY_STAT_LAN_ON);
 	WARN_ON_ONCE(data != PHY_STAT_LAN_ON);
...
+	ocp_word_set_bits(tp, MCU_TYPE_PLA, PLA_PHY_PWR, PFM_PWM_SWITCH);
 	...
 	switch (tp->version) {
 	case RTL_VER_12:
@@ -7874,9 +7616,9 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
...
@@ -8090,9 +7832,7 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
 	if (rtl_phy_patch_request(tp, true, true))
 		return;
...
+	ocp_word_set_bits(tp, MCU_TYPE_PLA, PLA_MAC_PWR_CTRL4, EEE_SPDWN_EN);
 	...
 	data = ocp_reg_read(tp, OCP_DOWN_SPEED);
 	data &= ~(EN_EEE_100 | EN_EEE_1000);
@@ -8131,22 +7871,17 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
...
@@ -8196,28 +7931,23 @@ static void r8156_init(struct r8152 *tp)
...
+	ocp_byte_set_bits(tp, MCU_TYPE_USB, USB_BMU_CONFIG, ACT_ODMA);
 	...
 	rtl_tally_reset(tp);
@@ -8227,26 +7957,19 @@ static void r8156_init(struct r8152 *tp)
...
@@ -8306,48 +8029,39 @@ static void r8156b_init(struct r8152 *tp)
