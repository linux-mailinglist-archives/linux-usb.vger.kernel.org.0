...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3324C525D9D
	for <lists+linux-usb@lfdr.de>; Fri, 13 May 2022 10:39:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1358165AbiEMIZQ (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Fri, 13 May 2022 04:25:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39824 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1378192AbiEMIYt (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Fri, 13 May 2022 04:24:49 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C7D262A7C06
        for <linux-usb@vger.kernel.org>; Fri, 13 May 2022 01:24:46 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 6463062042
        for <linux-usb@vger.kernel.org>; Fri, 13 May 2022 08:24:46 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPS id CDAA7C34100
        for <linux-usb@vger.kernel.org>; Fri, 13 May 2022 08:24:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1652430285;
        bh=ob6ZGH8D3aSR2xpBvILblE1FFVFBzGRf/CiU75/CKPQ=;
        h=From:To:Subject:Date:In-Reply-To:References:From;
        b=
Received: by aws-us-west-2-korg-bugzilla-1.web.codeaurora.org (Postfix, from userid 48)
        id A168FCAC6E2; Fri, 13 May 2022 08:24:45 +0000 (UTC)
...
Date:   Fri, 13 May 2022 08:24:45 +0000
...
Message-ID: <bug-215890-208809-edueqhK2RM@https.bugzilla.kernel.org/>
...
>>         Regression: No
>>
>> The Apple BCM5974 trackpad & keyboard show up in sudo libinput list-devi=
ces
...
>> [    7.144648] WARNING: CPU: 6 PID: 969 at include/linux/dma-mapping.h:3=
26
...
>> snd_hda_intel btintel snd_seq_midi_event btmtk kvm bluetooth
>> snd_intel_dspcfg
...
>> snd_seq_device
>> snd_timer snd sbs(+) soundcore acpi_als industrialio_triggered_buffer sb=
shc
>> kfifo_buf apple_gmux industrialio mac_hid apple_bl facetimehd(OE)
>> videobuf2_dma_sg videobuf2_memops videobuf2_v4l2 videobuf2_common videod=
ev
>> mc
>> coretemp ipmi_devintf ipmi_msghandler msr parport_pc ppdev lp parport
>> ip_tables
>> x_tables autofs4 zfs(POE) zunicode(POE) zzstd(OE) zlua(OE) zavl(POE)
>> icp(POE)
>> zcommon(POE) znvpair(POE) spl(OE) z3fold lz4 lz4_compress hid_logitech_h=
idpp
>> hid_apple hid_logitech_dj hid_generic
>> [    7.144716]  usbhid hid i915 nouveau mxm_wmi wmi drm_buddy i2c_algo_b=
it
>> drm_ttm_helper ttm drm_dp_helper cec rc_core drm_kms_helper uas syscopya=
rea
...
>> [    7.144742] CPU: 6 PID: 969 Comm: systemd-udevd Tainted: P           =
OE=20=20=20
>> 5.18.0-rc4 #1
>> [    7.144745] Hardware name: Apple Inc.
>> MacBookPro11,3/Mac-2BD1B31983FE1663,
>> BIOS 432.60.3.0.0 10/27/2021
>> [    7.144746] RIP: 0010:usb_hcd_map_urb_for_dma+0x4c0/0x4f0
>> [    7.144752] Code: 50 c6 05 dd fd 8a 01 01 4d 85 f6 75 03 4d 8b 32 4c =
89
>> d7
...
>> [    7.144864] Code: 25 00 00 41 00 3d 00 00 41 00 74 4b 64 8b 04 25 18 =
00
>> 00
