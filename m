...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 45B716C352A
	for <lists+linux-usb@lfdr.de>; Tue, 21 Mar 2023 16:10:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230293AbjCUPKA (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Tue, 21 Mar 2023 11:10:00 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52934 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231624AbjCUPJ6 (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Tue, 21 Mar 2023 11:09:58 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 17CF6E181
        for <linux-usb@vger.kernel.org>; Tue, 21 Mar 2023 08:09:26 -0700 (PDT)
Received: from drehscheibe.grey.stw.pengutronix.de ([2a0a:edc0:0:c01:1d::a2])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <ukl@pengutronix.de>)
        id 1pedc3-0006MZ-BD; Tue, 21 Mar 2023 16:09:23 +0100
Received: from [2a0a:edc0:0:900:1d::77] (helo=ptz.office.stw.pengutronix.de)
        by drehscheibe.grey.stw.pengutronix.de with esmtp (Exim 4.94.2)
        (envelope-from <ukl@pengutronix.de>)
        id 1pedc2-005iK1-KR; Tue, 21 Mar 2023 16:09:22 +0100
Received: from ukl by ptz.office.stw.pengutronix.de with local (Exim 4.94.2)
        (envelope-from <ukl@pengutronix.de>)
        id 1pedc1-006n4G-R9; Tue, 21 Mar 2023 16:09:21 +0100
From:   =?UTF-8?q?Uwe=20Kleine-K=C3=B6nig?= 
        <u.kleine-koenig@pengutronix.de>
To:     Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        Ard Biesheuvel <ardb@kernel.org>
Cc:     linux-usb@vger.kernel.org, kernel@pengutronix.de
Subject: [PATCH v2] usb: ftdi-elan: Delete driver
Date:   Tue, 21 Mar 2023 16:09:19 +0100
Message-Id: <20230321150919.351947-1-u.kleine-koenig@pengutronix.de>
X-Mailer: git-send-email 2.39.2
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
X-Developer-Signature: v=1; a=openpgp-sha256; l=89045; i=u.kleine-koenig@pengutronix.de; h=from:subject; bh=+rB0D3+cec7L/grXJ3ykCV17jiZbBj5EwiE4Z0AN29k=; b=owEBbQGS/pANAwAKAY+A+1h9Ev5OAcsmYgBkGcicGqycJudKWcx77NXd57Gg8zeADjfgXmRqD Pzy9OAPAPGJATMEAAEKAB0WIQQ/gaxpOnoeWYmt/tOPgPtYfRL+TgUCZBnInAAKCRCPgPtYfRL+ TqbPB/9kLSaGTTAqxsyXSRH7AJ8XI/qZbxbk+2Vf8ePwYxDq5+ll+v+YFld2tWtib4b8jlZ3V0V /LE7IbiiCKfkBVpn285/BuBWjdaVi7qAD1TvPgmi9AhVL83udizqjsCF4xS2D4Dvcxt/KyeJ3nn EDkQT9TO/0+s8GOEwXiQN6oVTSCXQmookp8Ivzj0gnDSJgHvemkYhz25w5kfT2KWqhdMNWIFg+M jxFOQeP17Vf01H6fsuMT74XO0S29QgHYsPBOjZUwWdB6V+zBiVpTdOYJheAZyaoexldWhxSV8RG XKRm6awHBL4t88IxPP9fZTGPps72xccXHUV5fw/uMcKfeF1j
...
I failed to add most files ... some things cannot be catched by compile
testing.
...
Uwe
 ...
 5 files changed, 2803 deletions(-)
 delete mode 100644 drivers/usb/misc/ftdi-elan.c

diff --git a/arch/mips/configs/mtx1_defconfig b/arch/mips/configs/mtx1_defconfig
index 7b6a2a9daa10..c0c61c37d0b1 100644
--- a/arch/mips/configs/mtx1_defconfig
+++ b/arch/mips/configs/mtx1_defconfig
@@ -553,7 +553,6 @@ CONFIG_USB_LCD=m
...
index fd5cc93c4a99..b6366e501f9a 100644
--- a/arch/powerpc/configs/ppc6xx_defconfig
+++ b/arch/powerpc/configs/ppc6xx_defconfig
@@ -907,7 +907,6 @@ CONFIG_USB_SEVSEG=m
...
index c873cfd4ee86..08e3cf9efb38 100644
--- a/drivers/usb/misc/Kconfig
+++ b/drivers/usb/misc/Kconfig
@@ -108,26 +108,6 @@ config USB_IDMOUSE
