...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D9B2B5B271A
	for <lists+linux-usb@lfdr.de>; Thu,  8 Sep 2022 21:48:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229917AbiIHTsH (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Thu, 8 Sep 2022 15:48:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55228 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229850AbiIHTsC (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Thu, 8 Sep 2022 15:48:02 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3A929F2D7D
        for <linux-usb@vger.kernel.org>; Thu,  8 Sep 2022 12:47:57 -0700 (PDT)
Received: from drehscheibe.grey.stw.pengutronix.de ([2a0a:edc0:0:c01:1d::a2])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mgr@pengutronix.de>)
        id 1oWNVE-0001MK-9m; Thu, 08 Sep 2022 21:47:56 +0200
Received: from [2a0a:edc0:0:1101:1d::ac] (helo=dude04.red.stw.pengutronix.de)
        by drehscheibe.grey.stw.pengutronix.de with esmtp (Exim 4.94.2)
        (envelope-from <mgr@pengutronix.de>)
        id 1oWNVB-004gYB-Mh; Thu, 08 Sep 2022 21:47:55 +0200
Received: from mgr by dude04.red.stw.pengutronix.de with local (Exim 4.94.2)
        (envelope-from <mgr@pengutronix.de>)
        id 1oWNVC-00Fjp5-9M; Thu, 08 Sep 2022 21:47:54 +0200
...
Subject: [PATCH v13 4/6] usb: gadget: uvc: add v4l2 try_format api call
Date:   Thu,  8 Sep 2022 21:47:48 +0200
Message-Id: <20220908194750.3750310-5-m.grzeschik@pengutronix.de>
...
the setting of the format. It will fallback to the nearest
allowed framesize.
...
---
v1 -> v13
     - refactored the try_format callback to this separate new patch
     - changed uvc_get_framesize function to use variables uformat and uframe

 drivers/usb/gadget/function/uvc_v4l2.c | 110 +++++++++++++++++++++++++
 1 file changed, 110 insertions(+)

diff --git a/drivers/usb/gadget/function/uvc_v4l2.c b/drivers/usb/gadget/function/uvc_v4l2.c
index 63cb5a40306c75..761bc833d1e54f 100644
