...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D68E66C2F2E
	for <lists+linux-usb@lfdr.de>; Tue, 21 Mar 2023 11:37:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230281AbjCUKhm (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Tue, 21 Mar 2023 06:37:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34856 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230297AbjCUKhj (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Tue, 21 Mar 2023 06:37:39 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 63DF03A843
        for <linux-usb@vger.kernel.org>; Tue, 21 Mar 2023 03:37:03 -0700 (PDT)
Received: from drehscheibe.grey.stw.pengutronix.de ([2a0a:edc0:0:c01:1d::a2])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <ukl@pengutronix.de>)
        id 1peZMQ-0004e9-JZ; Tue, 21 Mar 2023 11:36:58 +0100
Received: from [2a0a:edc0:0:900:1d::77] (helo=ptz.office.stw.pengutronix.de)
        by drehscheibe.grey.stw.pengutronix.de with esmtp (Exim 4.94.2)
        (envelope-from <ukl@pengutronix.de>)
        id 1peZMP-005fNt-Hk; Tue, 21 Mar 2023 11:36:57 +0100
Received: from ukl by ptz.office.stw.pengutronix.de with local (Exim 4.94.2)
        (envelope-from <ukl@pengutronix.de>)
        id 1peZMO-006iwX-8H; Tue, 21 Mar 2023 11:36:56 +0100
From:   =?UTF-8?q?Uwe=20Kleine-K=C3=B6nig?= 
        <u.kleine-koenig@pengutronix.de>
To:     Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        Ard Biesheuvel <ardb@kernel.org>
Cc:     linux-usb@vger.kernel.org, kernel@pengutronix.de
Subject: [PATCH] usb: host: u132-hcd: Delete driver
Date:   Tue, 21 Mar 2023 11:36:38 +0100
Message-Id: <20230321103638.343886-1-u.kleine-koenig@pengutronix.de>
X-Mailer: git-send-email 2.39.2
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
X-Developer-Signature: v=1; a=openpgp-sha256; l=103587; i=u.kleine-koenig@pengutronix.de; h=from:subject; bh=P1hvGgeFtBQ3cVpN9wlncR3DT21GEZWNRUBU+AOPhZM=; b=owGbwMvMwMXY3/A7olbonx/jabUkhhTJji2yGVqrjcJaVQrLr0/9V6Gs5dRhlVwYkcBRf9Un5 Xb87ZJORmMWBkYuBlkxRRb7xjWZVlVykZ1r/12GGcTKBDKFgYtTACby4QH7/6AvC8VXfRHQnGf/ Ms70z9Tf0lo5b1d+dPer2Xpzok27l6fdA1e7loyvnnHRUeevHj/prvMuk3Vd+GWxqdeV5gkbezj +5Zls6+GYH+e2qvpg2P4Zlk9f1irMU71Zfzb3t6H486eaxZ2hq057BlzZ9l9QyDFSu/Nwaf4PhT eZl/iCK7UVBLyEuBvLPeqKLz3TnHGF27C/k9U3pLxhZXuVRKWf2N9Ud02VAsZM/vPXXs/0Olhzz DTU2CQ4NXzvc1v/jQdjF930LyqbMOv5AvcKD96g6e6FMm1P1D+zb8tgE23ntV0lxrTtR9D6uJTK eZO4Ja//c9kbJb5EIL+wksEnMeLZnfLAw+lenbvuxgMA
...
index 45244c791bcb..000000000000
...
index a5f7652db7da..c873cfd4ee86 100644
--- a/drivers/usb/misc/Kconfig
+++ b/drivers/usb/misc/Kconfig
@@ -126,8 +126,6 @@ config USB_FTDI_ELAN
 	  worked with a USB PEN Drive inserted into the first USB port of
 	  the PCCARD. A rather pointless thing to do, but useful for testing.
...
prerequisite-patch-id: ee571dc079450116a7f42e966ed597bae1584d89
prerequisite-patch-id: 6cc25872dd2fb2087b66719d218bde79dd71a12c
-- 
2.39.2
