...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CF9EC272A0C
	for <lists+linux-usb@lfdr.de>; Mon, 21 Sep 2020 17:27:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727861AbgIUP1z (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Mon, 21 Sep 2020 11:27:55 -0400
Received: from out28-4.mail.aliyun.com ([115.124.28.4]:59507 "EHLO
        out28-4.mail.aliyun.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727262AbgIUP1z (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Mon, 21 Sep 2020 11:27:55 -0400
X-Alimail-AntiSpam: AC=CONTINUE;BC=0.07436282|-1;CH=green;DM=|CONTINUE|false|;DS=CONTINUE|ham_system_inform|0.0448385-0.00253698-0.952625;FP=0|0|0|0|0|-1|-1|-1;HT=e02c03303;MF=zhouyanjie@wanyeetech.com;NM=1;PH=DS;RN=14;RT=14;SR=0;TI=SMTPD_---.IaIi.Kq_1600702064;
Received: from 192.168.10.195(mailfrom:zhouyanjie@wanyeetech.com fp:SMTPD_---.IaIi.Kq_1600702064)
          by smtp.aliyun-inc.com(10.147.41.178);
          Mon, 21 Sep 2020 23:27:45 +0800
...
References: <20200919084225.112072-1-zhouyanjie@wanyeetech.com>
 ...
 <EOC0HQ.DRQCDU2E1XFG3@crapouillou.net>
From:   Zhou Yanjie <zhouyanjie@wanyeetech.com>
Message-ID: <a440988f-ddb3-f77a-4809-e5976db38472@wanyeetech.com>
Date:   Mon, 21 Sep 2020 23:27:41 +0800
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.3.0
MIME-Version: 1.0
In-Reply-To: <EOC0HQ.DRQCDU2E1XFG3@crapouillou.net>
...
>> +#define USBPCR_COMPDISTUNE_MASK        GENMASK(19, 
...
>> +#define USBPCR_TXFSLSTUNE_MASK        GENMASK(10, 
>> USBPCR_TXFSLSTUNE_LSB)
...
>
> You can remove this, since you have the platform_set_drvdata(), and 
> priv->phy->dev == &pdev->dev. phy_get_drvdata() will still work.
>
