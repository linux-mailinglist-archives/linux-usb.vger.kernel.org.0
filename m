...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D2ADC46413F
	for <lists+linux-usb@lfdr.de>; Tue, 30 Nov 2021 23:25:01 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235887AbhK3W2U (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Tue, 30 Nov 2021 17:28:20 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53488 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235555AbhK3W2T (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Tue, 30 Nov 2021 17:28:19 -0500
Received: from mail-lj1-x236.google.com (mail-lj1-x236.google.com [IPv6:2a00:1450:4864:20::236])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 91BEAC061574
        for <linux-usb@vger.kernel.org>; Tue, 30 Nov 2021 14:24:59 -0800 (PST)
Received: by mail-lj1-x236.google.com with SMTP id v15so44144259ljc.0
        for <linux-usb@vger.kernel.org>; Tue, 30 Nov 2021 14:24:59 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=date:from:to:subject:message-id:mime-version:content-disposition;
        bh=rZW+krZrU+ABnW+aALny+P/fhfizmGqDBwUt1VeURkA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:date:from:to:subject:message-id:mime-version
         :content-disposition;
        bh=rZW+krZrU+ABnW+aALny+P/fhfizmGqDBwUt1VeURkA=;
        b=
X-Gm-Message-State: AOAM531/lf7IL9JLY7rUnoyYiyUU993MlB0rJvBNGVAYrGfUkd2DszuT
        mdC3EGvRVoALyXNrIPiPNrMn7FiOtYQ=
X-Google-Smtp-Source: ABdhPJzbUGEc3Q/Jb4mpj3uy3HhFZJL6AKZXBOMNQkOq+mNqFUdAhGXypXdYqLF0ixKsMvkf2Em4qA==
X-Received: by 2002:a05:651c:503:: with SMTP id o3mr1636842ljp.353.1638311097882;
        Tue, 30 Nov 2021 14:24:57 -0800 (PST)
Received: from dell-precision-T3610 (h-98-128-167-144.NA.cust.bahnhof.se. [98.128.167.144])
        by smtp.gmail.com with ESMTPSA id n4sm2087402lfu.70.2021.11.30.14.24.57
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 30 Nov 2021 14:24:57 -0800 (PST)
Date:   Tue, 30 Nov 2021 23:24:56 +0100
...
Subject: [PATCH v4 5/5] tools/usbip: import USB devices on a given bus
 persistently
Message-ID: <20211130222456.GA16614@dell-precision-T3610>
MIME-Version: 1.0
