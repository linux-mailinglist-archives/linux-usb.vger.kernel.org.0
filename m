...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BABD05F8A76
	for <lists+linux-usb@lfdr.de>; Sun,  9 Oct 2022 11:52:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229569AbiJIJw6 (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Sun, 9 Oct 2022 05:52:58 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36062 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229853AbiJIJwz (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Sun, 9 Oct 2022 05:52:55 -0400
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8762814D31
        for <linux-usb@vger.kernel.org>; Sun,  9 Oct 2022 02:52:52 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1665309172; x=1696845172;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=/swld+v2XV5DWl00OUrrAzAA3YaNf801OfztDhM9ogs=;
  b=I7ZzPqtf4VrjJwMTmEjq8QNRRAvNfVKdqTZFLIlAxsAmKPe5DckrEZGG
   hwwRj51utq06VgfcP5SkKMIDePWJKA+YJExFkMsBqLqx2yLQgkvO8a521
   T2S/ikpJAdFAdWIh2kTpyACCQ62CvC2PAGGj1d2DXXBXRcLIXAnAEMNV4
   gajp36EUljOVyCaeFE5WLfokp0wQ8kpT9h6ZOdud+UoRGxeVvYf/e/kss
   kyxqA2IQ9yzYHe4LLhXqd04tzfNDQuBVf5ee7eVaxo3H6lPp51jIlWXZk
   GedRXWp09obS991vYA/dKdbTubgsPSGdie5u6kRFIMgmw18+g2CRopE85
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10494"; a="365998462"
X-IronPort-AV: E=Sophos;i="5.95,171,1661842800"; 
   d="scan'208";a="365998462"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Oct 2022 02:52:51 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10494"; a="954590238"
X-IronPort-AV: E=Sophos;i="5.95,171,1661842800"; 
   d="scan'208";a="954590238"
Received: from lkp-server01.sh.intel.com (HELO 2af0a69ca4e0) ([10.239.97.150])
  by fmsmga005.fm.intel.com with ESMTP; 09 Oct 2022 02:52:48 -0700
Received: from kbuild by 2af0a69ca4e0 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ohSzH-0000rU-1k;
        Sun, 09 Oct 2022 09:52:47 +0000
Date:   Sun, 9 Oct 2022 17:52:17 +0800
...
Subject: Re: [PATCH 1/8] usb: chipidea: core: add controller resume support
 when controller is powered off
Message-ID: <202210091716.1BSpNzfb-lkp@intel.com>
References: <20221009160813.776829-2-xu.yang_2@nxp.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="fPe88b/HgxgZ1BYl"
Content-Disposition: inline
In-Reply-To: <20221009160813.776829-2-xu.yang_2@nxp.com>
...
reproduce (this is a W=1 build):
        ...
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=m68k SHELL=/bin/bash drivers/usb/chipidea/
...
>> drivers/usb/chipidea/core.c:681:6: warning: no previous prototype for 'ci_handle_power_lost' [-Wmissing-prototypes]
     681 | void ci_handle_power_lost(struct ci_hdrc *ci)
         |      ^~~~~~~~~~~~~~~~~~~~


vim +/ci_handle_power_lost +681 drivers/usb/chipidea/core.c

   680	
 > 681	void ci_handle_power_lost(struct ci_hdrc *ci)
   682	{
   683		enum ci_role role;
   684	
   685		disable_irq_nosync(ci->irq);
   686		if (!ci_otg_is_fsm_mode(ci)) {
   687			role = ci_get_role(ci);
   688	
   689			if (ci->role != role) {
   690				ci_handle_id_switch(ci);
   691			} else if (role == CI_ROLE_GADGET) {
   692				if (ci->is_otg && hw_read_otgsc(ci, OTGSC_BSV))
   693					usb_gadget_vbus_connect(&ci->gadget);
   694			}
   695		}
   696	
   697		enable_irq(ci->irq);
   698	}
   699	
...
# Linux/m68k 6.0.0-rc4 Kernel Configuration
#
