
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: zJZUKqWYpLzV+huhKcM6+2G1c0/X4VE5/4IMdurxxoGu4/n3pOO6q6Eo+lhOKfo/Lwo0ywgFG5YA5xM9fUPxSSj/wRJKhax9YKdwlmzZBRVo8bo3a8YTonKjBcq58SE5
...
@@ -235,12 +320,31 @@ static int mausb_hcd_hub_status(struct usb_hcd *hcd, =
char *buff);
...
+{
+=09mausb_pr_debug("URB: urb=3D%p, ep_handle=3D%#x, packet_num=3D%d, setup_=
dma=3D%lld, is_setup_packet=3D%d, is_ep=3D%d, is_sg=3D%d, num_sgs=3D%d, num=
_mapped_sgs=3D%d, status=3D%d, is_transfer_buffer=3D%d, transfer_buffer_len=
gth=3D%d, is_transfer_dma=3D%llu, transfer_flags=3D%d, is_hcpriv=3D%d",
...
@@ -311,6 +418,25 @@ static int get_root_hub_port_number(struct usb_device =
*dev, u8 *port_number)
 =09return 0;
 }
=20
...
+
 ...
 {
@@ -330,6 +456,31 @@ static struct mausb_usb_device_ctx *mausb_find_usb_dev=
...
+
 ...
 {
 =09return 0;
@@ -504,6 +655,123 @@ static int mausb_hcd_hub_control(struct usb_hcd *hcd,=
 u16 type_req,
 =09return retval;
 }
=20
...
+=09=09mausb_pr_err("Client is not responsive anymore - finish urb immediat=
ely");
...
@@ -763,8 +1031,10 @@ static void mausb_free_dev(struct usb_hcd *hcd, struc=
t usb_device *dev)
 =09u8=09port_number;
 =09s16=09dev_handle;
 =09int=09status;
...
=20
@@ -777,6 +1047,16 @@ static void mausb_free_dev(struct usb_hcd *hcd, struc=
t usb_device *dev)
=20
...
@@ -785,6 +1065,13 @@ static void mausb_free_dev(struct usb_hcd *hcd, struc=
t usb_device *dev)
=20
 =09dev_handle =3D usb_device_ctx->dev_handle;
=20
+=09if (atomic_read(&ma_dev->unresponsive_client)) {
+=09=09mausb_pr_err("Client is not responsive anymore - free usbdevice imme=
diately");
...
+
 ...
 =09=09dev->ep0.hcpriv =3D NULL;
 =09=09kfree(ep_ctx);
@@ -793,16 +1080,60 @@ static void mausb_free_dev(struct usb_hcd *hcd, stru=
ct usb_device *dev)
...
+=09struct mausb_device=09    *ma_dev;
 ...
 =09struct mausb_endpoint_ctx   *endpoint_ctx;
=20
@@ -813,9 +1144,23 @@ static int mausb_address_device(struct usb_hcd *hcd, =
...
@@ -846,9 +1191,13 @@ static int mausb_add_endpoint(struct usb_hcd *hcd, st=
ruct usb_device *dev,
 {
 =09int=09status;
 =09u8=09port_number;
...
@@ -857,6 +1206,16 @@ static int mausb_add_endpoint(struct usb_hcd *hcd, st=
ruct usb_device *dev,
 =09=09return 0;
 =09}
=20
...
=20
 =09if (!usb_dev_ctx) {
@@ -870,8 +1229,17 @@ static int mausb_add_endpoint(struct usb_hcd *hcd, st=
ruct usb_device *dev,
=20
...
=20
@@ -881,8 +1249,10 @@ static int mausb_drop_endpoint(struct usb_hcd *hcd, s=
...
=20
 =09status =3D get_root_hub_port_number(dev, &port_number);
 =09if (status < 0 || port_number >=3D NUMBER_OF_PORTS) {
@@ -891,6 +1261,16 @@ static int mausb_drop_endpoint(struct usb_hcd *hcd, s=
truct usb_device *dev,
 =09=09return -EINVAL;
 =09}
=20
...
=20
 =09if (!endpoint_ctx) {
@@ -907,12 +1287,78 @@ static int mausb_drop_endpoint(struct usb_hcd *hcd, =
struct usb_device *dev,
 =09return 0;
 }
=20
...
=20
 =09status =3D get_root_hub_port_number(dev, &port_number);
 =09if (status < 0 || port_number >=3D NUMBER_OF_PORTS) {
@@ -921,13 +1367,27 @@ static int mausb_enable_device(struct usb_hcd *hcd, =
struct usb_device *dev)
 =09=09return -EINVAL;
 =09}
=20
...
=20
@@ -941,7 +1401,9 @@ static int mausb_update_device(struct usb_hcd *hcd, st=
ruct usb_device *dev)
...
@@ -955,6 +1417,16 @@ static int mausb_update_device(struct usb_hcd *hcd, s=
truct usb_device *dev)
 =09=09return -EINVAL;
 =09}
=20
...
@@ -969,10 +1441,12 @@ static int mausb_hub_update_device(struct usb_hcd *h=
...
@@ -987,6 +1461,16 @@ static int mausb_hub_update_device(struct usb_hcd *hc=
...
+
 ...
 =09=09=09=09=09       dev);
=20
@@ -1027,10 +1511,12 @@ static void mausb_endpoint_reset(struct usb_hcd *hc=
d,
 =09int is_control;
 =09int epnum;
 =09int is_out;
...
@@ -1053,14 +1539,21 @@ static void mausb_endpoint_reset(struct usb_hcd *hc=
d,
 =09}
...
@@ -1083,7 +1576,9 @@ static int mausb_reset_device(struct usb_hcd *hcd, st=
ruct usb_device *dev)
 =09int status;
 =09u8  port_number;
 =09u16 dev_handle;
...
=20
 =09hub =3D (struct hub_ctx *)hcd->hcd_priv;
@@ -1095,6 +1590,16 @@ static int mausb_reset_device(struct usb_hcd *hcd, s=
truct usb_device *dev)
 =09=09return -EINVAL;
 =09}
=20
...
+=09if (atomic_read(&ma_dev->unresponsive_client)) {
+=09=09mausb_pr_err("Client is not responsive anymore - finish urb immediat=
ely urb=3D%p, ep_handle=3D%#x, dev_handle=3D%#x",
...
+=09=09mausb_pr_alert("Failed to insert in tree urb=3D%p ep_handle=3D%#x, s=
tatus=3D%d",
...
diff --git a/drivers/usb/mausb_host/ma_usb.h b/drivers/usb/mausb_host/ma_us=
b.h
new file mode 100644
...
diff --git a/drivers/usb/mausb_host/mausb_address.h b/drivers/usb/mausb_hos=
t/mausb_address.h
new file mode 100644
...
diff --git a/drivers/usb/mausb_host/mausb_event.h b/drivers/usb/mausb_host/=
mausb_event.h
new file mode 100644
