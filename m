Return-Path: <linux-usb+bounces-35846-lists+linux-usb=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-usb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id wOhKFnApzmnIlQYAu9opvQ
	(envelope-from <linux-usb+bounces-35846-lists+linux-usb=lfdr.de@vger.kernel.org>)
	for <lists+linux-usb@lfdr.de>; Thu, 02 Apr 2026 10:31:44 +0200
X-Original-To: lists+linux-usb@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [104.64.211.4])
	by mail.lfdr.de (Postfix) with ESMTPS id 36D383860B9
	for <lists+linux-usb@lfdr.de>; Thu, 02 Apr 2026 10:31:42 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 106E03054337
	for <lists+linux-usb@lfdr.de>; Thu,  2 Apr 2026 08:28:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3A5313C1404;
	Thu,  2 Apr 2026 08:28:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b="2ahiQh9v";
	dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b="ej8BXXYf"
X-Original-To: linux-usb@vger.kernel.org
Received: from bkemail.birger-koblitz.de (bkemail.birger-koblitz.de [23.88.97.239])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9EBC53BED2C;
	Thu,  2 Apr 2026 08:28:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=23.88.97.239
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1775118509; cv=none; b=pNCizxtL+0uSSXMAtAZV8mGoXFHAhiel1dkc/o/g6kIhQNRzvCcO0IlA3yPGWIqE7ehzaysnZBhFz+VTvL2D7leLE9GRqzF8Qi4KsdCqnllAg6tHhYzL9cbrrpnKawsZ8Ftc7pDBRlpCdnTF42Ja9uOJdxLdA1qzRU9WgNaC/os=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1775118509; c=relaxed/simple;
	bh=KQ+B9aCo43gC36Xl+/wlDp75Xpym1i3aibhYsnPnySI=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=gm9s+X6stDJDGwwyRLnkWTtOIP6j9YyDCE7P124j/kO9XIH4Sot1/8FEai94gJDfE4N4xqXovKiQdiad+OUFOmaWQjJPFAfsLdH1J/ncEhYnNwX9Q9y4gB5HdW4k6owZckgmNFmZJ45lrinGEwv1MPKUUuTrP+UqpL+OAHGHnNo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=birger-koblitz.de; spf=pass smtp.mailfrom=birger-koblitz.de; dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b=2ahiQh9v; dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b=ej8BXXYf; arc=none smtp.client-ip=23.88.97.239
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=birger-koblitz.de
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=birger-koblitz.de
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=birger-koblitz.de;
	s=default; t=1775118504;
	bh=KQ+B9aCo43gC36Xl+/wlDp75Xpym1i3aibhYsnPnySI=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
	b=
Received: by bkemail.birger-koblitz.de (Postfix, from userid 109)
	id 13F26408D4; Thu,  2 Apr 2026 08:28:24 +0000 (UTC)
X-Spam-Level: 
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=birger-koblitz.de;
	s=default; t=1775118499;
	bh=KQ+B9aCo43gC36Xl+/wlDp75Xpym1i3aibhYsnPnySI=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
	b=
Received: from DebianDesktop.lan (p200300c69f04eb0000000000000001c8.dip0.t-ipconnect.de [IPv6:2003:c6:9f04:eb00::1c8])
	by bkemail.birger-koblitz.de (Postfix) with ESMTPSA id 48BCA408C3;
	Thu,  2 Apr 2026 08:28:19 +0000 (UTC)
From: Birger Koblitz <mail@birger-koblitz.de>
Date: Thu, 02 Apr 2026 10:28:14 +0200
Subject: [PATCH net-next v6 2/2] r8152: Add support for the RTL8157
 hardware
Precedence: bulk
...
Message-Id: <20260402-rtl8157_next-v6-2-a9b77c0931ef@birger-koblitz.de>
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-35846-lists,linux-usb=lfdr.de];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sin.lore.kernel.org:helo,sin.lore.kernel.org:rdns,birger-koblitz.de:dkim,birger-koblitz.de:email,birger-koblitz.de:mid]
X-Rspamd-Queue-Id: 36D383860B9
