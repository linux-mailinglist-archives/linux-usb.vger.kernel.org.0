Return-Path: <linux-usb+bounces-38048-lists+linux-usb=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-usb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id DUWBJbXLFGqVQQcAu9opvQ
	(envelope-from <linux-usb+bounces-38048-lists+linux-usb=lfdr.de@vger.kernel.org>)
	for <lists+linux-usb@lfdr.de>; Tue, 26 May 2026 00:22:45 +0200
X-Original-To: lists+linux-usb@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id DFD495CEFFB
	for <lists+linux-usb@lfdr.de>; Tue, 26 May 2026 00:22:44 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 033893018AD8
	for <lists+linux-usb@lfdr.de>; Mon, 25 May 2026 22:22:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 276FA3939BD;
	Mon, 25 May 2026 22:22:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="JUvH5M/c"
X-Original-To: linux-usb@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-alma10-1.taild15c8.ts.net [100.103.45.18])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E9E7A1F4CB3
	for <linux-usb@vger.kernel.org>; Mon, 25 May 2026 22:22:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=100.103.45.18
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1779747760; cv=none; b=aCuB1gXz1eecf7i2IIKeNeSFsO3iF2dLu9y+LUx9R2aypyA3d7zU4cDFSV/uk+wdX+7s/ggXSPrWDIFkFC3+ye+kaN5W7wrW2qzEgXE1NCwYA6w4MKHa4/tjwmgVUZL94T5IzUThO0wO91kUurmrVdjNbJtocC8Tm6zldKG4qM0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1779747760; c=relaxed/simple;
	bh=QggmNbcGWIyf8cKYjcVzJZV5ZbRwfvGcUtPPYUX6Zd0=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=CLQesAhJUsAEadgcubJM16d+HkLAM42ez3HpebRyY5EL6CF+RIMZ/mJ7UZ1xQ6DyEFgXNJQofHfk1fQAXI1jWW3F5gpBKIN84CJTThT+kEqAnHpN6/Nt56oglziTRgmfigujQE0t9aUYiKTAWRk8lXtYGgeGMWAFYlmNkconiFo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=JUvH5M/c; arc=none smtp.client-ip=100.103.45.18
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 83F8B1F000E9;
	Mon, 25 May 2026 22:22:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kernel.org;
	s=k20260515; t=1779747758;
	bh=s8pKUdbaBkzVAZmPqWVy1XS+F65ZmJ2CIbd1e1hGtxs=;
	h=Date:Subject:To:Cc:References:From:In-Reply-To;
	b=
Message-ID: <8c753210-e399-4ddf-8ca4-d250fd4af369@kernel.org>
Date: Mon, 25 May 2026 17:22:35 -0500
Precedence: bulk
...
In-Reply-To: <20260525044421.GI8580@black.igk.intel.com>
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-38048-lists,linux-usb=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
...
added a discrete USB4v2 router to some of the PCIe lanes on the Strix 
Halo APU.
...
Can you reproduce your issue on the AMD routers too (these are the 
regular USB4 ones with PCI vendor 1022) or only on the USB4v2 ones?

You might need to look at the user guide for your device to see which 
USB-C ports these are connected to if it's not obvious from silkscreens.
...
The most severe symptom is that when using an NV dGPU with the GSP 
loaded it causes a sync flood to the APU and the system reboots.
...
Maybe Mika and some others on this list have some further ideas.  It 
seems Windows and Linux are setting up something very differently.
>>
>> Attached:
