...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 00109256D5B
	for <lists+linux-usb@lfdr.de>; Sun, 30 Aug 2020 12:39:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728700AbgH3Kjf (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Sun, 30 Aug 2020 06:39:35 -0400
Received: from mga06.intel.com ([134.134.136.31]:44216 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726130AbgH3Kjc (ORCPT <rfc822;linux-usb@vger.kernel.org>);
        Sun, 30 Aug 2020 06:39:32 -0400
IronPort-SDR: +k31XSxi9qeU2O7tibCatLYrdnWstcuuB4lYCOOhfHFF1ApfxcqfFrshTZwBcAYto/C7nx7f/H
 adnQ7+uFU+gg==
X-IronPort-AV: E=McAfee;i="6000,8403,9728"; a="218399591"
X-IronPort-AV: E=Sophos;i="5.76,371,1592895600"; 
   d="gz'50?scan'50,208,50";a="218399591"
...
To:     =?utf-8?B?5ZGo55Cw5p2wIChaaG91IFlhbmppZSk=?= 
        <zhouyanjie@wanyeetech.com>, kishon@ti.com, vkoul@kernel.org,
...
[cannot apply to balbi-usb/testing/next linus/master phy/next v5.9-rc2 v5.9-rc1 v5.8 v5.9-rc2]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch]

url:    https://github.com/0day-ci/linux/commits/Zhou-Yanjie/USB-PHY-JZ4770-Use-the-generic-PHY-framework/20200830-154912
...
git fetch --no-tags linux-review Zhou-Yanjie/USB-PHY-JZ4770-Use-the-generic-PHY-framework/20200830-154912
...
2a6c0b82e65128c drivers/usb/phy/phy-jz4770.c 周琰杰 (Zhou Yanjie  2020-07-23 @312) static const struct of_device_id ingenic_usb_phy_of_matches[] = {
2a6c0b82e65128c drivers/usb/phy/phy-jz4770.c 周琰杰 (Zhou Yanjie  2020-07-23  313) 	{ .compatible = "ingenic,jz4770-phy", .data = &jz4770_soc_info },
2a6c0b82e65128c drivers/usb/phy/phy-jz4770.c 周琰杰 (Zhou Yanjie  2020-07-23  314) 	{ .compatible = "ingenic,jz4780-phy", .data = &jz4780_soc_info },
2a6c0b82e65128c drivers/usb/phy/phy-jz4770.c 周琰杰 (Zhou Yanjie  2020-07-23  315) 	{ .compatible = "ingenic,x1000-phy", .data = &x1000_soc_info },
2a6c0b82e65128c drivers/usb/phy/phy-jz4770.c 周琰杰 (Zhou Yanjie  2020-07-23  316) 	{ .compatible = "ingenic,x1830-phy", .data = &x1830_soc_info },
2a6c0b82e65128c drivers/usb/phy/phy-jz4770.c 周琰杰 (Zhou Yanjie  2020-07-23  317) 	{ /* sentinel */ }
2a6c0b82e65128c drivers/usb/phy/phy-jz4770.c 周琰杰 (Zhou Yanjie  2020-07-23  318) };
2a6c0b82e65128c drivers/usb/phy/phy-jz4770.c 周琰杰 (Zhou Yanjie  2020-07-23  319) MODULE_DEVICE_TABLE(of, ingenic_usb_phy_of_matches);
