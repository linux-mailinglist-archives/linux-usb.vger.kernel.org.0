...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5B5D24EB9B9
	for <lists+linux-usb@lfdr.de>; Wed, 30 Mar 2022 06:36:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242635AbiC3Ei2 (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Wed, 30 Mar 2022 00:38:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44938 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242617AbiC3EiW (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Wed, 30 Mar 2022 00:38:22 -0400
Received: from alexa-out.qualcomm.com (alexa-out.qualcomm.com [129.46.98.28])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F314922B00
        for <linux-usb@vger.kernel.org>; Tue, 29 Mar 2022 21:36:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=quicinc.com; i=@quicinc.com; q=dns/txt; s=qcdkim;
  t=1648614997; x=1680150997;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=ZVSSV0XOQpNnR4T92tchagkZ85QpbJyLAuNDxzyGyCk=;
  b=oaILr8OKfJV79MDwsuFdocVt05pTDjo4+FWXcs0YULg2cyeiEavNq3Lo
   XEe8K+CkIRVAXW7EQzos4jaDzeate/800fWB6+ae7oLfpiuzZpxOWLUtu
   J2CntID9mhmPpom9L5VXgGfyby/Z5/SaKRu/NG9n8zldJo2IqQGAZDToX
   8=;
Received: from ironmsg08-lv.qualcomm.com ([10.47.202.152])
  by alexa-out.qualcomm.com with ESMTP; 29 Mar 2022 21:36:36 -0700
X-QCInternal: smtphost
Received: from nasanex01c.na.qualcomm.com ([10.47.97.222])
  by ironmsg08-lv.qualcomm.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Mar 2022 21:36:36 -0700
Received: from nalasex01b.na.qualcomm.com (10.47.209.197) by
 nasanex01c.na.qualcomm.com (10.47.97.222) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.986.22; Tue, 29 Mar 2022 21:36:36 -0700
...
Subject: [PATCH v3 5/5] usb: gadget: add trace event of configfs write attributes operation
Date:   Wed, 30 Mar 2022 12:36:20 +0800
Message-ID: <1648614980-25024-6-git-send-email-quic_linyyuan@quicinc.com>
...
index b39bf6f..76f7c41 100644
--- a/drivers/usb/gadget/trace.c
+++ b/drivers/usb/gadget/trace.c
@@ -129,4 +129,28 @@ void trace_usb_configfs_unlink_group(struct config_item *dest,
