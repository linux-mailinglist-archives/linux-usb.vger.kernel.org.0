...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C94E01B8532
	for <lists+linux-usb@lfdr.de>; Sat, 25 Apr 2020 11:21:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726271AbgDYJUf (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Sat, 25 Apr 2020 05:20:35 -0400
Received: from eu-smtp-delivery-167.mimecast.com ([207.82.80.167]:43282 "EHLO
        eu-smtp-delivery-167.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726188AbgDYJUd (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Sat, 25 Apr 2020 05:20:33 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=displaylink.com;
        s=mimecast20151025; t=1587806424;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=T34tLatZ+B/mChzogOTqRxVU8zFlb1BrnkNHi8Clke0=;
        b=oqwcXvhgFF9bnPsWHo/7qtfYx991/JRTxRuG5GWLXHgMTMw/Q+rMH1vBpurv9CN93l0m70
        0HZU1fwFKWsFeV1ftHKSgMF68TM7pJT0IzQuVYDaq9b3j1QrkFOPbGi6I4jVBHwhDFIDZH
        KAYTmr3lkKzNFqlTBuYAA3A5xqlfgco=
Received: from EUR01-HE1-obe.outbound.protection.outlook.com
 (mail-he1eur01lp2050.outbound.protection.outlook.com [104.47.0.50]) (Using
 TLS) by relay.mimecast.com with ESMTP id
 uk-mta-106-4Pq6mODxN6iJVPdvTRwVmQ-2; Sat, 25 Apr 2020 10:20:22 +0100
X-MC-Unique: 4Pq6mODxN6iJVPdvTRwVmQ-2
...
Date:   Sat, 25 Apr 2020 11:19:53 +0200
Message-Id: <20200425091954.1610-8-vladimir.stankovic@displaylink.com>
...
Received: from raven-hp.endava.net (94.189.199.177) by LO2P265CA0131.GBRP265.PROD.OUTLOOK.COM (2603:10a6:600:9f::23) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.2937.13 via Frontend Transport; Sat, 25 Apr 2020 09:20:17 +0000
X-Mailer: git-send-email 2.17.1
X-Originating-IP: [94.189.199.177]
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: 6aa41985-09e4-464f-ee3e-08d7e8f9def5
X-MS-TrafficTypeDiagnostic: VI1PR1001MB1056:
X-MS-Exchange-Transport-Forked: True
X-Microsoft-Antispam-PRVS: <VI1PR1001MB10565C0C6D3A1BB525430FF191D10@VI1PR1001MB1056.EURPRD10.PROD.OUTLOOK.COM>
...
X-Microsoft-Antispam-Message-Info: 
X-MS-Exchange-AntiSpam-MessageData: 
X-OriginatorOrg: displaylink.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 6aa41985-09e4-464f-ee3e-08d7e8f9def5
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 25 Apr 2020 09:20:18.6092
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: a4bda75a-b444-4312-9c90-44a7c4b2c91a
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: Jnba2l62ZZOs4jhqcandzVX++eI070StjeVrmq5JV88mqpXbjan1ZXBOj5OypiLWmmjusuJu0J4A7YGXe0wbtTnu4P3jn6j1aM9wCyqZ/pBBe/5DMeouuz4W+byKjCIa
...
@@ -1073,6 +1074,18 @@ static void mausb_free_dev(struct usb_hcd *hcd, stru=
ct usb_device *dev)
 =09}
=20
 =09if (ep_ctx) {
...
+=09=09=09=09      ep_ctx->ep_handle, dev_handle);
 ...
 =09=09kfree(ep_ctx);
=20
@@ -1080,6 +1093,14 @@ static void mausb_free_dev(struct usb_hcd *hcd, stru=
ct usb_device *dev)
...
g");
@@ -1094,6 +1115,21 @@ static void mausb_free_dev(struct usb_hcd *hcd, stru=
ct usb_device *dev)
...
@@ -1176,6 +1212,12 @@ static int mausb_address_device(struct usb_hcd *hcd,=
...
@@ -1183,7 +1225,19 @@ static int mausb_address_device(struct usb_hcd *hcd,=
 struct usb_device *dev)
 =09=09return -EINVAL;
 =09}
=20
...
@@ -1236,10 +1290,32 @@ static int mausb_add_endpoint(struct usb_hcd *hcd, =
struct usb_device *dev,
...
=20
@@ -1248,6 +1324,7 @@ static int mausb_drop_endpoint(struct usb_hcd *hcd, s=
...
@@ -1282,9 +1359,49 @@ static int mausb_drop_endpoint(struct usb_hcd *hcd, =
struct usb_device *dev,
 =09=09return -ENODEV;
 =09}
=20
...
+=09=09mausb_pr_err("Client is not responsive anymore - drop endpoint immed=
iately");
+=09=09endpoint->hcpriv =3D NULL;
+=09=09kfree(endpoint_ctx);
...
+=09=09=09=09=09=09      endpoint_ctx->ep_handle);
+
+=09=09mausb_pr_info("ep_handle_delete_request, ep_handle=3D%#x, dev_handle=
=3D%#x, status=3D%d",
...
@@ -1337,6 +1454,20 @@ static int mausb_device_assign_dev_handle(struct usb=
_hcd *hcd,
 =09=09return -EINVAL;
 =09}
=20
...
+
 ...
 =09if (!endpoint_ctx)
 =09=09return -ENOMEM;
@@ -1348,6 +1479,22 @@ static int mausb_device_assign_dev_handle(struct usb=
_hcd *hcd,
=20
...
=20
@@ -1385,9 +1532,18 @@ static int mausb_enable_device(struct usb_hcd *hcd, =
struct usb_device *dev)
 =09=09=09return status;
 =09}
=20
...
=20
@@ -1433,7 +1589,15 @@ static int mausb_update_device(struct usb_hcd *hcd, =
struct usb_device *dev)
 =09=09return -ENODEV;
 =09}
=20
...
*dev,
@@ -1443,8 +1607,10 @@ static int mausb_hub_update_device(struct usb_hcd *h=
...
@@ -1484,7 +1650,17 @@ static int mausb_hub_update_device(struct usb_hcd *h=
cd, struct usb_device *dev,
...
@@ -1561,12 +1748,52 @@ static void mausb_endpoint_reset(struct usb_hcd *hc=
d,
...
+
+=09=09mausb_pr_err("ep_activate failed, status=3D%d, ep_handle=3D%#x, dev_=
handle=3D%#x",
...
@@ -1608,7 +1835,15 @@ static int mausb_reset_device(struct usb_hcd *hcd, s=
truct usb_device *dev)
=20
...
@@ -278,6 +279,31 @@ void mausb_release_event_resources(struct mausb_event =
*event)
...
+
 ...
 {
 =09(*port_number) =3D 0;
@@ -338,11 +404,142 @@ static inline void mausb_port_has_changed_event(stru=
ct mausb_device *dev,
...
=20
@@ -363,6 +560,11 @@ static void mausb_socket_disconnect_event(struct work_=
struct *work)
...
+
+=09=09mausb_pr_info("Sending notification to user that network is disconne=
cted status=3D%d",
+=09=09=09      status);
+
 ...
 =09=09kref_put(&dev->refcount, mausb_release_ma_dev_async);
 =09}
@@ -427,6 +629,13 @@ static void mausb_delete_madev(struct work_struct *wor=
k)
=20
...
@@ -449,10 +658,14 @@ static void mausb_delete_madev(struct work_struct *wo=
rk)
=20
...
@@ -576,6 +797,7 @@ mausb_create_madev(struct mausb_device_address dev_addr=
, u8 madev_address,
=20
...
@@ -601,6 +823,15 @@ mausb_create_madev(struct mausb_device_address dev_add=
r, u8 madev_address,
...
@@ -659,6 +890,14 @@ int mausb_initiate_dev_connection(struct mausb_device_=
address dev_addr,
 =09return 0;
 }
=20
...
+
 ...
 {
@@ -683,9 +922,29 @@ int mausb_enqueue_event_from_user(u8 madev_addr, u16 n=
um_of_events,
 =09return 0;
 }
=20
...
@@ -728,7 +987,12 @@ int mausb_data_req_enqueue_event(struct mausb_device *=
dev, u16 ep_handle,
...
@@ -841,6 +1105,17 @@ static void mausb_execute_urb_dequeue(struct work_str=
uct *dequeue_work)
...
@@ -855,6 +1130,13 @@ static void mausb_execute_urb_dequeue(struct work_str=
uct *dequeue_work)
...
@@ -1104,7 +1387,6 @@ int mausb_send_transfer_ack(struct mausb_device *dev,=
...
@@ -1119,10 +1401,9 @@ int mausb_send_data_msg(struct mausb_device *dev, st=
...
vent)
@@ -1142,8 +1423,10 @@ int mausb_receive_data_msg(struct mausb_device *dev,=
 struct mausb_event *event)
=20
...
@@ -1279,6 +1562,7 @@ static void mausb_connect_callback(struct mausb_devic=
e *dev,
...
=20
@@ -1305,6 +1589,16 @@ static void mausb_handle_receive_event(struct mausb_=
device *dev,
 =09}
=20
...
@@ -1614,3 +1908,148 @@ u32 mausb_data_iterator_length(struct mausb_data_it=
er *iterator)
 {
...
@@ -133,6 +134,10 @@ static inline u64 mausb_event_id(struct mausb_device *=
dev)
=20
...
,
@@ -282,6 +287,33 @@ void mausb_reset_data_iterator(struct mausb_data_iter =
*iterator);
...
+
 ...
 {
@@ -292,4 +324,16 @@ static inline unsigned int mausb_get_page_order(unsign=
ed int num_of_elems,
 =09return order;
 }
=20
...
diff --git a/drivers/usb/mausb_host/hpal_events.c b/drivers/usb/mausb_host/=
hpal_events.c
...
+}
diff --git a/drivers/usb/mausb_host/hpal_events.h b/drivers/usb/mausb_host/=
hpal_events.h
new file mode 100644
...
diff --git a/drivers/usb/mausb_host/mausb_driver_status.h b/drivers/usb/mau=
sb_host/mausb_driver_status.h
new file mode 100644
...
@@ -35,9 +78,213 @@ static int mausb_file_close(struct inode *inode, struct=
 file *filp)
 =09return 0;
 }
=20
...
+=09=09mausb_pr_alert("The actual size differs from the expected number of =
bytes");
...
+
+=09mausb_pr_debug("num_of_bytes_not_copied %lu, num_of_bytes_to_read %zd",
...
+}
+
+static ssize_t mausb_file_write(struct file *filp, const char __user *buff=
er,
