...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 71AD7655777
	for <lists+linux-usb@lfdr.de>; Sat, 24 Dec 2022 02:35:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236769AbiLXBfh (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Fri, 23 Dec 2022 20:35:37 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57544 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236691AbiLXBel (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Fri, 23 Dec 2022 20:34:41 -0500
Received: from sin.source.kernel.org (sin.source.kernel.org [IPv6:2604:1380:40e1:4800::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C77084AF0E;
        Fri, 23 Dec 2022 17:31:47 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by sin.source.kernel.org (Postfix) with ESMTPS id 72684CE1D30;
        Sat, 24 Dec 2022 01:31:45 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 8DE47C433A0;
        Sat, 24 Dec 2022 01:31:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1671845503;
        bh=x2jjWrNEPlngtrb8TsMjwE/H6ebLUQan9PH5KNzXqac=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
From:   Sasha Levin <sashal@kernel.org>
To:     linux-kernel@vger.kernel.org, stable@vger.kernel.org
Cc:     Sascha Hauer <s.hauer@pengutronix.de>,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        Sasha Levin <sashal@kernel.org>, skhan@linuxfoundation.org,
...
Subject: [PATCH AUTOSEL 5.15 04/14] usb: gadget: u_ether: Do not make UDC parent of the net device
Date:   Fri, 23 Dec 2022 20:31:17 -0500
Message-Id: <20221224013127.393187-4-sashal@kernel.org>
...
index ef253599dcf9..315df034878a 100644
--- a/drivers/usb/gadget/function/u_ether.c
+++ b/drivers/usb/gadget/function/u_ether.c
@@ -797,7 +797,6 @@ struct eth_dev *gether_setup_name(struct usb_gadget *g,
...
@@ -871,8 +870,6 @@ int gether_register_netdev(struct net_device *net)
 	struct usb_gadget *g;
 	int status;
...
@@ -903,7 +900,6 @@ void gether_set_gadget(struct net_device *net, struct usb_gadget *g)
