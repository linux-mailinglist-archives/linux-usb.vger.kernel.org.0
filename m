...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8F5B74D9DB5
	for <lists+linux-usb@lfdr.de>; Tue, 15 Mar 2022 15:35:26 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1349310AbiCOOf3 (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Tue, 15 Mar 2022 10:35:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44776 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1349281AbiCOOfW (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Tue, 15 Mar 2022 10:35:22 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5818C36B75
        for <linux-usb@vger.kernel.org>; Tue, 15 Mar 2022 07:34:01 -0700 (PDT)
Received: from dude.hi.pengutronix.de ([2001:67c:670:100:1d::7])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mgr@pengutronix.de>)
        id 1nU8FL-0004wq-HE; Tue, 15 Mar 2022 15:33:59 +0100
Received: from mgr by dude.hi.pengutronix.de with local (Exim 4.94.2)
        (envelope-from <mgr@pengutronix.de>)
        id 1nU8FK-00GRp5-MI; Tue, 15 Mar 2022 15:33:58 +0100
From:   Michael Grzeschik <m.grzeschik@pengutronix.de>
To:     linux-usb@vger.kernel.org
Cc:     balbi@kernel.org, laurent.pinchart@ideasonboard.com,
        paul.elder@ideasonboard.com, kernel@pengutronix.de,
        nicolas@ndufresne.ca, kieran.bingham@ideasonboard.com
Subject: [PATCH v7 6/7] usb: gadget: uvc: add VIDIOC function
Date:   Tue, 15 Mar 2022 15:33:55 +0100
Message-Id: <20220315143356.3919911-7-m.grzeschik@pengutronix.de>
...
negotiate and allocate the data. It doesn't have to bring its own configfs
parser.
...
index 37fdf8b3495a48..64f20fe6967099 100644
...
+	struct config_item *streaming, *header, *h;
 	...
 	if (uvc == NULL)
@@ -938,6 +944,33 @@ static struct usb_function *uvc_alloc(struct usb_function_instance *fi)
...
index c3607a32b98624..5a6e3e493d0630 100644
...
@@ -175,4 +178,11 @@ extern void uvc_endpoint_stream(struct uvc_device *dev);
...
index d852ac9e47e72c..d6f97788859f32 100644
