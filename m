Return-Path: <linux-usb+bounces-34531-lists+linux-usb=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-usb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CMPiLkw9sWmAswIAu9opvQ
	(envelope-from <linux-usb+bounces-34531-lists+linux-usb=lfdr.de@vger.kernel.org>)
	for <lists+linux-usb@lfdr.de>; Wed, 11 Mar 2026 11:00:44 +0100
X-Original-To: lists+linux-usb@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 697ED2619BF
	for <lists+linux-usb@lfdr.de>; Wed, 11 Mar 2026 11:00:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id CB723337BB41
	for <lists+linux-usb@lfdr.de>; Wed, 11 Mar 2026 09:28:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 402AA3C9424;
	Wed, 11 Mar 2026 09:21:58 +0000 (UTC)
...
X-Spamd-Result: default: False [2.44 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-34531-lists,linux-usb=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[aleksandr.loktionov@intel.com,linux-usb@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
	DKIM_TRACE(0.00)[intel.com:+];
	NEURAL_HAM(-0.00)[-1.000];
	ASN(0.00)[asn:63949, ipnet:172.234.224.0/19, country:SG];
	TAGGED_RCPT(0.00)[linux-usb];
	RSPAMD_EMAILBL_FAIL(0.00)[v9fs.lists.linux.dev:query timed out,scsi.vger.kernel.org:query timed out,linux-s390.vger.kernel.org:query timed out,cifs.vger.kernel.org:query timed out,linux-modules.vger.kernel.org:query timed out,linux-ext4.vger.kernel.org:query timed out,lan.lists.osuosl.org:query timed out,kernel.vger.kernel.org:query timed out,linux-gpio.vger.kernel.org:query timed out,hyperv.vger.kernel.org:query timed out,amd-gfx.lists.freedesktop.org:query timed out,ntfs3.lists.linux.dev:query timed out,dri-devel.lists.freedesktop.org:query timed out,iommu.lists.linux.dev:query timed out,ceph-devel.vger.kernel.org:query timed out,linux-arm-kernel.lists.infradead.org:query timed out,marcel.holtmann.org:query timed out,media.vger.kernel.org:query timed out,phahn-oss.avm.de:query timed out,linux-stm32.st-md-mailman.stormreply.com:query timed out,linux-sctp.vger.kernel.org:query timed out,samba-technical.lists.samba.org:query timed out,linux-pm.vger.kernel.org:query timed out,linux-le
 ds.vger.kernel.org:query timed out,nfs.vger.kernel.org:query timed out,linux-trace-kernel.vger.kernel.org:query timed out,linux-input.vger.kernel.org:query timed out,linux-block.vger.kernel.org:query timed out,linux-omap.vger.kernel.org:query timed out,rockchip.lists.infradead.org:query timed out];
	MISSING_XM_UA(0.00)[];
