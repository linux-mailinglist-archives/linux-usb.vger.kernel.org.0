Return-Path: <linux-usb+bounces-35254-lists+linux-usb=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-usb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id IFWJJLwsvWmI7QIAu9opvQ
	(envelope-from <linux-usb+bounces-35254-lists+linux-usb=lfdr.de@vger.kernel.org>)
	for <lists+linux-usb@lfdr.de>; Fri, 20 Mar 2026 12:17:16 +0100
X-Original-To: lists+linux-usb@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id BE2712D9648
	for <lists+linux-usb@lfdr.de>; Fri, 20 Mar 2026 12:17:15 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 3C36C3150B30
	for <lists+linux-usb@lfdr.de>; Fri, 20 Mar 2026 11:14:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E09193A1698;
	Fri, 20 Mar 2026 11:14:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b="nc9xX0Dm";
	dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b="lQejud3i"
X-Original-To: linux-usb@vger.kernel.org
Received: from bkemail.birger-koblitz.de (bkemail.birger-koblitz.de [23.88.97.239])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D5A2B3A3836;
	Fri, 20 Mar 2026 11:14:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=23.88.97.239
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1774005288; cv=none; b=A45r9iKJwMR+7Dpnepmeh0dlp7SvZbOn2PYqf8o08ZFaac0diZt3Keb/wcbLQ2RerbRdocwlBcgk4A/1cPh8++pgd9I7dEExgRG78TyvG1InGwlt4yfO0JZwZ7ctMrd3ZlPyS3yDpFpDhFpiFgZde+c/WsGVMVsbwGpIrPBL3xk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1774005288; c=relaxed/simple;
	bh=FZw+6aVfxyZqJnTVjGEF5/sxauVz+esDn8hrCJhcHgo=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=k3BZAz7B+dfLuHjGip6GRi/X5Bpw+Nrf7Vrs+cs4BDGZxxizIsHsIA/ORC7czQPeMzOr3TgG0R5GrNjG9Ud+dduhdpEBYQSbqmjz4Ck+S7yDVfj+Ckl9tj9b5cfrUPCnnuq1Ech8H3hCg0khh+6Ohy4h6q2pRgN37us+jxZGZpQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=birger-koblitz.de; spf=pass smtp.mailfrom=birger-koblitz.de; dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b=nc9xX0Dm; dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b=lQejud3i; arc=none smtp.client-ip=23.88.97.239
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=birger-koblitz.de
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=birger-koblitz.de
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=birger-koblitz.de;
	s=default; t=1774005283;
	bh=FZw+6aVfxyZqJnTVjGEF5/sxauVz+esDn8hrCJhcHgo=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
	b=
Received: by bkemail.birger-koblitz.de (Postfix, from userid 109)
	id 54FB33FF06; Fri, 20 Mar 2026 11:14:43 +0000 (UTC)
X-Spam-Level: 
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=birger-koblitz.de;
	s=default; t=1774005278;
	bh=FZw+6aVfxyZqJnTVjGEF5/sxauVz+esDn8hrCJhcHgo=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
	b=
Received: from AMDDesktop.lan (unknown [IPv6:2a00:6020:47a3:e800:271c:c6c5:9fde:77cb])
	by bkemail.birger-koblitz.de (Postfix) with ESMTPSA id AFDD93FEF1;
	Fri, 20 Mar 2026 11:14:38 +0000 (UTC)
From: Birger Koblitz <mail@birger-koblitz.de>
Date: Fri, 20 Mar 2026 12:14:38 +0100
Subject: [PATCH net-next v3 2/2] r8152: Add support for the RTL8157
 hardware
Precedence: bulk
...
Message-Id: <20260320-rtl8157_next-v3-2-1aefeca7fda7@birger-koblitz.de>
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-35254-lists,linux-usb=lfdr.de];
	FROM_HAS_DN(0.00)[];
...
---
 drivers/net/usb/r8152.c | 1020 ++++++++++++++++++++++++++++++++++++-----------
 1 file changed, 777 insertions(+), 243 deletions(-)

diff --git a/drivers/net/usb/r8152.c b/drivers/net/usb/r8152.c
index bab8e10e5f99afcb332e333c2739ed7509b03419..6cd3c321edb41a52b8b42d6fc50cc2e93a76278f 100644
...
@@ -2923,13 +3283,14 @@ static netdev_features_t
...
+	else if ((skb->len + tp->tx_desc.size) > agg_buf_sz)
 	...
 	return features;
@@ -3020,7 +3381,7 @@ static void rtl8152_nic_reset(struct r8152 *tp)
...
@@ -3242,6 +3603,7 @@ static void r8153_set_rx_early_timeout(struct r8152 *tp)
 	case RTL_VER_12:
 	case RTL_VER_13:
 	case RTL_VER_15:
+	case RTL_VER_16:
...
@@ -3253,9 +3615,14 @@ static void r8153_set_rx_early_timeout(struct r8152 *tp)
 	}
 }
...
+	u32 ocp_data = tp->rx_buf_sz - rx_reserved_size(tp, tp->netdev->mtu);
 	...
 	switch (tp->version) {
 	case RTL_VER_03:
@@ -3280,6 +3647,10 @@ static void r8153_set_rx_early_size(struct r8152 *tp)
...
+		break;
 	default:
 		WARN_ON_ONCE(1);
 		break;
@@ -3405,6 +3776,7 @@ static void rtl_rx_vlan_en(struct r8152 *tp, bool enable)
 	case RTL_VER_12:
 	case RTL_VER_13:
 	case RTL_VER_15:
+	case RTL_VER_16:
 	default:
 		...
 		if (enable)
@@ -3577,6 +3949,14 @@ static void r8153_u2p3en(struct r8152 *tp, bool enable)
...
+
 ...
 {
 	u32 ups_flags = 0;
@@ -3930,9 +4310,7 @@ static void r8153_power_cut_en(struct r8152 *tp, bool enable)
...
@@ -3946,9 +4324,19 @@ static void r8153b_power_cut_en(struct r8152 *tp, bool enable)
 		ocp_data &= ~PWR_EN;
 	ocp_write_word(tp, MCU_TYPE_USB, USB_POWER_CUT, ocp_data);
...
@@ -4080,6 +4468,14 @@ static void rtl8156_runtime_enable(struct r8152 *tp, bool enable)
 	}
 }
...
+
 ...
 {
 	u32 ocp_data;
@@ -4107,6 +4503,7 @@ static void r8153_teredo_off(struct r8152 *tp)
 	case RTL_VER_13:
 	case RTL_VER_14:
 	case RTL_VER_15:
+	case RTL_VER_16:
...
@@ -4163,6 +4560,7 @@ static void rtl_clear_bp(struct r8152 *tp, u16 type)
 		bp_num = 8;
 		break;
 	case RTL_VER_14:
+	case RTL_VER_16:
 	default:
 		...
 		bp_num = 16;
@@ -4278,6 +4676,7 @@ static bool rtl8152_is_fw_phy_speed_up_ok(struct r8152 *tp, struct fw_phy_speed_
 	case RTL_VER_11:
 	case RTL_VER_12:
 	case RTL_VER_14:
+	case RTL_VER_16:
 	...
 	case RTL_VER_13:
 	case RTL_VER_15:
@@ -5448,6 +5847,7 @@ static void rtl_eee_enable(struct r8152 *tp, bool enable)
 	case RTL_VER_12:
 	case RTL_VER_13:
 	case RTL_VER_15:
+	case RTL_VER_16:
...
@@ -6151,15 +6551,24 @@ static int rtl8156_enable(struct r8152 *tp)
...
@@ -6167,10 +6576,12 @@ static int rtl8156_enable(struct r8152 *tp)
 		ocp_data |= IDLE_SPDWN_EN;
...
@@ -6183,12 +6594,9 @@ static int rtl8156_enable(struct r8152 *tp)
...
@@ -6201,54 +6609,6 @@ static void rtl8156_disable(struct r8152 *tp)
 	rtl8153_disable(tp);
 }
...
-
 static int rtl8152_set_speed(struct r8152 *tp, u8 autoneg, u32 speed, u8 duplex,
 			     u32 advertising)
 {
@@ -6621,7 +6981,7 @@ static void rtl8156_change_mtu(struct r8152 *tp)
...
@@ -6632,26 +6992,24 @@ static void rtl8156_up(struct r8152 *tp)
 		return;
...
@@ -6661,9 +7019,7 @@ static void rtl8156_up(struct r8152 *tp)
 	case RTL_TEST_01:
 	case RTL_VER_10:
 	case RTL_VER_11:
...
+		ocp_word_set_bits(tp, MCU_TYPE_USB, USB_BMU_CONFIG, ACT_ODMA);
 	...
 	default:
 		break;
@@ -6675,13 +7031,11 @@ static void rtl8156_up(struct r8152 *tp)
 	ocp_data |= 0x08;
...
@@ -6693,7 +7047,7 @@ static void rtl8156_up(struct r8152 *tp)
...
@@ -6706,13 +7060,13 @@ static void rtl8156_down(struct r8152 *tp)
 		return;
 	}
...
+	}
 	...
 	ocp_data = ocp_read_byte(tp, MCU_TYPE_PLA, PLA_OOB_CTRL);
@@ -6736,13 +7090,9 @@ static void rtl8156_down(struct r8152 *tp)
 	 */
...
@@ -8147,42 +8497,30 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
...
@@ -8191,59 +8529,180 @@ static void r8156_init(struct r8152 *tp)
...
+	case RTL_VER_16:
 		...
 		break;
 	default:
@@ -8289,13 +8750,9 @@ static void r8156b_init(struct r8152 *tp)
...
+			ocp_reg_clr_bits(tp, 0xa466, BIT(0));
 	...
 	data = r8152_mdio_read(tp, MII_BMCR);
@@ -8306,7 +8763,10 @@ static void r8156b_init(struct r8152 *tp)
...
+		r8153_u2p3en(tp, false);
 	...
 	/* MSC timer = 0xfff * 8ms = 32760 ms */
 	ocp_write_word(tp, MCU_TYPE_USB, USB_MSC_TIMER, 0x0fff);
@@ -8314,7 +8774,11 @@ static void r8156b_init(struct r8152 *tp)
 	/* U1/U2/L1 idle timer. 500 us */
 	ocp_write_word(tp, MCU_TYPE_USB, USB_U1U2_TIMER, 500);
...
+
 	...
 	r8153_queue_wake(tp, false);
 	rtl_runtime_suspend_enable(tp, false);
@@ -8324,33 +8788,27 @@ static void r8156b_init(struct r8152 *tp)
...
+		ocp_word_clr_bits(tp, MCU_TYPE_PLA, PLA_MAC_PWR_CTRL3, PLA_MCU_SPDWN_EN);
 	...
 	ocp_data = ocp_read_word(tp, MCU_TYPE_PLA, PLA_EXTRA_STATUS);
 	if (rtl8152_get_speed(tp) & LINK_STATUS)
@@ -8362,10 +8820,21 @@ static void r8156b_init(struct r8152 *tp)
...
+	}
 	...
 	r8156_mdio_force_mode(tp);
 	rtl_tally_reset(tp);
@@ -9518,6 +9987,38 @@ static void rtl8153b_unload(struct r8152 *tp)
 	r8153b_power_cut_en(tp, false);
 }
...
@@ -9541,6 +10042,7 @@ static int rtl_ops_init(struct r8152 *tp)
...
+		r8152_desc_init(tp);
 	...
 	case RTL_VER_03:
@@ -9565,6 +10067,7 @@ static int rtl_ops_init(struct r8152 *tp)
...
+		r8152_desc_init(tp);
 	...
 	case RTL_VER_08:
@@ -9584,6 +10087,7 @@ static int rtl_ops_init(struct r8152 *tp)
 		tp->rx_buf_sz		= 32 * 1024;
 		tp->eee_en		= true;
 		tp->eee_adv		= MDIO_EEE_1000T | MDIO_EEE_100TX;
+		r8152_desc_init(tp);
 	...
 	case RTL_VER_11:
@@ -9606,6 +10110,7 @@ static int rtl_ops_init(struct r8152 *tp)
...
+		r8152_desc_init(tp);
 	...
 	case RTL_VER_12:
@@ -9616,8 +10121,8 @@ static int rtl_ops_init(struct r8152 *tp)
 		tp->eee_en		= true;
 		tp->eee_adv		= MDIO_EEE_1000T | MDIO_EEE_100TX;
...
@@ -9629,6 +10134,7 @@ static int rtl_ops_init(struct r8152 *tp)
...
+		r8152_desc_init(tp);
 	...
 	case RTL_VER_14:
@@ -9647,6 +10153,29 @@ static int rtl_ops_init(struct r8152 *tp)
 		tp->rx_buf_sz		= 32 * 1024;
 		tp->eee_en		= true;
 		tp->eee_adv		= MDIO_EEE_1000T | MDIO_EEE_100TX;
+		r8152_desc_init(tp);
...
+		r8157_desc_init(tp);
 	...
 	default:
@@ -9799,6 +10328,9 @@ static u8 __rtl_get_hw_ver(struct usb_device *udev)
 	case 0x7420:
 		version = RTL_VER_15;
 		break;
+	case 0x1030:
...
@@ -9950,6 +10482,7 @@ static int rtl8152_probe_once(struct usb_interface *intf,
 	case RTL_VER_12:
 	case RTL_VER_13:
 	case RTL_VER_15:
+	case RTL_VER_16:
 		...
 		break;
 	case RTL_VER_01:
@@ -10109,6 +10642,7 @@ static const struct usb_device_id rtl8152_table[] = {
