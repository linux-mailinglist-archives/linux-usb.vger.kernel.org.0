...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9DFD25205BD
	for <lists+linux-usb@lfdr.de>; Mon,  9 May 2022 22:21:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229517AbiEIUYt (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Mon, 9 May 2022 16:24:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45982 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229506AbiEIUYg (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Mon, 9 May 2022 16:24:36 -0400
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E517B24DC54
        for <linux-usb@vger.kernel.org>; Mon,  9 May 2022 13:07:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1652126865; x=1683662865;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references;
  bh=8sUGiurltVTq0HdRABZFj9yHLZqPktX1gG5oUpcVSz0=;
  b=Xuuj93uXs1KjU4gb+aY+hM4s0i6og8aNq5dNgj/Ufo8WxXokvqZsqvsO
   o5tLlnLInGE+TMhx5TuKzsmwJnykNirHRDjryy7fLz+A/Z1xpjKVY4czu
   gqPNBpDZ57xgQZs3Hgka0yuEPElIpqfo0nmriYO4rkIM/zpUVoreiFlLu
   xeoxE6sA2VfZKlL7wGoyg9UZZHlMld8jfvPfjNcml10+6rHrUSqGZYuH/
   ZZnllzFJDGQbiXW3RAuPSkRpuwVg63MxVzdjKDQkA8K4N0Tba8CBXnWzH
   5ONV0nDU3RW3WF4mhEHhWvZYHnNVz56QRdfIDJKSTKsMVxZ1doNU/A01X
   w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10342"; a="249692951"
X-IronPort-AV: E=Sophos;i="5.91,212,1647327600"; 
   d="scan'208";a="249692951"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 May 2022 13:07:45 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.91,212,1647327600"; 
   d="scan'208";a="710688906"
Received: from ccdjpclinux26.jer.intel.com ([10.12.48.253])
  by fmsmga001.fm.intel.com with ESMTP; 09 May 2022 13:07:43 -0700
From:   Gil Fine <gil.fine@intel.com>
To:     andreas.noever@gmail.com, michael.jamet@intel.com,
        mika.westerberg@linux.intel.com, YehezkelShB@gmail.com
Cc:     gil.fine@intel.com, linux-usb@vger.kernel.org, lukas@wunner.de
Subject: [PATCH 5/6] thunderbolt: Add CL1 support for USB4 and Titan Ridge routers
Date:   Mon,  9 May 2022 23:16:55 +0300
Message-Id: <20220509201656.502-6-gil.fine@intel.com>
...
index 7419cd1aefba..4f74789dd1be 100644
...
@@ -1461,10 +1477,14 @@ static void tb_restore_children(struct tb_switch *sw)
 	if (sw->is_unplugged)
 		return;
