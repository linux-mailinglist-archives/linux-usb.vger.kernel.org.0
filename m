Return-Path: <linux-usb+bounces-35407-lists+linux-usb=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-usb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mMu1BHjbwmm0mwQAu9opvQ
	(envelope-from <linux-usb+bounces-35407-lists+linux-usb=lfdr.de@vger.kernel.org>)
	for <lists+linux-usb@lfdr.de>; Tue, 24 Mar 2026 19:44:08 +0100
X-Original-To: lists+linux-usb@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D87031AFF5
	for <lists+linux-usb@lfdr.de>; Tue, 24 Mar 2026 19:44:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 8C8C230B1C4B
	for <lists+linux-usb@lfdr.de>; Tue, 24 Mar 2026 18:38:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AD24A3A545B;
	Tue, 24 Mar 2026 18:38:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b="EoZ0/YdJ";
	dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b="VjlYHQkn"
X-Original-To: linux-usb@vger.kernel.org
Received: from bkemail.birger-koblitz.de (bkemail.birger-koblitz.de [23.88.97.239])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CCE2F3A4F35;
	Tue, 24 Mar 2026 18:38:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=23.88.97.239
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1774377489; cv=none; b=h/vWPmKOG+dQnhoBR6y5zfET45CWqsF7kktJl+JZpp/yt6wwokbkG3t2SW50P8XNSJgmqgLzrfz4HeJRDiEjbo5lAzaqDRvHKwZVy0R0245mBngn1a3WzL2WQCw+xsJy4FQ5Dc4GtbMwdSs8XOBYSNzpB5BzWhV3LRw9Kph0Ono=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1774377489; c=relaxed/simple;
	bh=tBdooYnzRCZYZewRQEc67ta/e+7syFjEqOQDjazQmLs=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=NVzbxNhQdJvAt9fHN4Sdn/IbLurvBcM2+Jybrjy8tzXGwvTx5bnhoF9CaMe3p6iLfm6+XnePIWpKHC6QgsQ9RZpSq/UNYhZiUYTFznMBt2cx/04t5/tP1zk1Cyukaqi4loF5bPxFOELuBp/RfAYybzdQeEGlga72hkD8nFu++rU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=birger-koblitz.de; spf=pass smtp.mailfrom=birger-koblitz.de; dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b=EoZ0/YdJ; dkim=pass (2048-bit key) header.d=birger-koblitz.de header.i=@birger-koblitz.de header.b=VjlYHQkn; arc=none smtp.client-ip=23.88.97.239
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=birger-koblitz.de
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=birger-koblitz.de
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=birger-koblitz.de;
	s=default; t=1774377484;
	bh=tBdooYnzRCZYZewRQEc67ta/e+7syFjEqOQDjazQmLs=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
	b=
Received: by bkemail.birger-koblitz.de (Postfix, from userid 109)
	id 64C2D40072; Tue, 24 Mar 2026 18:38:04 +0000 (UTC)
X-Spam-Level: 
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=birger-koblitz.de;
	s=default; t=1774377478;
	bh=tBdooYnzRCZYZewRQEc67ta/e+7syFjEqOQDjazQmLs=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
	b=
Received: from AMDDesktop.lan (unknown [IPv6:2a00:6020:47a3:e800:271c:c6c5:9fde:77cb])
	by bkemail.birger-koblitz.de (Postfix) with ESMTPSA id E5B5A4006E;
	Tue, 24 Mar 2026 18:37:57 +0000 (UTC)
From: Birger Koblitz <mail@birger-koblitz.de>
Date: Tue, 24 Mar 2026 19:37:56 +0100
Subject: [PATCH net-next v4 2/2] r8152: Add support for the RTL8157
 hardware
Precedence: bulk
...
Message-Id: <20260324-rtl8157_next-v4-2-034312b12de5@birger-koblitz.de>
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-35407-lists,linux-usb=lfdr.de];
	FROM_HAS_DN(0.00)[];
...
---
 drivers/net/usb/r8152.c | 1027 ++++++++++++++++++++++++++++++++++++-----------
 1 file changed, 783 insertions(+), 244 deletions(-)

diff --git a/drivers/net/usb/r8152.c b/drivers/net/usb/r8152.c
index bab8e10e5f99afcb332e333c2739ed7509b03419..010126e6dae4bb435791a3b6312c2680a696a0ac 100644
...
+	else if ((skb->len + tp->tx_desc.size) > agg_buf_sz)
 	...
 	return features;
@@ -3020,7 +3386,7 @@ static void rtl8152_nic_reset(struct r8152 *tp)
...
@@ -3242,6 +3608,7 @@ static void r8153_set_rx_early_timeout(struct r8152 *tp)
 	case RTL_VER_12:
 	case RTL_VER_13:
 	case RTL_VER_15:
+	case RTL_VER_16:
...
@@ -3253,9 +3620,14 @@ static void r8153_set_rx_early_timeout(struct r8152 *tp)
 	}
 }
...
+	u32 ocp_data = tp->rx_buf_sz - rx_reserved_size(tp, tp->netdev->mtu);
 	...
 	switch (tp->version) {
 	case RTL_VER_03:
@@ -3280,6 +3652,10 @@ static void r8153_set_rx_early_size(struct r8152 *tp)
...
+		break;
 	default:
 		WARN_ON_ONCE(1);
 		break;
@@ -3405,6 +3781,7 @@ static void rtl_rx_vlan_en(struct r8152 *tp, bool enable)
 	case RTL_VER_12:
 	case RTL_VER_13:
 	case RTL_VER_15:
+	case RTL_VER_16:
 	default:
 		...
 		if (enable)
@@ -3577,6 +3954,14 @@ static void r8153_u2p3en(struct r8152 *tp, bool enable)
...
+
 ...
 {
 	u32 ups_flags = 0;
@@ -3930,9 +4315,7 @@ static void r8153_power_cut_en(struct r8152 *tp, bool enable)
...
@@ -3946,9 +4329,19 @@ static void r8153b_power_cut_en(struct r8152 *tp, bool enable)
 		ocp_data &= ~PWR_EN;
 	ocp_write_word(tp, MCU_TYPE_USB, USB_POWER_CUT, ocp_data);
...
+
 ...
 {
 	u32 ocp_data;
@@ -4107,6 +4508,7 @@ static void r8153_teredo_off(struct r8152 *tp)
 	case RTL_VER_13:
 	case RTL_VER_14:
 	case RTL_VER_15:
+	case RTL_VER_16:
...
@@ -4163,6 +4565,7 @@ static void rtl_clear_bp(struct r8152 *tp, u16 type)
 		bp_num = 8;
 		break;
 	case RTL_VER_14:
+	case RTL_VER_16:
 	default:
 		...
 		bp_num = 16;
@@ -4278,6 +4681,7 @@ static bool rtl8152_is_fw_phy_speed_up_ok(struct r8152 *tp, struct fw_phy_speed_
 	case RTL_VER_11:
 	case RTL_VER_12:
 	case RTL_VER_14:
+	case RTL_VER_16:
 	...
 	case RTL_VER_13:
 	case RTL_VER_15:
@@ -5448,6 +5852,7 @@ static void rtl_eee_enable(struct r8152 *tp, bool enable)
 	case RTL_VER_12:
 	case RTL_VER_13:
 	case RTL_VER_15:
+	case RTL_VER_16:
...
@@ -6151,15 +6556,24 @@ static int rtl8156_enable(struct r8152 *tp)
...
@@ -6167,10 +6581,12 @@ static int rtl8156_enable(struct r8152 *tp)
 		ocp_data |= IDLE_SPDWN_EN;
...
@@ -6183,12 +6599,9 @@ static int rtl8156_enable(struct r8152 *tp)
...
@@ -6201,54 +6614,6 @@ static void rtl8156_disable(struct r8152 *tp)
 	rtl8153_disable(tp);
 }
...
-
 static int rtl8152_set_speed(struct r8152 *tp, u8 autoneg, u32 speed, u8 duplex,
 			     u32 advertising)
 {
@@ -6621,7 +6986,7 @@ static void rtl8156_change_mtu(struct r8152 *tp)
...
@@ -6632,26 +6997,24 @@ static void rtl8156_up(struct r8152 *tp)
 		return;
...
@@ -6661,9 +7024,7 @@ static void rtl8156_up(struct r8152 *tp)
 	case RTL_TEST_01:
 	case RTL_VER_10:
 	case RTL_VER_11:
...
+		ocp_word_set_bits(tp, MCU_TYPE_USB, USB_BMU_CONFIG, ACT_ODMA);
 	...
 	default:
 		break;
@@ -6675,13 +7036,11 @@ static void rtl8156_up(struct r8152 *tp)
 	ocp_data |= 0x08;
...
+	}
 	...
 	ocp_data = ocp_read_byte(tp, MCU_TYPE_PLA, PLA_OOB_CTRL);
@@ -6736,13 +7095,9 @@ static void rtl8156_down(struct r8152 *tp)
 	 */
...
@@ -8147,42 +8502,30 @@ static void r8156b_hw_phy_cfg(struct r8152 *tp)
...
@@ -8191,59 +8534,180 @@ static void r8156_init(struct r8152 *tp)
...
+static void r8156_init(struct r8152 *tp)
 {
 	u32 ocp_data;
 	u16 data;
@@ -8252,25 +8716,27 @@ static void r8156b_init(struct r8152 *tp)
 	if (test_bit(RTL8152_INACCESSIBLE, &tp->flags))
 		return;
...
+	case RTL_VER_16:
 		...
 		break;
 	default:
@@ -8289,13 +8755,9 @@ static void r8156b_init(struct r8152 *tp)
...
+			ocp_reg_clr_bits(tp, 0xa466, BIT(0));
 	...
 	data = r8152_mdio_read(tp, MII_BMCR);
@@ -8306,7 +8768,10 @@ static void r8156b_init(struct r8152 *tp)
...
+		r8153_u2p3en(tp, false);
 	...
 	/* MSC timer = 0xfff * 8ms = 32760 ms */
 	ocp_write_word(tp, MCU_TYPE_USB, USB_MSC_TIMER, 0x0fff);
@@ -8314,7 +8779,11 @@ static void r8156b_init(struct r8152 *tp)
 	/* U1/U2/L1 idle timer. 500 us */
 	ocp_write_word(tp, MCU_TYPE_USB, USB_U1U2_TIMER, 500);
...
+
 	...
 	r8153_queue_wake(tp, false);
 	rtl_runtime_suspend_enable(tp, false);
@@ -8324,33 +8793,27 @@ static void r8156b_init(struct r8152 *tp)
...
+	}
 	...
 	r8156_mdio_force_mode(tp);
 	rtl_tally_reset(tp);
@@ -9518,6 +9992,38 @@ static void rtl8153b_unload(struct r8152 *tp)
 	r8153b_power_cut_en(tp, false);
 }
...
@@ -9541,6 +10047,7 @@ static int rtl_ops_init(struct r8152 *tp)
...
+		r8152_desc_init(tp);
 	...
 	case RTL_VER_03:
@@ -9565,6 +10072,7 @@ static int rtl_ops_init(struct r8152 *tp)
...
+		r8152_desc_init(tp);
 	...
 	case RTL_VER_08:
@@ -9584,6 +10092,7 @@ static int rtl_ops_init(struct r8152 *tp)
 		tp->rx_buf_sz		= 32 * 1024;
 		tp->eee_en		= true;
 		tp->eee_adv		= MDIO_EEE_1000T | MDIO_EEE_100TX;
+		r8152_desc_init(tp);
 	...
 	case RTL_VER_11:
@@ -9606,6 +10115,7 @@ static int rtl_ops_init(struct r8152 *tp)
...
+		r8152_desc_init(tp);
 	...
 	case RTL_VER_12:
@@ -9616,8 +10126,8 @@ static int rtl_ops_init(struct r8152 *tp)
 		tp->eee_en		= true;
 		tp->eee_adv		= MDIO_EEE_1000T | MDIO_EEE_100TX;
...
@@ -9629,6 +10139,7 @@ static int rtl_ops_init(struct r8152 *tp)
...
+		r8157_desc_init(tp);
 	...
 	default:
@@ -9799,6 +10333,9 @@ static u8 __rtl_get_hw_ver(struct usb_device *udev)
 	case 0x7420:
 		version = RTL_VER_15;
 		break;
+	case 0x1030:
...
@@ -9950,6 +10487,7 @@ static int rtl8152_probe_once(struct usb_interface *intf,
 	case RTL_VER_12:
 	case RTL_VER_13:
 	case RTL_VER_15:
+	case RTL_VER_16:
 		...
 		break;
 	case RTL_VER_01:
@@ -10109,6 +10647,7 @@ static const struct usb_device_id rtl8152_table[] = {
