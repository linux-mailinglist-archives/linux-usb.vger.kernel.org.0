...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id DA0FCE18DD
	for <lists+linux-usb@lfdr.de>; Wed, 23 Oct 2019 13:24:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2404966AbfJWLWg (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Wed, 23 Oct 2019 07:22:36 -0400
Received: from mga14.intel.com ([192.55.52.115]:29707 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2404891AbfJWLWJ (ORCPT <rfc822;linux-usb@vger.kernel.org>);
        Wed, 23 Oct 2019 07:22:09 -0400
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga103.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 23 Oct 2019 04:22:08 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.68,220,1569308400"; 
   d="scan'208";a="191800598"
Received: from black.fi.intel.com ([10.237.72.28])
  by orsmga008.jf.intel.com with ESMTP; 23 Oct 2019 04:22:04 -0700
Received: by black.fi.intel.com (Postfix, from userid 1001)
        id 0D6F67AF; Wed, 23 Oct 2019 14:21:56 +0300 (EEST)
...
Subject: [PATCH 24/25] thunderbolt: Add support for USB 3.x tunnels
Date:   Wed, 23 Oct 2019 14:21:53 +0300
Message-Id: <20191023112154.64235-25-mika.westerberg@linux.intel.com>
...
index 6a39e71bd682..3215f48902bf 100644
...
index 4b52b7d3eef7..2931f5c972c2 100644
...
-
 static struct tb_port *tb_find_pcie_down(struct tb_switch *sw,
 					 const struct tb_port *port)
 {
@@ -885,6 +986,11 @@ static int tb_start(struct tb *tb)
...
index 21d266a76b7d..18a9d9b08793 100644
...
index 65c989f11184..dd246835187d 100644
...
@@ -702,6 +711,37 @@ struct tb_port *usb4_switch_map_pcie_down(struct tb_switch *sw,
 	return NULL;
 }
