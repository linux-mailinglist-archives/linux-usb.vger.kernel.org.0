...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2099B720261
	for <lists+linux-usb@lfdr.de>; Fri,  2 Jun 2023 14:47:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234294AbjFBMrA (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Fri, 2 Jun 2023 08:47:00 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46510 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235687AbjFBMqx (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Fri, 2 Jun 2023 08:46:53 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C69B41A8;
        Fri,  2 Jun 2023 05:46:49 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 2C5D865009;
        Fri,  2 Jun 2023 12:46:49 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 45EE4C4339B;
        Fri,  2 Jun 2023 12:46:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1685710008;
        bh=DLwXq+7pQ7yZ0OAr8L3ueNBu2fKEjxSKnV84XqdOJ7Q=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
Received: from johan by xi.lan with local (Exim 4.94.2)
        (envelope-from <johan@kernel.org>)
        id 1q54BG-0004xz-0R; Fri, 02 Jun 2023 14:46:58 +0200
From:   Johan Hovold <johan@kernel.org>
To:     Johan Hovold <johan@kernel.org>
Cc:     Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        linux-usb@vger.kernel.org, linux-kernel@vger.kernel.org,
        Corey Minyard <minyard@acm.org>
Subject: [PATCH 1/3] USB: serial: return errors from break handling
Date:   Fri,  2 Jun 2023 14:46:40 +0200
Message-Id: <20230602124642.19076-2-johan@kernel.org>
...
---
 ...
 25 files changed, 139 insertions(+), 71 deletions(-)
...
index 3a4c0febf335..977468d2ab26 100644
--- a/drivers/usb/serial/io_edgeport.c
+++ b/drivers/usb/serial/io_edgeport.c
@@ -1560,7 +1560,7 @@ static int edge_ioctl(struct tty_struct *tty,
  * SerialBreak
