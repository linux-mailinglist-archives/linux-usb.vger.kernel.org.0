Return-Path: <linux-usb+bounces-15648-lists+linux-usb=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-usb@lfdr.de
Delivered-To: lists+linux-usb@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BF34098D5DA
	for <lists+linux-usb@lfdr.de>; Wed,  2 Oct 2024 15:34:37 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id CC8ED1C221F6
	for <lists+linux-usb@lfdr.de>; Wed,  2 Oct 2024 13:34:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2CF811D079C;
	Wed,  2 Oct 2024 13:34:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=suse.cz header.i=@suse.cz header.b="zsB0beuD";
	dkim=permerror (0-bit key) header.d=suse.cz header.i=@suse.cz header.b="hQoUygPb";
	dkim=pass (1024-bit key) header.d=suse.cz header.i=@suse.cz header.b="b4cguX8s";
	dkim=permerror (0-bit key) header.d=suse.cz header.i=@suse.cz header.b="shMfGt0+"
X-Original-To: linux-usb@vger.kernel.org
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.223.130])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DE0261D016B;
	Wed,  2 Oct 2024 13:34:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.135.223.130
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1727876053; cv=none; b=kq15zWgH2yLAK/rulFNfdjSgh0SIpMpL39dHCyv2jdlB3QmhTQ+pvjjxPqK1fzkxBDLqK9HqT6CJsqU5bbhaVZta6RBvBwk7HNt5kxk2P+3CopchCK4BJX9XWXojay0Ebs4ysSG3WV1fgponhfUAbQDViESPd4QOwoBP3faSjn0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1727876053; c=relaxed/simple;
	bh=hZggemGHvaDLFSgq2AZIcXsog1Xqli0kbd2u2KxLFTA=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=fw1l/JhrvhYzNA2dbW7f+GskrUVGLxLmeLkzEriHaFQ7ik5Ph246aU71MM0CY31HlTmnImMxjXd77E88GCTL9DUJdOYiIXzlA/Uroc7RzYeYkzYldqHJisS+9IIQlWDwkVC+dd/95FmNMC78Wb1JJmjWq0/NhinOQu5tJ+CfQm0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=suse.cz; spf=pass smtp.mailfrom=suse.cz; dkim=pass (1024-bit key) header.d=suse.cz header.i=@suse.cz header.b=zsB0beuD; dkim=permerror (0-bit key) header.d=suse.cz header.i=@suse.cz header.b=hQoUygPb; dkim=pass (1024-bit key) header.d=suse.cz header.i=@suse.cz header.b=b4cguX8s; dkim=permerror (0-bit key) header.d=suse.cz header.i=@suse.cz header.b=shMfGt0+; arc=none smtp.client-ip=195.135.223.130
...
Received: from imap1.dmz-prg2.suse.org (imap1.dmz-prg2.suse.org [IPv6:2a07:de40:b281:104:10:150:64:97])
	...
	(No client certificate requested)
	by smtp-out1.suse.de (Postfix) with ESMTPS id D52E7219B9;
	Wed,  2 Oct 2024 13:34:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.cz; s=susede2_rsa;
	t=1727876047; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
	 mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=urBoWHR3d/7wcIZuLytevoMSfjIZI8CppmHuMssdbx0=;
	b=zsB0beuDmL7hiUMzMynxbgWF9wuBRLyyvVsSWa3C1AFFiTUGmiok/qglUSpJJO2XNPl8d+
	XIcjaMZd1GJ1EjGmeD5mCMPZ8JEUpl4oxOWBU1K/gnL+h7zQwtrHJ4So5Urg3FDJ34suCf
	jplBTSnj7gPq/UQYmVrgDqPwYP7/9WQ=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.cz;
	s=susede2_ed25519; t=1727876047;
	h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
	 mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=urBoWHR3d/7wcIZuLytevoMSfjIZI8CppmHuMssdbx0=;
	b=hQoUygPbXLWSV+M5I3W7ckQHj2Oo4JGtgYa5PrTjLzbFKheecWAYeMToOtcPLlYbQDc/Bf
	mtFHN7P661fdb7AA==
Authentication-Results: smtp-out1.suse.de;
	dkim=pass header.d=suse.cz header.s=susede2_rsa header.b=b4cguX8s;
	dkim=pass header.d=suse.cz header.s=susede2_ed25519 header.b=shMfGt0+
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.cz; s=susede2_rsa;
	t=1727876046; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
	 mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=urBoWHR3d/7wcIZuLytevoMSfjIZI8CppmHuMssdbx0=;
	b=b4cguX8sBZnivYc9uTo6aLFMfoH7OJ4+dJ56SXnwXoBjNtHmuQdLp82YawH/JUqPqYnoam
	jljMKw+s48nnXKzYRwo+4nHFvEoWap+JJlGf/ZNowDf13XNLtA5CDoV8z9FrXSf2Rxb2cP
	/2iP0RIy1fe4L8WdT0qnRzdVkGMQaP8=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.cz;
	s=susede2_ed25519; t=1727876046;
	h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
	 mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=urBoWHR3d/7wcIZuLytevoMSfjIZI8CppmHuMssdbx0=;
	b=shMfGt0+n2Xi+17E9k7jVPL31C6pqeHzey5TB6WFWcN6MrVLkcyKgd1XJwBQdao1Ii3f1p
	2rghdHfHAe7+TECQ==
Received: from imap1.dmz-prg2.suse.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by imap1.dmz-prg2.suse.org (Postfix) with ESMTPS id B917213974;
	Wed,  2 Oct 2024 13:34:06 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
	by imap1.dmz-prg2.suse.org with ESMTPSA
	id WCgmLc5L/WZ+HwAAD6G6ig
	(envelope-from <jack@suse.cz>); Wed, 02 Oct 2024 13:34:06 +0000
Received: by quack3.suse.cz (Postfix, from userid 1000)
	id 5FBA3A08CB; Wed,  2 Oct 2024 15:34:06 +0200 (CEST)
Date: Wed, 2 Oct 2024 15:34:06 +0200
From: Jan Kara <jack@suse.cz>
To: syzbot <syzbot+6dca7953fd4bbdf92f5d@syzkaller.appspotmail.com>
Cc: brauner@kernel.org, jack@suse.cz, linux-fsdevel@vger.kernel.org,
	linux-kernel@vger.kernel.org, linux-usb@vger.kernel.org,
	syzkaller-bugs@googlegroups.com, viro@zeniv.linux.org.uk,
	linux-input@vger.kernel.org
Subject: Re: [syzbot] [fs?] INFO: rcu detected stall in sys_utimensat (3)
Message-ID: <20241002133406.ggtvrs7jz5iq5kmh@quack3>
References: <66fcbf3d.050a0220.f28ec.04e9.GAE@google.com>
Precedence: bulk
...
In-Reply-To: <66fcbf3d.050a0220.f28ec.04e9.GAE@google.com>
X-Rspamd-Queue-Id: D52E7219B9
X-Spam-Score: -1.51
X-Rspamd-Action: no action
X-Spamd-Result: default: False [-1.51 / 50.00];
	BAYES_HAM(-3.00)[100.00%];
	SUSPICIOUS_RECIPS(1.50)[];
	URI_HIDDEN_PATH(1.00)[https://syzkaller.appspot.com/x/.config?x=3d9e1c0225f14ccc];
	...
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[storage.googleapis.com:url,imap1.dmz-prg2.suse.org:rdns,imap1.dmz-prg2.suse.org:helo,suse.com:email,suse.cz:dkim];
	...
	TAGGED_RCPT(0.00)[6dca7953fd4bbdf92f5d];
...
On Tue 01-10-24 20:34:21, syzbot wrote:
> Hello,
> 
...
Seems more like a usb/hid issue to me. Filesystem code was just where the
interrupt causing issues hit. So:
