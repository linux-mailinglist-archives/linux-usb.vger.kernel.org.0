...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EDB8CD7879
	for <lists+linux-usb@lfdr.de>; Tue, 15 Oct 2019 16:28:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732738AbfJOO2P (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Tue, 15 Oct 2019 10:28:15 -0400
Received: from relay2-d.mail.gandi.net ([217.70.183.194]:55621 "EHLO
        relay2-d.mail.gandi.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1732641AbfJOO2P (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Tue, 15 Oct 2019 10:28:15 -0400
X-Originating-IP: 83.155.44.161
Received: from classic (mon69-7-83-155-44-161.fbx.proxad.net [83.155.44.161])
        (Authenticated sender: hadess@hadess.net)
        by relay2-d.mail.gandi.net (Postfix) with ESMTPSA id 14D5C40002;
        Tue, 15 Oct 2019 14:28:11 +0000 (UTC)
Message-ID: <2fe7b917620fe7c2dfa2745dd841fe252f0ff3d5.camel@hadess.net>
Subject: [PATCH v2 6/6] USB: Add driver to control USB fast charge for iOS
 devices
From:   Bastien Nocera <hadess@hadess.net>
To:     Alan Stern <stern@rowland.harvard.edu>, linux-usb@vger.kernel.org,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        Benjamin Tissoires <benjamin.tissoires@redhat.com>
Date:   Tue, 15 Oct 2019 16:28:11 +0200
...
USB_RECIP_DEVICE;
+	retval = usb_control_msg(mfi->udev, usb_sndctrlpipe(mfi->udev,
0),
...
+}
+
+static int apple_mfi_fc_property_is_writeable(struct power_supply
*psy,
+					      enum
