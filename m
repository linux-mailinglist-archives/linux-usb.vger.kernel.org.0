...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 96305699256
	for <lists+linux-usb@lfdr.de>; Thu, 16 Feb 2023 11:55:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230333AbjBPKz2 (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Thu, 16 Feb 2023 05:55:28 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47098 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230132AbjBPKz0 (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Thu, 16 Feb 2023 05:55:26 -0500
Received: from mx0a-0014ca01.pphosted.com (mx0b-0014ca01.pphosted.com [208.86.201.193])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A1B4D5648D;
        Thu, 16 Feb 2023 02:55:12 -0800 (PST)
Received: from pps.filterd (m0042333.ppops.net [127.0.0.1])
        by mx0b-0014ca01.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 31G9q59H009705;
        Thu, 16 Feb 2023 02:54:38 -0800
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cadence.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=proofpoint;
 bh=DuYCMIk4VzSu2k5zwJ/ldd6ydfTCZcfcG5smyUVPUYc=;
 b= /A== 
Received: from nam02-dm3-obe.outbound.protection.outlook.com (mail-dm3nam02lp2041.outbound.protection.outlook.com [104.47.56.41])
        by mx0b-0014ca01.pphosted.com (PPS) with ESMTPS id 3np7g6er6x-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Thu, 16 Feb 2023 02:54:37 -0800
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=DuYCMIk4VzSu2k5zwJ/ldd6ydfTCZcfcG5smyUVPUYc=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cadence.com;
 ...
 bh=DuYCMIk4VzSu2k5zwJ/ldd6ydfTCZcfcG5smyUVPUYc=;
 b=w4pIkqdqXYJqgUyyWXksIn6ZZnh+Neo3YiCph1uFNU5LPmqkanejz4+IeAmVXG4CWceG/vIKFWRT9+HQhKDAtM/NNBk/zVIs0HwxGEpRtyTg5k7FSd7TyuwttGZDh0dmJCricp/rPxgDSHNaWam6w/k/hxygMXvjJnAVkIE9vCM=
Received: from DM5PR07CA0076.namprd07.prod.outlook.com (2603:10b6:4:ad::41) by
 DM4PR07MB9809.namprd07.prod.outlook.com (2603:10b6:8:17f::8) with Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.6086.24; Thu, 16 Feb 2023 10:54:31 +0000
Received: from DM6NAM12FT056.eop-nam12.prod.protection.outlook.com
 (2603:10b6:4:ad:cafe::c6) by DM5PR07CA0076.outlook.office365.com
...
Received: from maileu5.global.cadence.com (eudvw-maileu5.cadence.com [10.160.110.202])
        by sjmaillnx2.cadence.com (8.14.4/8.14.4) with ESMTP id 31GAsRhq021871
...
Received: from eu-cn02.cadence.com (localhost.localdomain [127.0.0.1])
        by eu-cn02.cadence.com (8.14.7/8.14.7) with ESMTP id 31GAsQdH364449;
        Thu, 16 Feb 2023 05:54:26 -0500
Received: (from pawell@localhost)
        by eu-cn02.cadence.com (8.14.7/8.14.7/Submit) id 31GAsQ3o364448;
        Thu, 16 Feb 2023 05:54:26 -0500
...
Subject: [PATCH 2/4] usb: cdns2: Add main part of Cadence USBHS driver
Date:   Thu, 16 Feb 2023 05:54:09 -0500
Message-ID: <20230216105411.364157-3-pawell@cadence.com>
...
X-MS-TrafficTypeDiagnostic: DM6NAM12FT056:EE_|DM4PR07MB9809:EE_
X-MS-Office365-Filtering-Correlation-Id: 892edad7-984a-42a2-5d21-08db100c2eda
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:158.140.1.148;CTRY:US;LANG:en;SCL:1;SRV:;IPV:CAL;SFV:NSPM;H:sjmaillnx2.cadence.com;PTR:unknown.Cadence.COM;CAT:NONE;SFS:(13230025)(4636009)(346002)(376002)(396003)(39860400002)(136003)(36092001)(451199018)(36840700001)(40470700004)(46966006)(47076005)(36756003)(336012)(6666004)(426003)(2616005)(83380400001)(86362001)(107886003)(186003)(26005)(82310400005)(1076003)(478600001)(54906003)(40480700001)(36860700001)(316002)(42186006)(4326008)(70206006)(40460700003)(41300700001)(8676002)(70586007)(6916009)(8936002)(7416002)(7636003)(5660300002)(30864003)(82740400003)(2906002)(356005)(579004)(559001)(309714004)(473944003)(414714003);DIR:OUT;SFP:1101;
X-OriginatorOrg: cadence.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 16 Feb 2023 10:54:31.3834
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 892edad7-984a-42a2-5d21-08db100c2eda
...
X-MS-Exchange-Transport-CrossTenantHeadersStamped: DM4PR07MB9809
X-Proofpoint-GUID: rSIHso4F9SJ75X0JI3r9Y6iswBpYLhv2
X-Proofpoint-ORIG-GUID: rSIHso4F9SJ75X0JI3r9Y6iswBpYLhv2
...
X-Proofpoint-Spam-Details: rule=outbound_check_notspam policy=outbound_check score=0
 ...
 mlxscore=0 lowpriorityscore=0 mlxlogscore=999 phishscore=0 malwarescore=0
...
---
 ...
 drivers/usb/gadget/udc/cdns2/cdns2-ep0.c    |  640 +++++
 drivers/usb/gadget/udc/cdns2/cdns2-gadget.c | 2312 +++++++++++++++++++
 drivers/usb/gadget/udc/cdns2/cdns2-pci.c    |  151 ++
 7 files changed, 3122 insertions(+)
...
new file mode 100644
index 000000000000..a8b606eed533
--- /dev/null
...
new file mode 100644
index 000000000000..c1d5d2eab207
--- /dev/null
...
+	 * enabling endpoint.
+	 */
+	if (pep->ep_state & EP_UPDATE_EP_TRBADDR) {
+		/*
+		 * Until SW is not ready to handle the OUT transfer the ISO OUT
+		 * Endpoint should be disabled (DMA_EP_CFG.ENABLE = 0).
+		 * DMA_EP_CFG_ENABLE must be set before updating ep_traddr.
+		 */
...
+		}
+
+		writel(ring->dma + preq->start_trb * TRB_SIZE,
+		       &pdev->adma_regs->ep_traddr);
+
+		pep->ep_state &= ~EP_UPDATE_EP_TRBADDR;
+	}
+
...
+	writel(ep_sts_reg, &pdev->adma_regs->ep_sts);
+
+	if (ep_sts_reg & DMA_EP_STS_TRBERR) {
...
+	pdev = pep->pdev;
+	comp_desc = pep->endpoint.comp_desc;
+
...
new file mode 100644
index 000000000000..e32e910a21af
--- /dev/null
