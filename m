...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 30EFE6320CC
	for <lists+linux-usb@lfdr.de>; Mon, 21 Nov 2022 12:37:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231163AbiKULhh (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Mon, 21 Nov 2022 06:37:37 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34942 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231499AbiKULhK (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Mon, 21 Nov 2022 06:37:10 -0500
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4F2B613DFD
        for <linux-usb@vger.kernel.org>; Mon, 21 Nov 2022 03:34:22 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1669030462; x=1700566462;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=0P9sAi/mWglxrS7g6SLkJzDBROxc3xDB1PNnsGQmvUU=;
  b=AJarHsBIKPaDzAhsEhMKQD2LdfeOs/7m6mU4VCOfe0WDiaEKQWg/buaS
   6CLWvKnt0HCJ7ZVI7ri46RK2BfyZIbnIXAtTR32nYmQAQrbAqLwTcAsYq
   ooX3N8Pu1tYsudnCFErEqYeq6av+K8b5gw61GNYWY23qIevTOdPBGqmod
   /eR27Fnz0D31qq5U3gqiNqvcGvlh0Oa4zttn5Qx8bauQkDkhFfvh3QWKX
   8njQ31QqcCzUP8J6Fszf8AUGzu0bElbo2zdzpurYMxS8UcRcjtuibCX1K
   Dlt7Jc9A3D1dEhc+qnL+VQgfxQDpnLcyrZUAoXC2LMqug9eXP8YAxEw4U
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10537"; a="340394740"
X-IronPort-AV: E=Sophos;i="5.96,181,1665471600"; 
   d="scan'208";a="340394740"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Nov 2022 03:34:21 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10537"; a="729977953"
X-IronPort-AV: E=Sophos;i="5.96,181,1665471600"; 
   d="scan'208";a="729977953"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by FMSMGA003.fm.intel.com with ESMTP; 21 Nov 2022 03:34:18 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ox545-0000P1-26;
        Mon, 21 Nov 2022 11:34:17 +0000
Date:   Mon, 21 Nov 2022 19:33:29 +0800
...
Subject: Re: [PATCH v2 5/9] usb: gadget: uvc: Support arbitrary string
 descriptors
Message-ID: <202211211952.PteOhFAh-lkp@intel.com>
References: <20221121092517.225242-6-dan.scally@ideasonboard.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="LrL0TIbLXM6alTRR"
...
[also build test WARNING on usb/usb-next usb/usb-linus westeri-thunderbolt/next linus/master v6.1-rc6 next-20221118]
...
patch link:    https://lore.kernel.org/r/20221121092517.225242-6-dan.scally%40ideasonboard.com
patch subject: [PATCH v2 5/9] usb: gadget: uvc: Support arbitrary string descriptors
config: m68k-allyesconfig
compiler: m68k-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/8356f287e416350c3398c8b51fe0e91d47563f85
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Daniel-Scally/Add-XU-support-to-UVC-Gadget/20221121-172732
        git checkout 8356f287e416350c3398c8b51fe0e91d47563f85
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=m68k SHELL=/bin/bash drivers/usb/gadget/function/
...
All warnings (new ones prefixed by >>):
   ...
   drivers/usb/gadget/function/uvc_configfs.c: In function 'uvcg_string_s_store':
>> drivers/usb/gadget/function/uvc_configfs.c:2889:13: warning: variable 'ret' set but not used [-Wunused-but-set-variable]
    2889 |         int ret;
         |             ^~~


vim +/ret +2889 drivers/usb/gadget/function/uvc_configfs.c

  2879	
  2880	static ssize_t uvcg_string_s_store(struct config_item *item, const char *page,
  2881					   size_t len)
  2882	{
  2883		struct config_group *group = to_config_group(item->ci_parent);
  2884		struct mutex *su_mutex = &group->cg_subsys->su_mutex;
  2885		struct uvcg_string *string = to_uvcg_string(item);
  2886		int size = min(sizeof(string->string), len + 1);
  2887		struct config_item *opts_item;
  2888		struct f_uvc_opts *opts;
> 2889		int ret;
  2890	
  2891		if (len > USB_MAX_STRING_LEN)
  2892			return -EINVAL;
  2893	
  2894		mutex_lock(su_mutex);
  2895	
  2896		opts_item = item->ci_parent->ci_parent->ci_parent;
  2897		opts = to_f_uvc_opts(opts_item);
  2898	
  2899		mutex_lock(&opts->lock);
  2900		ret = strscpy(string->string, page, size);
  2901		mutex_unlock(&opts->lock);
  2902	
  2903		mutex_unlock(su_mutex);
  2904	
  2905		return len;
  2906	}
  2907	UVC_ATTR(uvcg_string_, s, s);
  2908	
...
# Linux/m68k 6.1.0-rc3 Kernel Configuration
#
