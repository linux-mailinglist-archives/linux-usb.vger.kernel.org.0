...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B2F0650AA90
	for <lists+linux-usb@lfdr.de>; Thu, 21 Apr 2022 23:16:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1441883AbiDUVRm (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Thu, 21 Apr 2022 17:17:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46706 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1441826AbiDUVRf (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Thu, 21 Apr 2022 17:17:35 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 59A094BB96
        for <linux-usb@vger.kernel.org>; Thu, 21 Apr 2022 14:14:42 -0700 (PDT)
Received: from drehscheibe.grey.stw.pengutronix.de ([2a0a:edc0:0:c01:1d::a2])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mgr@pengutronix.de>)
        id 1nhe8O-0006XQ-Eq; Thu, 21 Apr 2022 23:14:40 +0200
Received: from [2a0a:edc0:0:1101:1d::ac] (helo=dude04.red.stw.pengutronix.de)
        by drehscheibe.grey.stw.pengutronix.de with esmtp (Exim 4.94.2)
        (envelope-from <mgr@pengutronix.de>)
        id 1nhe8P-004R0w-5E; Thu, 21 Apr 2022 23:14:39 +0200
Received: from mgr by dude04.red.stw.pengutronix.de with local (Exim 4.94.2)
        (envelope-from <mgr@pengutronix.de>)
        id 1nhe8M-00EGp3-61; Thu, 21 Apr 2022 23:14:38 +0200
...
Subject: [RESEND v7 6/7] usb: gadget: uvc: add VIDIOC function
Date:   Thu, 21 Apr 2022 23:14:26 +0200
Message-Id: <20220421211427.3400834-7-m.grzeschik@pengutronix.de>
...
index 0334c8a414e9b9..626612c3c6ea3e 100644
...
+
 		...
 		v4l2_event_queue(&uvc->vdev, &v4l2_event);
@@ -882,6 +886,7 @@ static void uvc_free(struct usb_function *f)
...
@@ -909,6 +914,7 @@ static struct usb_function *uvc_alloc(struct usb_function_instance *fi)
...
+	struct config_item *streaming, *header, *h;
 	...
 	if (uvc == NULL)
@@ -940,6 +946,33 @@ static struct usb_function *uvc_alloc(struct usb_function_instance *fi)
...
index 9eec104b3666ad..f7d9a4d1f1b655 100644
--- a/drivers/usb/gadget/function/uvc.h
+++ b/drivers/usb/gadget/function/uvc.h
@@ -89,11 +89,10 @@ struct uvc_video {
...
@@ -176,4 +179,11 @@ extern void uvc_endpoint_stream(struct uvc_device *dev);
...
index f835006149546c..f182531c55f9fb 100644
...
index a2c78690c5c288..7ec63e929496fd 100644
...
+
 ...
 {
@@ -297,8 +559,12 @@ uvc_v4l2_ioctl_default(struct file *file, void *fh, bool valid_prio,
...
index a9bb4553db847e..6333779d51facf 100644
...
+#include "uvc_configfs.h"
 ...
 /* --------------------------------------------------------------------------
  * Video codecs
@@ -483,21 +484,71 @@ int uvcg_video_enable(struct uvc_video *video, int enable)
 	return ret;
 }
