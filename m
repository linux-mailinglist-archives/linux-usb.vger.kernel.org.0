...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 21F84468DCD
	for <lists+linux-usb@lfdr.de>; Sun,  5 Dec 2021 23:58:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240470AbhLEXBj (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Sun, 5 Dec 2021 18:01:39 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33210 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240266AbhLEXBi (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Sun, 5 Dec 2021 18:01:38 -0500
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D32A1C061751
        for <linux-usb@vger.kernel.org>; Sun,  5 Dec 2021 14:58:10 -0800 (PST)
Received: from dude.hi.pengutronix.de ([2001:67c:670:100:1d::7])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mgr@pengutronix.de>)
        id 1mu0SP-0006eO-1M; Sun, 05 Dec 2021 23:58:09 +0100
Received: from mgr by dude.hi.pengutronix.de with local (Exim 4.94.2)
        (envelope-from <mgr@pengutronix.de>)
        id 1mu0SO-00182W-BR; Sun, 05 Dec 2021 23:58:08 +0100
From:   Michael Grzeschik <m.grzeschik@pengutronix.de>
To:     linux-usb@vger.kernel.org
Cc:     balbi@kernel.org, laurent.pinchart@ideasonboard.com,
        paul.elder@ideasonboard.com, kernel@pengutronix.de
Subject: [PATCH v4 6/7] usb: gadget: uvc: add VIDIOC function
Date:   Sun,  5 Dec 2021 23:58:02 +0100
Message-Id: <20211205225803.268492-7-m.grzeschik@pengutronix.de>
...
v3 -> v4:
 ...
 drivers/usb/gadget/function/uvc_v4l2.c  | 337 +++++++++++++++++++++---
...
index a2c78690c5c288..1663e70c41eb24 100644
...
@@ -94,46 +229,164 @@ uvc_v4l2_get_format(struct file *file, void *fh, struct v4l2_format *fmt)
 }
...
+
 ...
 {
@@ -297,8 +550,12 @@ uvc_v4l2_ioctl_default(struct file *file, void *fh, bool valid_prio,
