...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2BCFA2B7AB1
	for <lists+linux-usb@lfdr.de>; Wed, 18 Nov 2020 10:51:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726357AbgKRJv1 (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Wed, 18 Nov 2020 04:51:27 -0500
Received: from mx0a-0014ca01.pphosted.com ([208.84.65.235]:61578 "EHLO
        mx0a-0014ca01.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1725774AbgKRJv0 (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Wed, 18 Nov 2020 04:51:26 -0500
Received: from pps.filterd (m0042385.ppops.net [127.0.0.1])
        by mx0a-0014ca01.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 0AI9ahGB004094;
        Wed, 18 Nov 2020 01:50:35 -0800
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cadence.com; h=from : to : cc :
 subject : date : message-id : references : in-reply-to : content-type :
 content-transfer-encoding : mime-version; s=proofpoint;
 bh=5BusoHOzMrUZfFjreX2guqtVUjpe75u315TyQU61dGc=;
 b= 4w== 
Received: from nam11-bn8-obe.outbound.protection.outlook.com (mail-bn8nam11lp2172.outbound.protection.outlook.com [104.47.58.172])
        by mx0a-0014ca01.pphosted.com with ESMTP id 34tcp1xtba-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Wed, 18 Nov 2020 01:50:32 -0800
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=5BusoHOzMrUZfFjreX2guqtVUjpe75u315TyQU61dGc=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cadence.com;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=5BusoHOzMrUZfFjreX2guqtVUjpe75u315TyQU61dGc=;
 b=q2ATtLgYLaMxjOii+q55/ToSNdRqmK/8YTKnhfLjt8y7A+sEcuOxh72fu/diIlePR+3aE2Y0vEzEf74ZNEE8xrj8RZuLsISszYl3SirreXek+VZpazWPW0wYYWhoTwnPI+EYrXT4izwYWpjZcUJTIzi4opQm1Hrrd4xMyM8+vg0=
Received: from BL0PR07MB5522.namprd07.prod.outlook.com (2603:10b6:208:37::25)
 by BL0PR07MB8084.namprd07.prod.outlook.com (2603:10b6:208:17d::24) with
 Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.3499.19; Wed, 18 Nov
 2020 09:50:26 +0000
Received: from BL0PR07MB5522.namprd07.prod.outlook.com
 ([fe80::ec07:8b80:7e3d:ac7a]) by BL0PR07MB5522.namprd07.prod.outlook.com
 ([fe80::ec07:8b80:7e3d:ac7a%6]) with mapi id 15.20.3564.028; Wed, 18 Nov 2020
 09:50:26 +0000
...
Thread-Topic: [PATCH v2 07/10] usb: cdnsp: cdns3 Add main part of Cadence
 USBSSP DRD Driver
Thread-Index: AQHWtDI60oTN6IA6VUq5/VjqDSjGXKnCTDuAgAso/JA=
Date:   Wed, 18 Nov 2020 09:50:26 +0000
Message-ID: <BL0PR07MB552241B050E33D22E04290D8DDE10@BL0PR07MB5522.namprd07.prod.outlook.com>
References: <20201106114300.1245-1-pawell@cadence.com>
 <20201106114300.1245-8-pawell@cadence.com>
 <20201111032502.GC14896@b29397-desktop>
In-Reply-To: <20201111032502.GC14896@b29397-desktop>
Accept-Language: en-US
Content-Language: en-US
X-MS-Has-Attach: 
X-MS-TNEF-Correlator: 
x-dg-ref: 
x-dg-rorf: true
authentication-results: nxp.com; dkim=none (message not signed)
 header.d=none;nxp.com; dmarc=none action=none header.from=cadence.com;
x-originating-ip: [185.217.253.59]
x-ms-publictraffictype: Email
x-ms-office365-filtering-correlation-id: a1ca530a-70ae-41dd-4e7e-08d88ba76052
x-ms-traffictypediagnostic: BL0PR07MB8084:
x-ms-exchange-transport-forked: True
x-microsoft-antispam-prvs: <BL0PR07MB8084714CAE10A1FFAE0E198DDDE10@BL0PR07MB8084.namprd07.prod.outlook.com>
x-ms-oob-tlc-oobclassifiers: OLM:10000;
x-ms-exchange-senderadcheck: 1
x-microsoft-antispam: BCL:0;
x-microsoft-antispam-message-info: 
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:BL0PR07MB5522.namprd07.prod.outlook.com;PTR:;CAT:NONE;SFS:(4636009)(376002)(366004)(136003)(39860400002)(346002)(396003)(36092001)(9686003)(4326008)(54906003)(66446008)(66946007)(86362001)(26005)(52536014)(64756008)(8936002)(66476007)(83380400001)(45080400002)(186003)(55016002)(316002)(76116006)(71200400001)(33656002)(8676002)(66556008)(2906002)(6916009)(478600001)(6506007)(5660300002)(7696005)(30864003)(579004)(569008);DIR:OUT;SFP:1101;
x-ms-exchange-antispam-messagedata: 
...
X-MS-Exchange-CrossTenant-Network-Message-Id: a1ca530a-70ae-41dd-4e7e-08d88ba76052
X-MS-Exchange-CrossTenant-originalarrivaltime: 18 Nov 2020 09:50:26.2132
 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: d36035c5-6ce6-4662-a3dc-e762e61ae4c9
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: jc2G604xt7ftS+NfazP4i/RliEIXRFECXDWX4MToqmHmZQGWHP9pvoHiA8LoQW62bcsc8wqWaIiiyC0hC0OoZvcDfW7MIweU3R/+VZtGMJA=
X-MS-Exchange-Transport-CrossTenantHeadersStamped: BL0PR07MB8084
...
X-Proofpoint-Spam-Details: rule=outbound_check_notspam policy=outbound_check score=0 spamscore=0
 ...
 clxscore=1015 bulkscore=0 suspectscore=0 adultscore=0 mlxlogscore=999
...
Actually, I don't have other testing platform then PCIe , so at this point
driver support only PCIe platform.
Of course, IP controller support AXI.

The support for platform driver (similar as for cdns3) will be
added in the feature. Then, I think that I will add the second
config, E.g., USB_CDNSP_PLAT
...
You have right, it doesn't make sense.
...
No, it's impossible.=20
This fragment is responsible for searching command event on event ring.=20
If driver is in this place, it's means that command event is on event ring.=
=20
This fragment only searches all events to find out completion code for comm=
and.
...
Sure, I even have the right one: CDNSP_ENDPOINTS_NUM
...
No, it's not possible. The event ring has finite number of elements (256).=
=20
Additionally, this function is called during stopping driver, so the new=20
events will not be inserted to event ring.=20
...
I don't need it. Will be removed.
...
At first glance the better solution is to re-use cdnsp-pci.c in cdns3 drive=
r.
I think its better solution to have one module for PCI driver.=20
cdns3-pci-wrap.c work as separate module which registers platform device.
It could simplify cdns3 driver for PCI based on platform.=20

It should be a separate topic not related with this patch set.=20
...
>> +{
>> +	if (pdev->active_port =3D=3D &pdev->usb2_port && pdev->gadget.lpm_capa=
ble)
