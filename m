...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8FA6145465F
	for <lists+linux-usb@lfdr.de>; Wed, 17 Nov 2021 13:26:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236971AbhKQM1v (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Wed, 17 Nov 2021 07:27:51 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56276 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234638AbhKQM1p (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Wed, 17 Nov 2021 07:27:45 -0500
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C5799C061764
        for <linux-usb@vger.kernel.org>; Wed, 17 Nov 2021 04:24:46 -0800 (PST)
Received: from dude.hi.pengutronix.de ([2001:67c:670:100:1d::7])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mgr@pengutronix.de>)
        id 1mnJzZ-0005Wv-0p; Wed, 17 Nov 2021 13:24:45 +0100
Received: from mgr by dude.hi.pengutronix.de with local (Exim 4.94.2)
        (envelope-from <mgr@pengutronix.de>)
        id 1mnJzY-00A6sH-1e; Wed, 17 Nov 2021 13:24:44 +0100
From:   Michael Grzeschik <m.grzeschik@pengutronix.de>
To:     linux-usb@vger.kernel.org
Cc:     balbi@kernel.org, laurent.pinchart@ideasonboard.com,
        paul.elder@ideasonboard.com, kernel@pengutronix.de
Subject: [PATCH v3 6/7] usb: gadget: uvc: add VIDIOC function
Date:   Wed, 17 Nov 2021 13:24:34 +0100
Message-Id: <20211117122435.2409362-7-m.grzeschik@pengutronix.de>
...
v2 -> v3:
 ...
 drivers/usb/gadget/function/uvc_v4l2.c  | 343 +++++++++++++++++++++---
 drivers/usb/gadget/function/uvc_video.c |  61 ++++-
 5 files changed, 398 insertions(+), 50 deletions(-)

diff --git a/drivers/usb/gadget/function/f_uvc.c b/drivers/usb/gadget/function/f_uvc.c
index 37fdf8b3495a48..f1fd44e6062980 100644
--- a/drivers/usb/gadget/function/f_uvc.c
+++ b/drivers/usb/gadget/function/f_uvc.c
@@ -880,6 +880,7 @@ static void uvc_free(struct usb_function *f)
...
@@ -907,6 +908,7 @@ static struct usb_function *uvc_alloc(struct usb_function_instance *fi)
...
+	struct config_item *streaming, *header, *h;
 	...
 	if (uvc == NULL)
@@ -938,6 +940,28 @@ static struct usb_function *uvc_alloc(struct usb_function_instance *fi)
...
index a2c78690c5c288..9128f02ff40d02 100644
...
-
 ...
 {
@@ -80,56 +210,187 @@ uvc_v4l2_get_format(struct file *file, void *fh, struct v4l2_format *fmt)
...
@@ -297,8 +558,12 @@ uvc_v4l2_ioctl_default(struct file *file, void *fh, bool valid_prio,
