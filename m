...
X-MS-Exchange-Transport-CrossTenantHeadersStamped: DM6PR07MB6651
...
index 53202b21a8d2..af8573c0ab14 100644
...
+cdnsp-udc-pci-$(CONFIG_TRACING)			+= trace.o
+endif
...
index 7f6e1d28d3b8..07a1ccd3294a 100644
...
+
 	...
 	spin_lock(&pdev->lock);
@@ -60,11 +65,15 @@ static int cdnsp_ep0_set_config(struct cdnsp_device *pdev,
...
@@ -214,18 +224,21 @@ static int cdnsp_ep0_handle_feature_device(struct cdnsp_device *pdev,
...
+		trace_cdnsp_u2(set);
 	...
 	case USB_DEVICE_LTM_ENABLE:
 		return -EINVAL;
@@ -429,6 +442,8 @@ void cdnsp_setup_analyze(struct cdnsp_device *pdev)
 	int ret = 0;
 	__le16 len;
...
@@ -439,8 +454,10 @@ void cdnsp_setup_analyze(struct cdnsp_device *pdev)
 	}
...
@@ -449,6 +466,7 @@ void cdnsp_setup_analyze(struct cdnsp_device *pdev)
...
@@ -470,8 +488,10 @@ void cdnsp_setup_analyze(struct cdnsp_device *pdev)
 	if (!len)
 		pdev->ep0_stage = CDNSP_STATUS_STAGE;
...
index 38ad170b2bdd..4c7f5a1ef838 100644
...
+
 		...
 		if (pdev->cmd.status == COMP_SUCCESS)
 			return 0;
@@ -578,6 +601,8 @@ int cdnsp_halt_endpoint(struct cdnsp_device *pdev,
 {
 	int ret;
...
+
 	if (value) {
 		ret = cdnsp_cmd_stop_ep(pdev, pep);
 		if (ret)
@@ -598,6 +623,8 @@ int cdnsp_halt_endpoint(struct cdnsp_device *pdev,
...
@@ -651,6 +678,9 @@ static int cdnsp_update_eps_configuration(struct cdnsp_device *pdev,
...
+
 	...
 	return ret;
@@ -675,6 +705,7 @@ int cdnsp_reset_device(struct cdnsp_device *pdev)
...
@@ -702,6 +733,8 @@ int cdnsp_reset_device(struct cdnsp_device *pdev)
 	for (i = 1; i < 31; ++i)
...
+
 	if (ret)
 		dev_err(pdev->dev, "Reset device failed with error code %d",
 			ret);
@@ -758,6 +791,8 @@ int cdnsp_alloc_streams(struct cdnsp_device *pdev, struct cdnsp_ep *pep)
...
+
 	...
 	if (ret)
 		return ret;
@@ -783,6 +818,8 @@ int cdnsp_disable_slot(struct cdnsp_device *pdev)
 	pdev->slot_id = 0;
...
@@ -806,11 +843,14 @@ int cdnsp_enable_slot(struct cdnsp_device *pdev)
 	cdnsp_ring_cmd_db(pdev);
 	ret = cdnsp_wait_for_cmd_compl(pdev);
 	if (ret)
-		return ret;
...
+	return ret;
 ...
 /*
@@ -824,8 +864,10 @@ int cdnsp_setup_device(struct cdnsp_device *pdev, enum cdnsp_setup_dev setup)
 	int dev_state = 0;
 	int ret;
...
+	}
 	...
 	if (!pdev->active_port->port_num)
 		return -EINVAL;
@@ -833,8 +875,10 @@ int cdnsp_setup_device(struct cdnsp_device *pdev, enum cdnsp_setup_dev setup)
 	slot_ctx = cdnsp_get_slot_ctx(&pdev->out_ctx);
...
@@ -850,10 +894,14 @@ int cdnsp_setup_device(struct cdnsp_device *pdev, enum cdnsp_setup_dev setup)
...
+
 	...
 	ctrl_ctx->drop_flags = 0;
@@ -868,6 +916,8 @@ void cdnsp_set_usb2_hardware_lpm(struct cdnsp_device *pdev,
...
@@ -947,6 +997,7 @@ static int cdnsp_gadget_ep_enable(struct usb_ep *ep,
...
+	trace_cdnsp_ep_enable_end(pep, 0);
 	...
 	return ret;
@@ -1003,6 +1054,7 @@ static int cdnsp_gadget_ep_disable(struct usb_ep *ep)
 	pep->ep_state |= EP_STOPPED;
...
+	trace_cdnsp_ep_disable_end(pep, 0);
 	...
 	return ret;
@@ -1021,6 +1073,8 @@ static struct usb_request *cdnsp_gadget_ep_alloc_request(struct usb_ep *ep,
...
@@ -1029,6 +1083,7 @@ static void cdnsp_gadget_ep_free_request(struct usb_ep *ep,
 {
...
@@ -1097,6 +1152,7 @@ static int cdnsp_gadget_ep_set_halt(struct usb_ep *ep, int value)
 	preq = next_request(&pep->pending_list);
 	if (value) {
 		if (preq) {
...
@@ -1160,6 +1216,8 @@ void cdnsp_gadget_giveback(struct cdnsp_ep *pep,
 	usb_gadget_unmap_request_by_dev(pdev->dev, &preq->request,
 					preq->direction);
...
@@ -1240,6 +1298,7 @@ static int cdnsp_run(struct cdnsp_device *pdev,
...
+	trace_cdnsp_init("Controller ready to work");
 ...
 err:
 	cdnsp_halt(pdev);
@@ -1392,6 +1451,8 @@ static void cdnsp_stop(struct cdnsp_device *pdev)
...
+	trace_cdnsp_exit("Controller stopped.");
 ...
 /*
@@ -1473,6 +1534,8 @@ static int cdnsp_gadget_pullup(struct usb_gadget *gadget, int is_on)
...
index 09662574adeb..585d99162738 100644
...
+	trace_cdnsp_port_info(addr, port_offset, port_count, port->maj_rev);
 	...
 	port->exist = 1;
@@ -1172,6 +1184,8 @@ static int cdnsp_setup_port_arrays(struct cdnsp_device *pdev, gfp_t flags)
 		return -ENODEV;
 	}
...
index b7fdfbbebcc0..d1c9da9c696a 100644
...
+	trace_cdnsp_inc_enq(ring);
 ...
 /*
@@ -250,6 +255,7 @@ static bool cdnsp_room_on_ring(struct cdnsp_device *pdev,
...
@@ -288,6 +294,8 @@ static bool cdnsp_ring_ep_doorbell(struct cdnsp_device *pdev,
 	else
...
+
 	...
 	/* Doorbell was set. */
@@ -471,6 +479,8 @@ static void cdnsp_find_new_dequeue_state(struct cdnsp_device *pdev,
...
+	trace_cdnsp_new_deq_state(state);
 ...
 /*
@@ -531,6 +541,10 @@ static struct cdnsp_segment *cdnsp_trb_in_td(struct cdnsp_device *pdev,
...
@@ -581,6 +595,9 @@ static void cdnsp_unmap_td_bounce_buffer(struct cdnsp_device *pdev,
...
@@ -618,6 +635,9 @@ static int cdnsp_cmd_set_deq(struct cdnsp_device *pdev,
 	cdnsp_ring_cmd_db(pdev);
 	ret = cdnsp_wait_for_cmd_compl(pdev);
...
@@ -669,6 +689,9 @@ int cdnsp_remove_request(struct cdnsp_device *pdev,
...
@@ -776,6 +799,8 @@ static void cdnsp_handle_port_status(struct cdnsp_device *pdev,
...
@@ -941,8 +966,10 @@ static int cdnsp_giveback_first_trb(struct cdnsp_device *pdev,
...
@@ -1384,6 +1431,8 @@ static bool cdnsp_handle_event(struct cdnsp_device *pdev)
...
@@ -1531,6 +1580,7 @@ static void cdnsp_queue_trb(struct cdnsp_device *pdev, struct cdnsp_ring *ring,
...
@@ -1561,6 +1611,8 @@ static int cdnsp_prepare_ring(struct cdnsp_device *pdev,
...
+
 		...
 		if (cdnsp_ring_expansion(pdev, ep_ring, num_trbs_needed,
 					 mem_flags)) {
@@ -1724,6 +1776,8 @@ static int cdnsp_align_td(struct cdnsp_device *pdev,
...
@@ -1760,6 +1814,9 @@ static int cdnsp_align_td(struct cdnsp_device *pdev,
...
@@ -1996,13 +2053,17 @@ int cdnsp_cmd_stop_ep(struct cdnsp_device *pdev, struct cdnsp_ep *pep)
...
+
 ep_stopped:
 	pep->ep_state |= EP_STOPPED;
 	return ret;
@@ -2016,6 +2077,8 @@ int cdnsp_cmd_flush_ep(struct cdnsp_device *pdev, struct cdnsp_ep *pep)
 	cdnsp_ring_cmd_db(pdev);
 	ret = cdnsp_wait_for_cmd_compl(pdev);
...
new file mode 100644
index 000000000000..11891cad070c
--- /dev/null
