...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id DC50F1A4D6B
	for <lists+linux-usb@lfdr.de>; Sat, 11 Apr 2020 04:13:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726736AbgDKCN5 (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Fri, 10 Apr 2020 22:13:57 -0400
Received: from smtprelay-out1.synopsys.com ([149.117.87.133]:36594 "EHLO
        smtprelay-out1.synopsys.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726671AbgDKCN5 (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Fri, 10 Apr 2020 22:13:57 -0400
Received: from mailhost.synopsys.com (sv1-mailhost2.synopsys.com [10.205.2.132])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
        (No client certificate requested)
        by smtprelay-out1.synopsys.com (Postfix) with ESMTPS id B464DC00A7;
        Sat, 11 Apr 2020 02:13:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=synopsys.com; s=mail;
        t=1586571236; bh=QXmShu7+/95XMt5m5HnTYDQkAxi4jCgiC7LaO6MgMqM=;
        h=Date:In-Reply-To:References:From:Subject:To:Cc:From;
        b=
Received: from te-lab16 (nanobot.internal.synopsys.com [10.10.186.99])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mailhost.synopsys.com (Postfix) with ESMTPSA id 4840FA006D;
        Sat, 11 Apr 2020 02:13:55 +0000 (UTC)
Received: by te-lab16 (sSMTP sendmail emulation); Fri, 10 Apr 2020 19:13:55 -0700
Date:   Fri, 10 Apr 2020 19:13:55 -0700
Message-Id: <523c5286a511418f10b9456591aee428bd434594.1586570825.git.thinhn@synopsys.com>
In-Reply-To: <cover.1586570825.git.thinhn@synopsys.com>
References: <cover.1586570825.git.thinhn@synopsys.com>
From:   Thinh Nguyen <Thinh.Nguyen@synopsys.com>
Subject: [PATCH 1/2] usb: dwc3: Add support for DWC_usb32 IP
...
@@ -1826,7 +1824,7 @@ static int __dwc3_gadget_wakeup(struct dwc3 *dwc)
 	}
...
@@ -1888,12 +1886,12 @@ static int dwc3_gadget_run_stop(struct dwc3 *dwc, int is_on, int suspend)
...
@@ -1967,7 +1965,7 @@ static void dwc3_gadget_enable_irq(struct dwc3 *dwc)
...
@@ -2048,10 +2046,10 @@ static int __dwc3_gadget_start(struct dwc3 *dwc)
