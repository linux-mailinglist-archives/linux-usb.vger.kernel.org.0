Return-Path: <linux-usb+bounces-4274-lists+linux-usb=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-usb@lfdr.de
Delivered-To: lists+linux-usb@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 55787815663
	for <lists+linux-usb@lfdr.de>; Sat, 16 Dec 2023 03:30:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id D720E1F25920
	for <lists+linux-usb@lfdr.de>; Sat, 16 Dec 2023 02:30:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C974D20F6;
	Sat, 16 Dec 2023 02:30:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="xMsiHY4g"
X-Original-To: linux-usb@vger.kernel.org
Received: from out-175.mta0.migadu.com (out-175.mta0.migadu.com [91.218.175.175])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1804C1C32;
	Sat, 16 Dec 2023 02:30:16 +0000 (UTC)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.dev; s=key1;
	...
	bh=5jL8JITg3HQPe2xIs/J246ehJCWq++Te/BUmEKbsnf8=;
	b=xMsiHY4gKTuSA56bnYIZXX7/stQ/rlBId8ykZIfBtqV2JoOow0pxgyonDJmIZ0oEuts4nV
	WbiTF7Zi9ZOrJ4gJqXGXnSoLC+wdPdSwhCwfHWSGNC1wnhFE2fNjPqQTt3DO8pjI+/eEd6
	mFvWTqY5XqCP0vo4g9Z5vn8Zidtx2Yc=
...
Subject: [PATCH v2] USB: core: Use device_driver directly in struct usb_driver and usb_device_driver
Date: Sat, 16 Dec 2023 10:29:26 +0800
Message-Id: <20231216022926.2083376-1-yajun.deng@linux.dev>
Precedence: bulk
...
We can test that if 'drv->probe' is equal to usb_probe_device in
is_usb_device_driver(). This way, the struct usbdrv_wrap is no longer
needed, and struct usb_driver and usb_device_driver will be consistent
with other driver structs.
...
index 60363153fc3f..d98c057d8cbc 100644
--- a/drivers/usb/core/usb.h
+++ b/drivers/usb/core/usb.h
@@ -176,11 +176,10 @@ static inline int is_root_hub(struct usb_device *udev)
 }
