
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="oaOe8thHGxtiyaJL"
Content-Disposition: inline
In-Reply-To: <20260411180012.830193-1-jhapavitra98@gmail.com>
X-Spamd-Result: default: False [-1.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-36323-lists,linux-usb=lfdr.de];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[intel.com:email,intel.com:dkim,intel.com:mid,i.mx:url,sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,git-scm.com:url]
X-Rspamd-Queue-Id: E5497426141
...
[also build test ERROR on usb/usb-next usb/usb-linus westeri-thunderbolt/next linus/master v7.0 next-20260417]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Pavitra-Jha/usb-gadget-udc-max3420-validate-endpoint-index-before-array-access/20260418-074148
base:   https://git.kernel.org/pub/scm/linux/kernel/git/gregkh/usb.git usb-testing
patch link:    https://lore.kernel.org/r/20260411180012.830193-1-jhapavitra98%40gmail.com
patch subject: [PATCH] usb: gadget: udc: max3420: validate endpoint index before array access
...
| Closes: https://lore.kernel.org/oe-kbuild-all/202604200016.0yXrtPsW-lkp@intel.com/

All errors (new ones prefixed by >>):

   drivers/usb/gadget/udc/max3420_udc.c: In function 'max3420_getstatus':
>> drivers/usb/gadget/udc/max3420_udc.c:551:17: error: 'id' undeclared (first use in this function); did you mean 'ida'?
     551 |                 id = udc->setup.wIndex & USB_ENDPOINT_NUMBER_MASK;
         |                 ^~
         |                 ida
   drivers/usb/gadget/udc/max3420_udc.c:551:17: note: each undeclared identifier is reported only once for each function it appears in
   drivers/usb/gadget/udc/max3420_udc.c: In function 'max3420_set_clear_feature':
>> drivers/usb/gadget/udc/max3420_udc.c:603:25: error: label 'stall' used but not defined
     603 |                         goto stall;
         |                         ^~~~


vim +551 drivers/usb/gadget/udc/max3420_udc.c
 ...
 > 551			id = udc->setup.wIndex & USB_ENDPOINT_NUMBER_MASK;
   552			if (id >= MAX3420_MAX_EPS)
   553				goto stall;
   554			ep = &udc->ep[id];
   555			if (udc->setup.wIndex & USB_DIR_IN) {
   556				if (!ep->ep_usb.caps.dir_in)
   557					goto stall;
   558			} else {
   559				if (!ep->ep_usb.caps.dir_out)
   560					goto stall;
   561			}
   562			if (ep->halted)
   563				status = 1 << USB_ENDPOINT_HALT;
   564			break;
   565		default:
   566			goto stall;
   567		}
   568	
   569		status = cpu_to_le16(status);
   570		spi_wr_buf(udc, MAX3420_REG_EP0FIFO, &status, 2);
   571		spi_wr8_ack(udc, MAX3420_REG_EP0BC, 2, 1);
   572		return;
   573	stall:
   574		dev_err(udc->dev, "Can't respond to getstatus request\n");
   575		spi_wr8(udc, MAX3420_REG_EPSTALLS, STLEP0IN | STLEP0OUT | STLSTAT);
   576	}
   577	
   578	static void max3420_set_clear_feature(struct max3420_udc *udc)
   579	{
   580		struct max3420_ep *ep;
   581		int set = udc->setup.bRequest == USB_REQ_SET_FEATURE;
   582		unsigned long flags;
   583		int id;
   584	
   585		switch (udc->setup.bRequestType) {
   586		case USB_RECIP_DEVICE:
   587			if (udc->setup.wValue != USB_DEVICE_REMOTE_WAKEUP)
   588				break;
   589	
   590			if (udc->setup.bRequest == USB_REQ_SET_FEATURE)
   591				udc->remote_wkp = 1;
   592			else
   593				udc->remote_wkp = 0;
   594	
   595			return spi_ack_ctrl(udc);
   596	
   597		case USB_RECIP_ENDPOINT:
   598			if (udc->setup.wValue != USB_ENDPOINT_HALT)
   599				break;
   600	
   601			id = udc->setup.wIndex & USB_ENDPOINT_NUMBER_MASK;
   602			if (id >= MAX3420_MAX_EPS)
 > 603				goto stall;
   604			ep = &udc->ep[id];
   605	
   606			spin_lock_irqsave(&ep->lock, flags);
   607			ep->todo &= ~STALL_EP;
   608			if (set)
   609				ep->todo |= STALL;
   610			else
   611				ep->todo |= UNSTALL;
   ...
   613	
   614			spi_max3420_stall(ep);
   615			return;
   616		default:
   617			break;
   618		}
   619	
   620		dev_err(udc->dev, "Can't respond to SET/CLEAR FEATURE\n");
   621		spi_wr8(udc, MAX3420_REG_EPSTALLS, STLEP0IN | STLEP0OUT | STLSTAT);
   622	}
   623	
...
reproduce (this is a W=1 build):
        ...
        b4 shazam https://lore.kernel.org/r/20260411180012.830193-1-jhapavitra98@gmail.com

        git clone https://github.com/intel/lkp-tests.git ~/lkp-tests

        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-15.2.0 ~/lkp-tests/kbuild/make.cross W=1 O=build_dir ARCH=arc olddefconfig
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-15.2.0 ~/lkp-tests/kbuild/make.cross W=1 O=build_dir ARCH=arc SHELL=/bin/bash 
...
# Linux/arc 7.0.0-rc7 Kernel Configuration
#
CONFIG_CC_VERSION_TEXT="arc-linux-gcc (GCC) 15.2.0"
CONFIG_CC_IS_GCC=y
...
CONFIG_NET_DSA_TAG_MXL_862XX=y
CONFIG_NET_DSA_TAG_MXL_GSW1XX=y
...
CONFIG_PM_RUNTIME_KUNIT_TEST=y
...
CONFIG_NET_DSA_LANTIQ_COMMON=y
CONFIG_NET_DSA_LANTIQ_GSWIP=y
CONFIG_NET_DSA_MXL_GSW1XX=y
...
CONFIG_STMMAC_LIBPCI=y
CONFIG_DWMAC_LOONGSON=y
CONFIG_DWMAC_MOTORCOMM=y
CONFIG_STMMAC_PCI=y
...
CONFIG_RTW88_8814AE=y
CONFIG_RTW88_8814AU=y
...
CONFIG_INPUT_PF1550_ONKEY=y
CONFIG_INPUT_PM8941_PWRKEY=y
CONFIG_INPUT_PM8XXX_VIBRATOR=y
CONFIG_INPUT_PMIC8XXX_PWRKEY=y
CONFIG_INPUT_MAX7360_ROTARY=y
...
CONFIG_INPUT_TPS6594_PWRBUTTON=y
...
CONFIG_I2C_DESIGNWARE_AMDISP=y
...
CONFIG_SPI_MICROCHIP_CORE_SPI=y
CONFIG_SPI_MT65XX=y
CONFIG_SPI_MT7621=y
...
CONFIG_ZL3073X=y
CONFIG_ZL3073X_I2C=y
CONFIG_ZL3073X_SPI=y
...
CONFIG_POWER_RESET_TH1520_AON=y
...
CONFIG_POWER_SEQUENCING_TH1520_GPU=y
CONFIG_POWER_SEQUENCING_PCIE_M2=y
CONFIG_POWER_SUPPLY=y
CONFIG_POWER_SUPPLY_DEBUG=y
CONFIG_POWER_SUPPLY_HWMON=y
CONFIG_ADC_BATTERY_HELPER=y
...
CONFIG_BATTERY_HUAWEI_GAOKUN=y
...
CONFIG_SENSORS_KBATT=y
CONFIG_SENSORS_KFAN=y
...
CONFIG_SENSORS_LT3074=y
CONFIG_SENSORS_LT3074_REGULATOR=y
...
#
CONFIG_VIDEO_C3_ISP=y
CONFIG_VIDEO_C3_MIPI_ADAPTER=y
CONFIG_VIDEO_C3_MIPI_CSI2=y
...
CONFIG_VIDEO_OG0VE1B=y
CONFIG_VIDEO_OS05B10=y
CONFIG_VIDEO_OV01A10=y
CONFIG_VIDEO_OV02A10=y
CONFIG_VIDEO_OV02E10=y
CONFIG_VIDEO_OV02C10=y
...
CONFIG_VIDEO_S5K3M5=y
CONFIG_VIDEO_S5K5BAF=y
CONFIG_VIDEO_S5K6A3=y
CONFIG_VIDEO_S5KJN1=y
CONFIG_VIDEO_VD55G1=y
CONFIG_VIDEO_VD56G3=y
...
CONFIG_DRM_MEDIATEK_HDMI_COMMON=y
...
CONFIG_DRM_PANEL_HIMAX_HX83112B=y
CONFIG_DRM_PANEL_HIMAX_HX8394=y
CONFIG_DRM_PANEL_HYDIS_HV101HD1=y
...
CONFIG_DRM_PANEL_LG_LD070WX3=y
...
CONFIG_DRM_PANEL_NOVATEK_NT37801=y
...
CONFIG_DRM_PANEL_RENESAS_R61307=y
CONFIG_DRM_PANEL_RENESAS_R69328=y
...
CONFIG_DRM_PANEL_SAMSUNG_LTL106HL02=y
...
CONFIG_DRM_PANEL_SAMSUNG_S6E8AA5X01_AMS561RA01=y
CONFIG_DRM_PANEL_SAMSUNG_SOFEF00=y
CONFIG_DRM_PANEL_SEIKO_43WVF1G=y
CONFIG_DRM_PANEL_SHARP_LQ079L1SX01=y
...
CONFIG_DRM_PANEL_SYNAPTICS_TDDI=y
CONFIG_DRM_PANEL_TDO_TL070WSH30=y
CONFIG_DRM_PANEL_TPO_TD028TTEC1=y
CONFIG_DRM_PANEL_TPO_TD043MTEA1=y
CONFIG_DRM_PANEL_TPO_TPG110=y
CONFIG_DRM_PANEL_TRULY_NT35597_WQXGA=y
CONFIG_DRM_PANEL_VISIONOX_G2647FB105=y
...
CONFIG_SND_SOC_OPS_KUNIT_TEST=y
...
CONFIG_SND_SOC_INTEL_AVS_MACH_RT5640=y
...
CONFIG_SND_SOC_QCOM_OFFLOAD_UTILS=y
...
CONFIG_SND_SOC_SOF_INTEL_NVL=y
CONFIG_SND_SOC_SOF_NOVALAKE=y
...
CONFIG_SND_SOC_CS35L56_TEST=y
CONFIG_SND_SOC_CS35L56_SHARED_TEST=y
...
CONFIG_SND_SOC_FS_AMP_LIB=y
CONFIG_SND_SOC_FS210X=y
...
CONFIG_SND_SOC_PM4125=y
CONFIG_SND_SOC_PM4125_SDW=y
...
CONFIG_LEDS_ARIEL=y
CONFIG_LEDS_OSRAM_AMS_AS3668=y
...
CONFIG_EC_LENOVO_THINKPAD_T14S=y
...
CONFIG_COMMON_CLK_MT8196_MFGCFG=y
CONFIG_COMMON_CLK_MT8196_MMSYS=y
CONFIG_COMMON_CLK_MT8196_PEXTPSYS=y
CONFIG_COMMON_CLK_MT8196_UFSSYS=y
CONFIG_COMMON_CLK_MT8196_VDECSYS=y
CONFIG_COMMON_CLK_MT8196_VENCSYS=y
...
CONFIG_QCS_CAMCC_615=y
CONFIG_QCS_GCC_404=y
CONFIG_SA_CAMCC_8775P=y
CONFIG_QCS_GCC_8300=y
CONFIG_QCS_GCC_615=y
CONFIG_QCS_GPUCC_615=y
CONFIG_QCS_VIDEOCC_615=y
...
CONFIG_IOMMU_IO_PGTABLE_LPAE_KUNIT_TEST=y
...
CONFIG_ROHM_BD79112=y
CONFIG_ROHM_BD79124=y
...
CONFIG_INV_ICM45600_I2C=y
CONFIG_INV_ICM45600_SPI=y
...
CONFIG_IIO_MULTIPLY_KUNIT_TEST=y
...
CONFIG_ABP060MG=y
CONFIG_ABP2030PA=y
CONFIG_ABP2030PA_I2C=y
CONFIG_ABP2030PA_SPI=y
...
CONFIG_PWM_MAX7360=y
CONFIG_PWM_MC33XS2410=y
...
#
CONFIG_RESET_SPACEMIT_COMMON=y
...
CONFIG_PHY_COMMON_PROPS_TEST=y
...
CONFIG_INTERCONNECT_KUNIT_TEST=y
CONFIG_COUNTER=y
...
CONFIG_SECURITY_COMMONCAP_KUNIT_TEST=y
