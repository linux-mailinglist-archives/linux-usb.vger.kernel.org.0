...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 43E4622EA4A
	for <lists+linux-usb@lfdr.de>; Mon, 27 Jul 2020 12:46:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728266AbgG0Kqu (ORCPT <rfc822;lists+linux-usb@lfdr.de>);
        Mon, 27 Jul 2020 06:46:50 -0400
Received: from relay7-d.mail.gandi.net ([217.70.183.200]:49177 "EHLO
        relay7-d.mail.gandi.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727897AbgG0Kqt (ORCPT
        <rfc822;linux-usb@vger.kernel.org>); Mon, 27 Jul 2020 06:46:49 -0400
X-Originating-IP: 82.255.60.242
Received: from classic.redhat.com (lns-bzn-39-82-255-60-242.adsl.proxad.net [82.255.60.242])
        (Authenticated sender: hadess@hadess.net)
        by relay7-d.mail.gandi.net (Postfix) with ESMTPSA id 878AB2000E;
        Mon, 27 Jul 2020 10:46:47 +0000 (UTC)
From:   Bastien Nocera <hadess@hadess.net>
To:     linux-usb@vger.kernel.org
Cc:     Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        Alan Stern <stern@rowland.harvard.edu>,
        Bastien Nocera <hadess@hadess.net>
Subject: [PATCH v6 3/3] USB: Fix device driver race
Date:   Mon, 27 Jul 2020 12:46:44 +0200
Message-Id: <20200727104644.149873-3-hadess@hadess.net>
